...
var twemoji = (function() {
      ...
      parse: function(d, u) {
        ...
        return ('string' == typeof d
          ...
          : function(d, u) {
              ...
              for (; h--; ) {
                for (
                  e = !1, a = document.createDocumentFragment(), b = m[h], t = b.nodeValue, n = 0;
                  (r = g.exec(t));

                ) {
                  if (
                    ((o = r.index) !== n && a.appendChild(C(t.slice(n, o), !0)),
                    (s = r[0]),
                    (l = N(s)),
                    (n = o + s.length),
                    (p = u.callback(l, u)),
  ...
  function i(d, u) {
    for (var f = [], c = 0, e = 0, a = 0; a < d.length; )
      (c = d.charCodeAt(a++)),
        e
          ? (f.push((65536 + ((e - 55296) << 10) + (c - 56320)).toString(16)), (e = 0))
          : 55296 <= c && c <= 56319
          ? (e = c)
...
!(function(c, l) {
  ;(c.wp = c.wp || {}),
    (c.wp.emoji = new (function() {
      var n,
        u,
        e = c.MutationObserver || c.WebKitMutationObserver || c.MozMutationObserver,
        a = c.document,
        t = !1,
        r = 0,
              ...
              callback: function(u, e) {
                ...
                return (
                  !(
                    ...
                    !/^1f1(?:e[6-9a-f]|f[0-9a-f])-1f1(?:e[6-9a-f]|f[0-9a-f])$/.test(u) &&
      ...
      return l && (l.DOMReady ? s() : (l.readyCallback = s)), { parse: f, test: d }
    })())
