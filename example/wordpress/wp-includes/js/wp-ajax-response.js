...
window.wpAjax = jQuery.extend(
  {
        ...
        jQuery('response', x).each(function() {
          ...
          if (
            !jQuery('wp_error', child).each(function() {
              ...
              if (e) {
                wpAjax.invalidateForm(
                  jQuery('#' + e + ' :input[name="' + code + '"]').parents('.form-field:first')
                )
              }
    ...
    invalidateForm: function(selector) {
      return jQuery(selector)
        ...
        .find('input')
        .one('change wp-check-valid-field', function() {
          jQuery(this)
    ...
    validateForm: function(selector) {
      ...
      return !wpAjax.invalidateForm(
        selector.find('.form-required').filter(function() {
