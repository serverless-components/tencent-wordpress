...
!(function(n) {
  ...
  var a,
    ...
    l = function(t, e, i, n, s) {
      ...
      } else if (i && u.test(i)) for (r = i.split(u); o < r.length; o++) e = t(e, r[o], n, s)
      else e = t(e, i, n, s)
      return e
    }
  ;(n.on = function(t, e, i) {
    ;(this._events = l(s, this._events || {}, t, e, { context: i, ctx: this, listening: a })),
  ...
  ;(n.off = function(t, e, i) {
    return (
      this._events &&
        (this._events = l(r, this._events, t, e, { context: i, listeners: this._listeners })),
      this
    )
  }),
  ...
  ;(g.prototype.on = n.on),
    (g.prototype.off = function(t, e) {
      ;(this.interop
        ? ((this._events = l(r, this._events, t, e, { context: void 0, listeners: void 0 })),
          this._events)
  ...
  x.extend(v.prototype, n, {
    ...
    set: function(t, e, i) {
      ...
      var s = i.unset,
        ...
        a = this._changing
      ;(this._changing = !0),
        a || ((this._previousAttributes = x.clone(this.attributes)), (this.changed = {}))
    ...
    destroy: function(e) {
      ...
      return (
        this.isNew() ? x.defer(e.success) : (L(this, e), (t = this.sync('delete', this, e))),
        r || i(),
        t
      )
    },
      ...
      if (null != t) {
        ...
        if (
          ...
          for (r = 0; r < a.length; r++)
            null != n && (e.index = n + r), (s = a[r]).trigger('add', s, this, e)
          ;(p || y) && this.trigger('sort', this, e),
            (a.length || u.length || h.length) &&
              ((e.changes = { added: a, removed: u, merged: h }), this.trigger('update', this, e))
        }
        return i ? t[0] : t
      }
    },
    ...
    (h.sync = function(t, e, n) {
      ...
      if (
        ...
        null != n.data ||
          ...
          ((s.contentType = 'application/json'), (s.data = JSON.stringify(n.attrs || e.toJSON(n)))),
        n.emulateJSON &&
  ...
  ;(z.started = !1),
    x.extend(z.prototype, n, {
      ...
      matchRoot: function() {
        return (
          this.decodeFragment(this.location.pathname).slice(0, this.root.length - 1) + '/' ===
          this.root
        )
      },
