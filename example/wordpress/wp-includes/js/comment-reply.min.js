...
window.addComment = (function(f) {
    ...
    if (i && ((v = b(E.cancelReplyId)), (I = b(E.commentFormId)), v)) {
      ...
      var t = function(e) {
        if ((e.metaKey || e.ctrlKey) && 13 === e.keyCode)
          return I.removeEventListener('keydown', t), e.preventDefault(), I.submit.click(), !1
      }
  ...
  function l(e) {
    ...
    if (t && C) {
      ...
      o &&
        ...
        n &&
        (r && 'A' === r.nodeName && r.id !== E.cancelReplyId && (r.style.display = ''),
        (o.textContent = n)),
        e.preventDefault()
    }
  }
  ...
  return (
    i && 'loading' !== h.readyState ? t() : i && f.addEventListener('DOMContentLoaded', t, !1),
    {
      init: d,
        ...
        if (r && C && m) {
          void 0 === o && (o = y && y.textContent),
            ...
            y &&
              ...
              (u && 'A' === u.nodeName && u.id !== E.cancelReplyId && (u.style.display = 'none'),
              (y.textContent = o)),
            (v.onclick = function() {
              return !1
            })
          try {
            for (var p = 0; p < I.elements.length; p++)
              if (
                ...
                ((i.offsetWidth <= 0 && i.offsetHeight <= 0) || 'hidden' === a.visibility) &&
                  (l = !0),
