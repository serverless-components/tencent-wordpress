  ...
  /******/ [
    ...
    /***/ function(module, exports) {
      ...
      AudioDetails = State.extend(
        /** @lends wp.media.controller.AudioDetails.prototype */ {
          defaults: {
            id: 'audio-details',
    ...
    /***/ function(module, exports) {
      ...
      MediaDetails = Select.extend(
        /** @lends wp.media.view.MediaFrame.MediaDetails.prototype */ {
          defaults: {
            id: 'media',
            url: '',
            menu: 'media-details',
          ...
          initialize: function(options) {
            ...
            this.options.selection = new wp.media.model.Selection(this.media.attachment, {
              multiple: false
            })
    ...
    /***/ function(module, exports) {
      ...
      AudioDetails = MediaDetails.extend(
        /** @lends wp.media.view.MediaFrame.AudioDetails.prototype */ {
          defaults: {
            id: 'audio',
            url: '',
            menu: 'audio-details',
    ...
    /***/ function(module, exports) {
      ...
      VideoDetails = MediaDetails.extend(
        /** @lends wp.media.view.MediaFrame.VideoDetails.prototype */ {
          defaults: {
            id: 'video',
            url: '',
            menu: 'video-details',
    ...
    /***/ function(module, exports) {
      ...
      MediaDetails = AttachmentDisplay.extend(
        /** @lends wp.media.view.MediaDetails.prototype */ {
          initialize: function() {
        ...
        /** @lends wp.media.view.MediaDetails */ {
          ...
          prepareSrc: function(elem) {
            ...
            _.each($(elem).find('source'), function(source) {
              source.src = [source.src, source.src.indexOf('?') > -1 ? '&' : '?', '_=', i].join('')
            })
    ...
    /***/ function(module, exports) {
       ...
       */
      AudioDetails = MediaDetails.extend(
        /** @lends wp.media.view.AudioDetails.prototype */ {
    ...
    /***/ function(module, exports) {
       ...
       */
      VideoDetails = MediaDetails.extend(
        /** @lends wp.media.view.VideoDetails.prototype */ {
