...
;(window.wpCookies = {
  each: function(e, t, n) {
    ...
    if (((n = n || e), void 0 !== e.length)) {
      for (i = 0, s = e.length; i < s; i++) if (!1 === t.call(n, e[i], i, e)) return 0
  ...
  get: function(e) {
    ...
    if (i) {
      ...
      return (
        ...
        decodeURIComponent(i.substring(n + s.length, t))
      )
    }
  },
  ...
  (window.setUserSetting = function(e, t, n) {
    ...
    return (
      ...
      (t = 'number' == typeof t ? parseInt(t, 10) : t.toString().replace(/[^A-Za-z0-9_-]/g, '')),
      (s = s || {}),
      n ? delete s[e] : (s[e] = t),
      wpCookies.setHash('wp-settings-' + i, s, 31536e3, r, '', o),
      wpCookies.set('wp-settings-time-' + i, userSettings.time, 31536e3, r, '', o),
      e
    )
  }),
