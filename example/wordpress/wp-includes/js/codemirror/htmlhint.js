    ...
    (t.prototype = {
      ...
      fixPos: function(e, t) {
        var a,
          ...
          i = r.length - 1,
          s = e.line
        return i > 0 ? ((s += i), (a = r[i].length + 1)) : (a = e.col + t), { line: s, col: a }
      },
...
'object' == typeof exports && exports && (exports.HTMLParser = HTMLParser),
  ...
  HTMLHint.addRule({
    ...
    init: function(e, t) {
      var a = this
      e.addListener('tagstart', function(e) {
        for (var n, r = e.attrs, i = e.col + e.tagName.length + 1, s = 0, o = r.length; o > s; s++)
          (n = r[s]),
      ...
      var a = this,
        n = function(r) {
          'start' === r.type ||
            ...
            ((('comment' !== r.type && r.long === !1) || /^DOCTYPE\s+/i.test(r.content) === !1) &&
  ...
  HTMLHint.addRule({
    ...
    init: function(e, t) {
      ...
      e.addListener('tagstart', function(e) {
        ...
        void 0 !== n[r] &&
          (e.close ||
            t.warn('The empty tag : [ ' + r + ' ] must be self closed.', e.line, e.col, a, e.raw))
      })
    }
  }),
  HTMLHint.addRule({
    ...
    init: function(e, t) {
      ...
      function n(i) {
        ...
        if (s && 'title' === o) {
          ...
          'head' === o &&
            (s === !1 && t.error('<title> must be present in <head> tag.', i.line, i.col, r, i.raw),
