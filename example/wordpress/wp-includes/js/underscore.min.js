...
;(function() {
  ...
  'undefined' != typeof exports
    ? ('undefined' != typeof module && module.exports && (exports = module.exports = v),
      (exports._ = v))
    : (n._ = v),
    (v.VERSION = '1.8.3')
  ...
  ;(v.each = v.forEach = function(n, t, r) {
    var e, u
    if (((t = y(t, r)), j(n))) for (e = 0, u = n.length; e < u; e++) t(n[e], e, n)
    else {
      var i = v.keys(n)
    ...
    (v.contains = v.includes = v.include = function(n, t, r, e) {
      return (
        j(n) || (n = v.values(n)), ('number' == typeof r && !e) || (r = 0), 0 <= v.indexOf(n, t, r)
      )
    }),
  ...
  var N = function(n, t, r, e) {
    ...
    if (!i) {
      ...
      if (
        o !== a &&
        !(v.isFunction(o) && o instanceof o && v.isFunction(a) && a instanceof a) &&
        'constructor' in n &&
        'constructor' in t
      )
        return !1
    ...
    if ((r.push(n), e.push(t), i)) {
      ...
      for (; c--; ) if (((f = l[c]), !v.has(t, f) || !N(n[f], t[f], r, e))) return !1
    }
  ...
  ;(v.template = function(i, n, t) {
    ...
    var r = RegExp(
        [(n.escape || z).source, (n.interpolate || z).source, (n.evaluate || z).source].join('|') +
          '|$',
        'g'
      ),
      o = 0,
