...
;(function($, _) {
  ...
  wp.media.collection = function(attributes) {
    ...
    return _.extend(
      /** @lends wp.media.collection.prototype */ {
        coerce: wp.media.coerce,
        /**
  ...
  if (wp.media.view.settings.galleryDefaults) {
    wp.media.galleryDefaults = _.extend(
      {},
      wp.media._galleryDefaults,
  ...
  wp.media.gallery = new wp.media.collection({
    ...
    setDefaults: function(attrs) {
      var self = this,
        changed = !_.isEqual(wp.media.galleryDefaults, wp.media._galleryDefaults)
      _.each(this.defaults, function(value, key) {
        attrs[key] = self.coerce(attrs, key)
  ...
  wp.media.editor = {
    ...
    add: function(id, options) {
      ...
      workflow = workflows[id] = wp.media(
        _.defaults(options || {}, {
          frame: 'post',
          state: 'insert',
      ...
      workflow.state('gallery-edit').on(
        'update',
        function(selection) {
          /**
           * @this wp.media.editor
      ...
      workflow.state('playlist-edit').on(
        'update',
        function(selection) {
          /**
           * @this wp.media.editor
      ...
      workflow.state('video-playlist-edit').on(
        'update',
        function(selection) {
          /**
           * @this wp.media.editor
