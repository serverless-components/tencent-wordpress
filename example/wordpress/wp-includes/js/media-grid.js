  ...
  /******/ [
    ...
    /***/ function(module, exports) {
      ...
      EditAttachmentMetadata = wp.media.controller.State.extend(
        /** @lends wp.media.controller.EditAttachmentMetadata.prototype */ {
          defaults: {
            id: 'edit-attachment',
    ...
    /***/ function(module, exports) {
      ...
      Manage = MediaFrame.extend(
        /** @lends wp.media.view.MediaFrame.Manage.prototype */ {
          /**
           * @constructs
           */
          initialize: function() {
    ...
    /***/ function(module, exports) {
      ...
      TwoColumn = Details.extend(
        /** @lends wp.media.view.Attachment.Details.TowColumn.prototype */ {
    ...
    /***/ function(module, exports) {
      ...
      Details = EditImage.extend(
        /** @lends wp.media.view.EditImage.Details.prototype */ {
        ...
        /** @lends wp.media.view.MediaFrame.EditAttachments.prototype */ {
          ...
          editImageMode: function(contentRegion) {
            ...
            this.gridRouter.navigate(
              this.gridRouter.baseUrl('?item=' + this.model.id + '&mode=edit')
            )
          },
          ...
          keyEvent: function(event) {
            if (
              ('INPUT' === event.target.nodeName || 'TEXTAREA' === event.target.nodeName) &&
    ...
    /***/ function(module, exports) {
      ...
      SelectModeToggle = Button.extend(
        /** @lends wp.media.view.SelectModeToggle.prototype */ {
          initialize: function() {
            _.defaults(this.options, {
              size: ''
            })
    ...
    /***/ function(module, exports) {
      ...
      DeleteSelected = Button.extend(
        /** @lends wp.media.view.DeleteSelectedButton.prototype */ {
          initialize: function() {
            Button.prototype.initialize.apply(this, arguments)
