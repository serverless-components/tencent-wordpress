...
!(function(i, e, o) {
  if (e && e.customize) {
    var n = e.customize
    ;(n.HeaderTool.CurrentView = e.Backbone.View.extend({
      ...
      (n.HeaderTool.ChoiceView = e.Backbone.View.extend({
        ...
        initialize: function() {
          ...
          this.listenTo(this.model, 'change:selected', this.toggleSelected),
            o.contains(e, n.get().header_image) &&
              n.HeaderTool.currentHeader.set(this.extendedModel())
        },
        render: function() {
        ...
        extendedModel: function() {
          ...
          return o.extend(this.model.toJSON(), { type: e.type })
        },
        select: function() {
          this.preventJump(),
            this.model.save(),
      ...
      (n.HeaderTool.ChoiceListView = e.Backbone.View.extend({
        initialize: function() {
        ...
        addOne: function(e) {
          var t
          e.set({ collection: this.collection }),
            (t = new n.HeaderTool.ChoiceView({ model: e })),
      ...
      (n.HeaderTool.CombinedList = e.Backbone.View.extend({
        initialize: function(e) {
          ;(this.collections = e), this.on('all', this.propagate, this)
        },
        propagate: function(t, i) {
