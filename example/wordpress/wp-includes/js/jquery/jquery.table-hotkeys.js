;(function($) {
  ...
  $.table_hotkeys = function(table, keys, opts) {
    ...
    get_first_row = function() {
      return $(opts.cycle_expr, table)
        .filter_visible()
        .eq(opts.start_row_index)
    }
    ...
    if (opts.highlight_first) set_current_row(first_row)
    else if (opts.highlight_last) set_current_row(get_last_row())
