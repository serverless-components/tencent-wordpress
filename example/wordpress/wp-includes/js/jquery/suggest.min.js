  ...
  ;(a.suggest = function(b, c) {
    ...
    function e(a) {
      if (
        ...
        o.val().length != r &&
          (q && clearTimeout(q), (q = setTimeout(f, c.delay)), (r = o.val().length))
    }
    function f() {
      var b,
        d,
    ...
    function g(a) {
      var b
      for (b = 0; b < s.length; b++) if (s[b].q == a) return s.unshift(s.splice(b, 1)[0]), s[0]
      return !1
    }
    function h(a, b, d) {
      for (var e; s.length && t + d > c.maxCacheSize; ) (e = s.pop()), (t -= e.size)
      ...
      if (b) {
        ...
        p.html(f).show(),
          p
            .children('li')
            .mouseover(function() {
              p.children('li').removeClass(c.selectClass), a(this).addClass(c.selectClass)
            })
            .click(function(a) {
        ...
        $currentResult &&
          (c.multiple
            ? (-1 != o.val().indexOf(c.multipleSep)
                ? ($currentVal =
                    o.val().substr(0, o.val().lastIndexOf(c.multipleSep) + c.multipleSep.length) +
                    ' ')
                : ($currentVal = ''),
