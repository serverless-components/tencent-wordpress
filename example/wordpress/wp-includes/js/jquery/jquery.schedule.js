  ...
  $.scheduler.prototype = {
    schedule: function() {
      ...
      if (
        ...
        (typeof arguments[i] == 'string' && arguments[i].match(RegExp('^[0-9]+[smhdw]$')))
      )
      ...
      if (
        ...
        (_isfn(arguments[i]) || typeof arguments[i] == 'string')
      )
        ctx['func'] = arguments[i++]
      while (typeof arguments[i] != 'undefined') ctx['args'].push(arguments[i++])
      if (override) {
      ...
      if (ctx['id'] == null)
        ctx['id'] =
          ...
          String(ctx['args'])
      if (ctx['protect'])
        if (typeof this.bucket[ctx['id']] != 'undefined') return this.bucket[ctx['id']]
      if (!_isfn(ctx['func'])) {
        if (
          ctx['obj'] != null &&
