...
!(function(e) {
  ...
  return l.widget('ui.accordion', {
    ...
    _getCreateEventData: function() {
      return { header: this.active, panel: this.active.length ? this.active.next() : l() }
    },
    ...
    refresh: function() {
      ...
      this._processPanels(),
        (!1 === e.active && !0 === e.collapsible) || !this.headers.length
          ? ((e.active = !1), (this.active = l()))
          : !1 === e.active
          ? this._activate(0)
          : this.active.length && !l.contains(this.element[0], this.active[0])
    ...
    _activate: function(e) {
      ...
      t !== this.active[0] &&
        ((t = t || this.active[0]),
        this._eventHandler({ target: t, currentTarget: t, preventDefault: l.noop }))
    },
    ...
    _eventHandler: function(e) {
      var t,
        ...
        o = r ? l() : n.next(),
        d = s.next(),
        c = { oldHeader: s, oldPanel: d, newHeader: r ? l() : n, newPanel: o }
      e.preventDefault(),
        (h && !a.collapsible) ||
          !1 === this._trigger('beforeActivate', e, c) ||
          ((a.active = !r && this.headers.index(n)),
          (this.active = h ? l() : n),
          this._toggle(c),
          this._removeClass(s, 'ui-accordion-header-active', 'ui-state-active'),
          a.icons &&
            ((t = s.children('.ui-accordion-header-icon')),
            this._removeClass(t, null, a.icons.activeHeader)._addClass(t, null, a.icons.header)),
          h ||
            ...
            a.icons &&
              ((i = n.children('.ui-accordion-header-icon')),
            ...
            ? ((s = e.show().outerHeight()),
              ...
              void e.hide().animate(this.showProps, {
                ...
                step: function(e, t) {
                  ;(t.now = Math.round(e)),
                    'height' !== t.prop
                      ? 'content-box' === d && (o += t.now)
                      : 'content' !== r.options.heightStyle &&
                        ((t.now = Math.round(s - i.outerHeight() - o)), (o = 0))
                }
              }))
            : i.animate(this.hideProps, h, n, a)
          : e.animate(this.showProps, h, n, a)
      )
    },
