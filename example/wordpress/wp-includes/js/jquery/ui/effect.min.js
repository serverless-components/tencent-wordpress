...
!(function(t) {
  ...
  function M(t, e, n) {
    ...
    return null == t
      ...
      : ((t = r.floor ? ~~t : parseFloat(t)),
        isNaN(t) ? e.def : r.mod ? (t + r.mod) % r.mod : t < 0 ? 0 : r.max < t ? r.max : t)
  }
  function B(s) {
    var a = h(),
      c = (a._rgba = [])
    return (
      ...
      b(t, function(t, e) {
        var n,
          ...
          i = r && e.parse(r),
          o = e.space || 'rgba'
        if (i) return (n = a[o](i)), (a[g[o].cache] = n[g[o].cache]), (c = a._rgba = n._rgba), !1
      }),
      c.length ? ('0,0,0,0' === c.join() && u.extend(c, f.transparent), a) : f[s]
    )
  }
  function H(t, e, n) {
    return 6 * (n = (n + 1) % 1) < 1
  ...
  function I(t) {
    ...
    if (r && r.length && r[0] && r[r[0]])
      for (n = r.length; n--; ) 'string' == typeof r[(e = r[n])] && (i[d.camelCase(e)] = r[e])
  ...
  function T(t, e, n, r) {
    return (
      ...
      (t = { effect: t }),
      null == e && (e = {}),
      d.isFunction(e) && ((r = e), (n = null), (e = {})),
      ('number' != typeof e && !d.fx.speeds[e]) || ((r = n), (n = e), (e = {})),
      d.isFunction(n) && ((r = n), (n = null)),
      e && d.extend(t, e),
      (n = n || e.duration),
      (t.duration = d.fx.off
        ? 0
  ...
  return (
    ...
    (h.fn = u.extend(h.prototype, {
      parse: function(i, t, e, n) {
        if (i === l) return (this._rgba = [null, null, null, null]), this
        ;(i.jquery || i.nodeType) && ((i = u(i).css(t)), (t = l))
        var o = this,
          r = u.type(i),
          s = (this._rgba = [])
        return (
          t !== l && ((i = [i, t, e, n]), (r = 'array')),
          'string' === r
            ? this.parse(B(i) || f._default)
            : 'array' === r
                ...
                i instanceof h
                  ...
                  : function(t, n) {
                      ...
                      b(n.props, function(t, e) {
                        ...
                        o[r] &&
                          u.inArray(null, o[r].slice(0, 3)) < 0 &&
        ...
        return (
          ...
          b(n.props, function(t, e) {
            ...
            null !== i &&
              (null === r
                ? (f[n] = i)
                : (o.mod && (i - r > o.mod / 2 ? (r += o.mod) : r - i > o.mod / 2 && (r -= o.mod)),
                  (f[n] = M((i - r) * s + r, e))))
          }),
          this[e](f)
        )
      ...
      toHslaString: function() {
        var t = 'hsla(',
          e = u.map(this.hsla(), function(t, e) {
            return (
              null == t && (t = 2 < e ? 1 : 0), e && e < 3 && (t = Math.round(100 * t) + '%'), t
            )
          })
      ...
      return (
        (e =
          c === a
            ...
            ? (60 * (o - r)) / f + 120
            : (60 * (r - i)) / f + 240),
        (n = 0 == f ? 0 : l <= 0.5 ? f / u : f / (2 - u)),
        [Math.round(e) % 360, n, l, null == s ? 1 : s]
      )
    }),
    (g.hsla.from = function(t) {
      ...
      var e = t[0] / 360,
        ...
        s = 2 * r - o
      return [
        Math.round(255 * H(s, o, e + 1 / 3)),
        Math.round(255 * H(s, o, e)),
        Math.round(255 * H(s, o, e - 1 / 3)),
        i
      ]
    }),
    b(g, function(c, t) {
      var n = t.props,
        ...
        f = t.from
      ;(h.fn[c] = function(t) {
        if ((a && !this[s] && (this[s] = a(this._rgba)), t === l)) return this[s].slice()
        var e,
          r = u.type(t),
          i = 'array' === r || 'object' === r ? t : arguments,
          o = this[s].slice()
        return (
          b(n, function(t, e) {
            var n = i['object' === r ? t : e.idx]
            null == n && (n = o[e.idx]), (o[e.idx] = M(n, e))
          }),
          f ? (((e = h(f(o)))[s] = o), e) : h(o)
        )
      }),
        b(n, function(s, a) {
          h.fn[s] ||
            (h.fn[s] = function(t) {
              ...
              return 'undefined' === n
                ? o
                : ('function' === n && ((t = t.call(this, o)), (n = u.type(t))),
                  null == t && a.empty
                    ? this
                    : ('string' === n &&
                        (e = p.exec(t)) &&
        ...
        ;(u.cssHooks[o] = {
          set: function(t, e) {
            var n,
              r,
              i = ''
            if ('transparent' !== e && ('string' !== u.type(e) || (n = B(e)))) {
              if (((e = h(n || e)), !s.rgba && 1 !== e._rgba[3])) {
                for (
                  ...
                  try {
                    ;(i = u.css(r, 'backgroundColor')), (r = r.parentNode)
                  } catch (t) {}
          ...
          (u.fx.step[o] = function(t) {
            t.colorInit || ((t.start = h(t.elem, o)), (t.end = h(t.end)), (t.colorInit = !0)),
    ...
    d.each(['borderLeftStyle', 'borderRightStyle', 'borderBottomStyle', 'borderTopStyle'], function(
      t,
      e
    ) {
    ...
    (d.effects.animateClass = function(i, t, e, n) {
      var o = d.speed(t, e, n)
      return this.queue(function() {
        ...
        ;(r = r.map(function() {
          return { el: d(this), start: I(this) }
        })),
          (t = function() {
            d.each(c, function(t, e) {
              i[e] && n[e + 'Class'](i[e])
            })
          })(),
          (r = r.map(function() {
            return (
              ...
              (this.diff = (function(t, e) {
                ...
                for (n in e)
                  (r = e[n]),
                    t[n] !== r && (v[n] || (!d.fx.step[n] && isNaN(parseFloat(r))) || (i[n] = r))
                return i
              })(this.start, this.end)),
              this
            )
          ...
          d.when.apply(d, r.get()).done(function() {
            t(),
    ...
    d.fn.extend({
      addClass:
        ...
        function(t, e, n, r) {
          return e
            ? d.effects.animateClass.call(this, { add: t }, e, n, r)
      ...
      removeClass:
        ...
        function(t, e, n, r) {
          return 1 < arguments.length
            ? d.effects.animateClass.call(this, { remove: t }, e, n, r)
      ...
      toggleClass:
        ...
        function(t, e, n, r, i) {
          return 'boolean' == typeof e || void 0 === e
            ? n
              ? d.effects.animateClass.call(this, e ? { add: t } : { remove: t }, n, r, i)
              : o.apply(this, arguments)
            : d.effects.animateClass.call(this, { toggle: t }, e, n, r)
        }),
      switchClass: function(t, e, n, r, i) {
        return d.effects.animateClass.call(this, { add: e, remove: t }, n, r, i)
      }
    }),
    d.expr &&
      d.expr.filters &&
      ...
      (d.expr.filters.animated =
        ((n = d.expr.filters.animated),
        function(t) {
          return !!d(t).data(_) || n(t)
        })),
    !1 !== d.uiBackCompat &&
      d.extend(d.effects, {
        save: function(t, e) {
        ...
        createWrapper: function(n) {
          ...
          return (
            n.wrap(t),
            (n[0] !== i && !d.contains(n[0], i)) || d(i).trigger('focus'),
            (t = n.parent()),
            'static' === n.css('position')
              ? (t.css({ position: 'relative' }), n.css({ position: 'relative' }))
              : (d.extend(r, { position: n.css('position'), zIndex: n.css('z-index') }),
    ...
    d.fn.extend({
      effect: function() {
        function t(t) {
          var e = d(this),
            n = d.effects.mode(e, a) || o
          e.data(_, !0),
            c.push(n),
            o && ('show' === n || (n === o && 'hide' === n)) && e.show(),
            (o && 'none' === n) || d.effects.saveStyle(e),
            d.isFunction(t) && t()
        }
        var r = T.apply(this, arguments),
          i = d.effects.effect[r.effect],
          o = i.mode,
          e = r.queue,
          n = e || 'fx',
          s = r.complete,
        ...
        function f(t) {
          var e = d(this)
          function n() {
            d.isFunction(s) && s.call(e[0]), d.isFunction(t) && t()
          }
          ;(r.mode = c.shift()),
            !1 === d.uiBackCompat || o
              ? 'none' === r.mode
                ...
                : i.call(e[0], r, function() {
                    e.removeData(_), d.effects.cleanUp(e), 'hide' === r.mode && e.hide(), n()
                  })
              : (e.is(':hidden')
                ? 'hide' === a
                : 'show' === a)
        ...
        return !1 === e ? this.each(t).each(f) : this.queue(n, t).queue(n, f)
      },
      show:
        ((x = d.fn.show),
        function(t) {
      ...
      transfer: function(t, e) {
        var n = d(this),
          ...
          a = i ? o.scrollLeft() : 0,
          c = r.offset(),
          f = { top: c.top - s, left: c.left - a, height: r.innerHeight(), width: r.innerWidth() },
          u = n.offset(),
          l = d("<div class='ui-effects-transfer'></div>")
            .appendTo('body')
            ...
            .animate(f, t.duration, t.easing, function() {
              l.remove(), d.isFunction(e) && e()
            })
      }
    }),
