  ...
  return (
    l.widget('ui.tabs', {
      ...
      _isLocal:
        ...
        function(t) {
          var e, i
          ;(e = t.href.replace(a, '')), (i = location.href.replace(a, ''))
          try {
      ...
      _findNextTab: function(t, e) {
        ...
        for (; -1 !== l.inArray((i < t && (t = 0), t < 0 && (t = i), t), this.options.disabled); )
          t = e ? t + 1 : t - 1
        return t
      },
      ...
      _processTabs: function() {
        ...
        ;(this.tablist = this._getList().attr('role', 'tablist')),
          ...
          this.anchors.each(function(t, e) {
            ...
            o._isLocal(e)
              ? ((s = (i = e.hash).substring(1)), (a = o.element.find(o._sanitizeSelector(i))))
              : ((i = '#' + (s = h.attr('aria-controls') || l({}).uniqueId()[0].id)),
                (a = o.element.find(i)).length ||
                  (a = o._createPanel(s)).insertAfter(o.panels[t - 1] || o.tablist),
                a.attr('aria-live', 'polite')),
              a.length && (o.panels = o.panels.add(a)),
              r && h.data('ui-tabs-aria-controls', r),
              h.attr({ 'aria-controls': s, 'aria-labelledby': n }),
      ...
      _eventHandler: function(t) {
        var e = this.options,
          ...
          o = { oldTab: i, oldPanel: r, newTab: n ? l() : a, newPanel: h }
        t.preventDefault(),
      ...
      _toggle: function(t, e) {
        ...
        function h() {
          i._addClass(e.newTab.closest('li'), 'ui-tabs-active', 'ui-state-active'),
            a.length && i.options.show ? i._show(a, i.options.show, n) : (a.show(), n())
        }
        ;(this.running = !0),
      ...
      _activate: function(t) {
        ...
        i[0] !== this.active[0] &&
          ...
          this._eventHandler({ target: e, currentTarget: e, preventDefault: l.noop }))
      },
        ...
        return (
          'string' == typeof t &&
            (t = this.anchors.index(
              this.anchors.filter("[href$='" + l.ui.escapeSelector(t) + "']")
            )),
          t
        )
      },
      ...
      load: function(t, a) {
        ...
        var n = this,
          ...
          r = { tab: i, panel: h }
        this._isLocal(e[0]) ||
          ((this.xhr = l.ajax(this._ajaxSettings(e, a, r))),
          this.xhr &&
      ...
      _ajaxSettings: function(t, i, a) {
        ...
        return {
          ...
          beforeSend: function(t, e) {
            return s._trigger('beforeLoad', i, l.extend({ jqXHR: t, ajaxSettings: e }, a))
          }
        }
      },
