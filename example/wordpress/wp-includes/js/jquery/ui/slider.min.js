  ...
  return o.widget('ui.slider', o.ui.mouse, {
    ...
    _createHandles: function() {
      ...
      for (
        t = (i.values && i.values.length) || 1,
          s.length > t && (s.slice(t).remove(), (s = s.slice(0, t))),
          e = s.length;
        e < t;
        e++
      )
        a.push("<span tabindex='0'></span>")
      ;(this.handles = s.add(o(a.join('')).appendTo(this.element))),
        ...
        ? (!0 === e.range &&
            (e.values
              ? e.values.length && 2 !== e.values.length
                ...
                : o.isArray(e.values) && (e.values = e.values.slice(0))
    ...
    _mouseCapture: function(e) {
      ...
      return (
        ...
        this.handles.each(function(e) {
          ...
          ;(t < s || (s === t && (e === u._lastChangedValue || u.values(e) === r.min))) &&
            ((s = t), (a = o(this)), (n = e))
        }),
        !1 !== this._start(e, n) &&
    ...
    _uiHash: function(e, t, i) {
      ...
      return (
        this._hasMultipleValues() &&
          ((s.value = void 0 !== t ? t : this.values(e)), (s.values = i || this.values())),
        s
      )
    },
    ...
    _setOption: function(e, t) {
      ...
      switch (
        ...
        o.isArray(this.options.values) && (s = this.options.values.length),
        this._super(e, t),
        e)
      ) {
        case 'orientation':
      ...
      this._hasMultipleValues()
        ? this.handles.each(function(e) {
            ;(i = ((l.values(e) - l._valueMin()) / (l._valueMax() - l._valueMin())) * 100),
              ...
              o(this)
                .stop(1, 1)
                [u ? 'animate' : 'css'](r, h.animate),
              !0 === l.options.range &&
                ('horizontal' === l.orientation
                  ? (0 === e &&
                      l.range.stop(1, 1)[u ? 'animate' : 'css']({ left: i + '%' }, h.animate),
                    1 === e &&
                  ...
                  : (0 === e &&
                      l.range.stop(1, 1)[u ? 'animate' : 'css']({ bottom: i + '%' }, h.animate),
                    1 === e &&
                      l.range[u ? 'animate' : 'css'](
                        { height: i - t + '%' },
                        { queue: !1, duration: h.animate }
        ...
        : ((e = this.value()),
          ...
          'min' === n &&
            'horizontal' === this.orientation &&
            this.range.stop(1, 1)[u ? 'animate' : 'css']({ width: i + '%' }, h.animate),
          'max' === n &&
            'horizontal' === this.orientation &&
            this.range.stop(1, 1)[u ? 'animate' : 'css']({ width: 100 - i + '%' }, h.animate),
          'min' === n &&
            'vertical' === this.orientation &&
            this.range.stop(1, 1)[u ? 'animate' : 'css']({ height: i + '%' }, h.animate),
          'max' === n &&
            'vertical' === this.orientation &&
            this.range.stop(1, 1)[u ? 'animate' : 'css']({ height: 100 - i + '%' }, h.animate))
    },
    _handleEvents: {
      keydown: function(e) {
        var t,
