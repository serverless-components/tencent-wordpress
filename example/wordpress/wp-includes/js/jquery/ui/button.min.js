...
!(function(t) {
  'function' == typeof define && define.amd
    ? define(['jquery', './controlgroup', './checkboxradio', './core'], t)
    : t(jQuery)
})(function(e) {
  var t
  return (
    e.widget('ui.button', {
      ...
      _updateIcon: function(t, i) {
        var o = 'iconPosition' !== t,
          s = o ? this.options.iconPosition : i,
          n = 'top' === s || 'bottom' === s
        this.icon
          ? o && this._removeClass(this.icon, null, this.options.icon)
          : ((this.icon = e('<span>')),
            this._addClass(this.icon, 'ui-button-icon', 'ui-icon'),
            this.options.showLabel || this._addClass('ui-button-icon-only')),
          o && this._addClass(this.icon, null, i),
          this._attachIcon(s),
          n
      ...
      _setOption: function(t, i) {
        'icon' === t &&
          ...
          'disabled' === t &&
            ...
            (this.element[0].disabled = i) && this.element.blur())
      },
      refresh: function() {
            ...
            ? ('showLabel' === t && (this.options.text = i),
              ...
              'icons' === t &&
                (i.primary
                  ...
                  : i.secondary &&
                    (this._super('icon', i.secondary), this._super('iconPosition', 'end'))),
