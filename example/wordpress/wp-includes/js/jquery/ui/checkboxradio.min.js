      ...
      o.ui.formResetMixin,
      {
        ...
        _getCreateOptions: function() {
          ...
          return (
            ...
            (this.label = o(i[i.length - 1])),
            this.label.length || o.error('No label found for checkboxradio widget'),
            (this.originalLabel = ''),
            this.label
              .contents()
              .not(this.element[0])
        ...
        _getRadioGroup: function() {
          ...
          return e
            ? (this.form.length
                ? o(this.form[0].elements).filter(i)
                : o(i).filter(function() {
