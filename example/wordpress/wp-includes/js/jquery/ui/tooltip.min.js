...
!(function(t) {
  ...
  return (
    d.widget('ui.tooltip', {
          ...
          t &&
            ...
            i.parents().each(function() {
              ...
              i.data('ui-tooltip-open') &&
                (((t = d.Event('blur')).target = t.currentTarget = this), e.close(t, !0)),
                i.attr('title') &&
                  (i.uniqueId(),
      ...
      _open: function(t, i, e) {
        var o,
          ...
          s,
          l,
          a = d.extend({}, this.options.position)
        function r(t) {
          ;(a.of = t), n.is(':hidden') || n.position(a)
        }
        e &&
          ((o = this._find(i))
            ? o.tooltip.find('.ui-tooltip-content').html(e)
            : (i.is('[title]') &&
                (t && 'mouseover' === t.type ? i.attr('title', '') : i.removeAttr('title')),
              (o = this._tooltip(i)),
              (n = o.tooltip),
              this._addDescribedBy(i, n.attr('id')),
              n.find('.ui-tooltip-content').html(e),
              this.liveRegion.children().hide(),
              (l = d('<div>').html(n.find('.ui-tooltip-content').html()))
                .removeAttr('name')
                .find('[name]')
                .removeAttr('name'),
              l
              ...
              this.options.track && t && /^mouse/.test(t.type)
                ...
                : n.position(d.extend({ of: i }, this.options.position)),
              n.hide(),
              this._show(n, this.options.show),
              this.options.track &&
                this.options.show &&
                this.options.show.delay &&
                (s = this.delayedShow = setInterval(function() {
        ...
        n
          ? ((i = n.tooltip),
            n.closing ||
              ...
              t &&
                'mouseleave' === t.type &&
                d.each(this.parents, function(t, i) {
      ...
      _tooltip: function(t) {
        ...
        return (
          this._addClass(e, 'ui-tooltip-content'),
    ...
    !1 !== d.uiBackCompat &&
      d.widget('ui.tooltip', d.ui.tooltip, {
