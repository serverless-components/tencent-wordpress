  ...
  return u.widget('ui.sortable', u.ui.mouse, {
    ...
    _mouseCapture: function(t, e) {
      ...
      return (
        ...
        u.data(t.target, o.widgetName + '-item') === o && (i = u(t.target)),
        !!i &&
          !(
            this.options.handle &&
            !e &&
    ...
    _mouseStart: function(t, e, i) {
      ...
      return (
        ...
        u.ui.ddmanager && !r.dropBehaviour && u.ui.ddmanager.prepareOffsets(this, t),
        (this.dragging = !0),
          ...
          this.options.scroll &&
            (this.scrollParent[0] !== this.document[0] && 'HTML' !== this.scrollParent[0].tagName
              ...
              : (t.pageY - this.document.scrollTop() < r.scrollSensitivity
                  ? (n = this.document.scrollTop(this.document.scrollTop() - r.scrollSpeed))
                  : this.window.height() - (t.pageY - this.document.scrollTop()) <
                      r.scrollSensitivity &&
                    (n = this.document.scrollTop(this.document.scrollTop() + r.scrollSpeed)),
                t.pageX - this.document.scrollLeft() < r.scrollSensitivity
                  ? (n = this.document.scrollLeft(this.document.scrollLeft() - r.scrollSpeed))
        ...
        if (
          ...
          (o = this._intersectsWithPointer(i)) &&
            ...
            !(
              ...
              ('semi-dynamic' === this.options.type && u.contains(this.element[0], s))
            ))
        ) {
          if (
    ...
    _mouseStop: function(t, e) {
      if (t) {
        if (
          (u.ui.ddmanager && !this.options.dropBehaviour && u.ui.ddmanager.drop(this, t),
          this.options.revert)
        ) {
          var i = this,
          ...
          ;(o && 'x' !== o) ||
            ...
            (this.reverting = !0),
            u(this.helper).animate(r, parseInt(this.options.revert, 10) || 500, function() {
              i._clear(t)
            })
      ...
      return (
        this.placeholder &&
          ...
          'original' !== this.options.helper &&
            ...
            this.helper.remove(),
          u.extend(this, { helper: null, dragging: !1, reverting: !1, _noFinalSort: null }),
    ...
    _intersectsWith: function(t) {
      var e = this.positionAbs.left,
        ...
        f = 'y' === this.options.axis || (r < e + c && e + c < n),
        u = p && f
    ...
    _getItemsAsjQuery: function(t) {
      ...
      for (
        n.push([
          u.isFunction(this.options.items)
        ...
        for (e = p.length - 1; 0 <= e; e--)
          for (i = (s = u(p[e], this.document[0])).length - 1; 0 <= i; i--)
            (o = u.data(s[i], this.widgetFullName)) &&
              ...
              (c.push([
                u.isFunction(o.options.items)
                  ? o.options.items.call(o.element[0], t, { item: this.currentItem })
                  : u(o.options.items, o.element),
                o
              ]),
              this.containers.push(o))
      for (e = c.length - 1; 0 <= e; e--)
        for (r = c[e][1], i = 0, a = (n = c[e][0]).length; i < a; i++)
          (h = u(n[i])).data(this.widgetName + '-item', r),
            l.push({ item: h, instance: r, width: 0, height: 0, left: 0, top: 0 })
    },
    refreshPositions: function(t) {
      ...
      for (
        ...
        ((i = this.items[e]).instance !== this.currentContainer &&
          ...
          ((s = this.options.toleranceElement ? u(this.options.toleranceElement, i.item) : i.item),
      ...
      ;(o.placeholder && o.placeholder.constructor !== String) ||
        ...
        (o.placeholder = {
          element: function() {
            ...
            return (
              i
                ._addClass(e, 'ui-sortable-placeholder', s || i.currentItem[0].className)
                ._removeClass(e, 'ui-sortable-helper'),
              'tbody' === t
                ? i._createTrPlaceholder(
                    i.currentItem.find('tr').eq(0),
                    u('<tr>', i.document[0]).appendTo(e)
                  )
                : 'tr' === t
        ...
        (i.placeholder = u(o.placeholder.element.call(i.element, i.currentItem))),
      ...
      if (p)
        if (1 === this.containers.length)
          ...
          for (
            s = 1e4,
              o = null,
              r = (l = p.floating || this._isFloating(this.currentItem)) ? 'left' : 'top',
              n = l ? 'width' : 'height',
              c = l ? 'pageX' : 'pageY',
            ...
            u.contains(this.containers[f].element[0], this.items[i].item[0]) &&
              this.items[i].item[0] !== this.currentItem[0] &&
              ((h = this.items[i].item.offset()[r]),
              (a = !1),
              t[c] - h > this.items[i][n] / 2 && (a = !0),
              Math.abs(t[c] - h) < s &&
                ((s = Math.abs(t[c] - h)),
                (o = this.items[i]),
    ...
    _createHelper: function(t) {
      ...
      return (
        i.parents('body').length ||
          u('parent' !== e.appendTo ? e.appendTo : this.currentItem[0].parentNode)[0].appendChild(
            i[0]
          ),
    ...
    _adjustOffsetFromHelper: function(t) {
      'string' == typeof t && (t = t.split(' ')),
        u.isArray(t) && (t = { left: +t[0], top: +t[1] || 0 }),
    ...
    _convertPositionTo: function(t, e) {
      ...
      return {
        top:
          ...
          ('fixed' === this.cssPosition ? -this.scrollParent.scrollTop() : o ? 0 : s.scrollTop()) *
            i,
        left:
          e.left +
    ...
    _generatePosition: function(t) {
      ...
      return (
        ...
        this.originalPosition &&
          ...
          s.grid &&
            ((e =
              this.originalPageY + Math.round((r - this.originalPageY) / s.grid[1]) * s.grid[1]),
            (r = this.containment
              ...
              : i))),
        {
          top:
            ...
            this.offset.parent.top +
            ('fixed' === this.cssPosition ? -this.scrollParent.scrollTop() : h ? 0 : n.scrollTop()),
          left:
            o -
