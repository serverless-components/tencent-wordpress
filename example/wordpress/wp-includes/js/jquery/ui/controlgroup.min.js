  ...
  return u.widget('ui.controlgroup', {
    ...
    _initWidgets: function() {
      ...
      u.each(this.options.items, function(o, t) {
        var e,
          s = {}
        if (t)
          return 'controlgroupLabel' === o
            ? ((e = l.element.find(t)).each(function() {
                var t = u(this)
                t.children('.ui-controlgroup-label-contents').length ||
                  t.contents().wrapAll("<span class='ui-controlgroup-label-contents'></span>")
              }),
              l._addClass(e, null, 'ui-widget ui-widget-content ui-state-default'),
              void (r = r.concat(e.get())))
            : void (
                u.fn[o] &&
                ((s = l['_' + o + 'Options'] ? l['_' + o + 'Options']('middle') : { classes: {} }),
                l.element.find(t).each(function() {
                  ...
                  if ('button' !== o || !t.parent('.ui-spinner').length) {
                    ;(e = e || t[o]()[o]('instance')) &&
                      (i.classes = l._resolveClassesValues(i.classes, e)),
                      t[o](i)
                    var n = t[o]('widget')
        ...
        (this.childWidgets = u(u.unique(r))),
    ...
    refresh: function() {
      ...
      this._addClass('ui-controlgroup ui-controlgroup-' + this.options.direction),
        ...
        this._initWidgets(),
        (o = this.childWidgets),
        this.options.onlyVisible && (o = o.filter(':visible')),
        o.length &&
