...
!(function(i) {
  'function' == typeof define && define.amd
    ? define(['jquery', './button', './draggable', './mouse', './resizable', './core'], i)
    : i(jQuery)
})(function(h) {
  return (
    h.widget('ui.dialog', {
      ...
      _create: function() {
        ;(this.originalCss = {
          ...
          this.options.draggable && h.fn.draggable && this._makeDraggable(),
          this.options.resizable && h.fn.resizable && this._makeResizable(),
          (this._isOpen = !1),
          this._trackFocus()
      },
      _init: function() {
      ...
      _appendTo: function() {
        ...
        return i && (i.jquery || i.nodeType) ? h(i) : this.document.find(i || 'body').eq(0)
      },
      _destroy: function() {
        var i,
      ...
      close: function(i) {
        var t = this
        this._isOpen &&
          !1 !== this._trigger('beforeClose', i) &&
          ((this._isOpen = !1),
          (this._focusedElement = null),
          this._destroyOverlay(),
          this._untrackInstance(),
          this.opener.filter(':focusable').trigger('focus').length ||
            h.ui.safeBlur(h.ui.safeActiveElement(this.document[0])),
      ...
      _moveToTop: function(i, t) {
        var e = !1,
          o = this.uiDialog
            ...
            .map(function() {
              return +h(this).css('z-index')
            })
            .get(),
          s = Math.max.apply(null, o)
        return (
          s >= +this.uiDialog.css('z-index') && (this.uiDialog.css('z-index', s + 1), (e = !0)),
      ...
      open: function() {
        ...
        this._isOpen
          ...
          : ((this._isOpen = !0),
            (this.opener = h(h.ui.safeActiveElement(this.document[0]))),
            this._size(),
            this._position(),
            this._createOverlay(),
      ...
      _focusTabbable: function() {
        ...
        ;(i = i || this.element.find('[autofocus]')).length || (i = this.element.find(':tabbable')),
      ...
      _keepFocus: function(i) {
        function t() {
          var i = h.ui.safeActiveElement(this.document[0])
          this.uiDialog[0] === i || h.contains(this.uiDialog[0], i) || this._focusTabbable()
        }
        i.preventDefault(), t.call(this), this._delay(t)
      },
          ...
          this._on(this.uiDialog, {
            keydown: function(i) {
              if (
                ...
                i.keyCode &&
                i.keyCode === h.ui.keyCode.ESCAPE
              )
                return i.preventDefault(), void this.close(i)
              if (i.keyCode === h.ui.keyCode.TAB && !i.isDefaultPrevented()) {
                var t = this.uiDialog.find(':tabbable'),
                  e = t.filter(':first'),
                  o = t.filter(':last')
                ;(i.target !== o[0] && i.target !== this.uiDialog[0]) || i.shiftKey
                  ? (i.target !== e[0] && i.target !== this.uiDialog[0]) ||
                    !i.shiftKey ||
      ...
      _createTitlebar: function() {
        ...
        ;(this.uiDialogTitlebar = h('<div>')),
          ...
          this._on(this.uiDialogTitlebar, {
            mousedown: function(i) {
              h(i.target).closest('.ui-dialog-titlebar-close') || this.uiDialog.trigger('focus')
            }
          }),
          (this.uiDialogTitlebarClose = h("<button type='button'></button>")
            .button({
              label: h('<a>')
      ...
      _createButtonPane: function() {
        ;(this.uiDialogButtonPane = h('<div>')),
          this._addClass(
            this.uiDialogButtonPane,
            'ui-dialog-buttonpane',
            'ui-widget-content ui-helper-clearfix'
          ),
          (this.uiButtonSet = h('<div>').appendTo(this.uiDialogButtonPane)),
      ...
      _createButtons: function() {
        ...
        this.uiDialogButtonPane.remove(),
          ...
          h.isEmptyObject(i) || (h.isArray(i) && !i.length)
            ? this._removeClass(this.uiDialog, 'ui-dialog-buttons')
            : (h.each(i, function(i, t) {
                var e, o
                ;(t = h.isFunction(t) ? { click: t, text: i } : t),
                  (t = h.extend({ type: 'button' }, t)),
                  (e = t.click),
                  (o = {
                    icon: t.icon,
      ...
      _makeDraggable: function() {
        ...
        this.uiDialog.draggable({
          ...
          start: function(i, t) {
            s._addClass(h(this), 'ui-dialog-dragging'),
              s._blockFrames(),
          ...
          stop: function(i, t) {
            ...
            ;(n.position = {
              ...
              s._removeClass(h(this), 'ui-dialog-dragging'),
              s._unblockFrames(),
      ...
      _makeResizable: function() {
        var n = this,
          ...
          e = 'string' == typeof i ? i : 'n,e,s,w,se,sw,ne,nw'
        function l(i) {
          return {
        ...
        this.uiDialog
          .resizable({
            ...
            handles: e,
            start: function(i, t) {
              n._addClass(h(this), 'ui-dialog-resizing'),
                n._blockFrames(),
                n._trigger('resizeStart', i, l(t))
            },
            resize: function(i, t) {
              n._trigger('resize', i, l(t))
            },
            stop: function(i, t) {
              var e = n.uiDialog.offset(),
                o = e.left - n.document.scrollLeft(),
                s = e.top - n.document.scrollTop()
              ;(a.height = n.uiDialog.height()),
                (a.width = n.uiDialog.width()),
                (a.position = {
                  my: 'left top',
                  at: 'left' + (0 <= o ? '+' : '') + o + ' top' + (0 <= s ? '+' : '') + s,
                  of: n.window
                }),
                n._removeClass(h(this), 'ui-dialog-resizing'),
                n._unblockFrames(),
                n._trigger('resizeStop', i, l(t))
            }
          })
          .css('position', t)
      },
      _trackFocus: function() {
        this._on(this.widget(), {
          focusin: function(i) {
            this._makeFocusTarget(), (this._focusedElement = h(i.target))
          }
        })
      },
      ...
      _setOption: function(i, t) {
        ...
        'disabled' !== i &&
          ...
          'draggable' === i &&
            ((e = s.is(':data(ui-draggable)')) && !t && s.draggable('destroy'),
            !e && t && this._makeDraggable()),
          'position' === i && this._position(),
          'resizable' === i &&
            ((o = s.is(':data(ui-resizable)')) && !t && s.resizable('destroy'),
      ...
      _blockFrames: function() {
        this.iframeBlocks = this.document.find('iframe').map(function() {
          var i = h(this)
          return h('<div>')
            .css({ position: 'absolute', width: i.outerWidth(), height: i.outerHeight() })
            .appendTo(i.parent())
            .offset(i.offset())[0]
        })
      },
      ...
      _allowInteraction: function(i) {
        return (
          !!h(i.target).closest('.ui-dialog').length ||
          !!h(i.target).closest('.ui-datepicker').length
        )
      },
              ...
              this._on(this.document, {
                focusin: function(i) {
                  t ||
                    ...
                    (i.preventDefault(), this._trackingInstances()[0]._focusTabbable())
                }
              }),
            (this.overlay = h('<div>').appendTo(this._appendTo())),
