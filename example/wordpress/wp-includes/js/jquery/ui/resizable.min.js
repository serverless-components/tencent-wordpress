  ...
  return (
    w.widget('ui.resizable', w.ui.mouse, {
      ...
      _hasScroll: function(t, i) {
        ...
        return 0 < t[s] || ((t[s] = 1), (e = 0 < t[s]), (t[s] = 0), e)
      },
      _create: function() {
        var t,
          i = this.options,
        ...
        this._addClass('ui-resizable'),
          ...
          this.element[0].nodeName.match(/^(canvas|textarea|input|select|button|img)$/i) &&
            (this.element.wrap(
              w("<div class='ui-wrapper' style='overflow: hidden;'></div>").css({
          ...
          i.autoHide &&
            w(this.element)
              ...
              .on('mouseleave', function() {
                i.disabled ||
                  e.resizing ||
                  (e._addClass('ui-resizable-autohide'), e._handles.hide())
              }),
          this._mouseInit()
      },
      _destroy: function() {
      ...
      _setupHandles: function() {
        ...
        if (
          ((this.handles =
            n.handles ||
            (w('.ui-resizable-handle', this.element).length
              ? {
                  n: '.ui-resizable-n',
                  e: '.ui-resizable-e',
                  s: '.ui-resizable-s',
          ...
          for (
            ...
            (s = 'ui-resizable-' + (t = w.trim(e[i]))),
              (h = w('<div>')),
              this._addClass(h, 'ui-resizable-handle ' + s),
              h.css({ zIndex: n.zIndex }),
          ...
          for (i in ((t = t || this.element), this.handles))
            this.handles[i].constructor === String
              ...
              : (this.handles[i].jquery || this.handles[i].nodeType) &&
                ((this.handles[i] = w(this.handles[i])),
                this._on(this.handles[i], { mousedown: o._mouseDown })),
              this.elementIsWrapper &&
                this.originalElement[0].nodeName.match(/^(textarea|input|select|button)$/i) &&
                ((e = w(this.handles[i], this.element)),
                (h = /sw|ne|nw|se|n|s/.test(i) ? e.outerHeight() : e.outerWidth()),
                (s = [
                  'padding',
                  /ne|nw|n/.test(i)
                    ? 'Top'
      ...
      _mouseCapture: function(t) {
        ...
        for (i in this.handles)
          ((e = w(this.handles[i])[0]) !== t.target && !w.contains(e, t.target)) || (s = !0)
      ...
      _mouseStart: function(t) {
        ...
        return (
          ...
          h.containment &&
            ((i += w(h.containment).scrollLeft() || 0), (e += w(h.containment).scrollTop() || 0)),
          ...
          (this.aspectRatio =
            'number' == typeof h.aspectRatio
              ? h.aspectRatio
              : this.originalSize.width / this.originalSize.height || 1),
          (s = w('.ui-resizable-' + this.axis).css('cursor')),
          w('body').css('cursor', 'auto' === s ? this.axis + '-resize' : s),
      ...
      _mouseStop: function(t) {
        ...
        return (
          this._helper &&
            ...
            (o =
              parseFloat(r.element.css('left')) + (r.position.left - r.originalPosition.left) ||
              null),
            (a =
              parseFloat(r.element.css('top')) + (r.position.top - r.originalPosition.top) || null),
            l.animate || this.element.css(w.extend(n, { top: a, left: o })),
            r.helper.height(r.size.height),
            r.helper.width(r.size.width),
            this._helper && !l.animate && this._proportionallyResize()),
          w('body').css('cursor', 'auto'),
      ...
      _updateRatio: function(t) {
        ...
        return (
          ...
          'nw' === s &&
            ((t.top = i.top + (e.height - t.height)), (t.left = i.left + (e.width - t.width))),
          t
        )
      },
      ...
      _proportionallyResize: function() {
        if (this._proportionallyResizeElements.length)
          for (
            var t, i = 0, e = this.helper || this.element;
            i < this._proportionallyResizeElements.length;
            i++
          )
      ...
      _renderProxy: function() {
        ...
        ;(this.elementOffset = t.offset()),
          this._helper
            ? ((this.helper = this.helper || w("<div style='overflow:hidden;'></div>")),
      ...
      _change: {
        ...
        se: function(t, i, e) {
          return w.extend(
            ...
            this._change.e.apply(this, [t, i, e])
          )
        },
        sw: function(t, i, e) {
          return w.extend(
            this._change.s.apply(this, arguments),
            this._change.w.apply(this, [t, i, e])
          )
        },
        ne: function(t, i, e) {
          return w.extend(
      ...
      _propagate: function(t, i) {
        w.ui.plugin.call(this, t, [i, this.ui()]), 'resize' !== t && this._trigger(t, i, this.ui())
      },
      plugins: {},
      ui: function() {
        return {
    ...
    w.ui.plugin.add('resizable', 'animate', {
      stop: function(i) {
        var e = w(this).resizable('instance'),
          ...
          o = h ? 0 : e.sizeDiff.width,
          a = { width: e.size.width - o, height: e.size.height - n },
          l =
            parseFloat(e.element.css('left')) + (e.position.left - e.originalPosition.left) || null,
          r = parseFloat(e.element.css('top')) + (e.position.top - e.originalPosition.top) || null
        e.element.animate(w.extend(a, r && l ? { top: r, left: l } : {}), {
          ...
          step: function() {
            ...
            s && s.length && w(s[0]).css({ width: t.width, height: t.height }),
              e._updateCache(t),
    ...
    w.ui.plugin.add('resizable', 'containment', {
      start: function() {
        var e,
          ...
          n,
          o,
          a = w(this).resizable('instance'),
          l = a.options,
          r = a.element,
          p = l.containment,
          d = p instanceof w ? p.get(0) : /parent/.test(p) ? r.parent().get(0) : p
        d &&
          ((a.containerElement = w(d)),
          /document/.test(p) || p === document
            ...
            : ((e = w(d)),
              (s = []),
              w(['Top', 'Right', 'Left', 'Bottom']).each(function(t, i) {
                s[t] = a._num(e.css('padding' + i))
              }),
              (a.containerOffset = e.offset()),
              (a.containerPosition = e.position()),
              (a.containerSize = { height: e.innerHeight() - s[3], width: e.innerWidth() - s[1] }),
              (t = a.containerOffset),
              (i = a.containerSize.height),
              (h = a.containerSize.width),
              (n = a._hasScroll(d, 'left') ? d.scrollWidth : h),
              (o = a._hasScroll(d) ? d.scrollHeight : i),
              (a.parentData = { element: d, left: t.left, top: t.top, width: n, height: o })))
      },
      resize: function(t) {
        var i,
          e,
          s,
          h,
          n = w(this).resizable('instance'),
          o = n.options,
          a = n.containerOffset,
          l = n.position,
          r = n._aspectRatio || t.shiftKey,
          p = { top: 0, left: 0 },
          d = n.containerElement,
          g = !0
        d[0] !== document && /static/.test(d.css('position')) && (p = a),
          l.left < (n._helper ? a.left : 0) &&
            ((n.size.width =
              n.size.width + (n._helper ? n.position.left - a.left : n.position.left - p.left)),
            r && ((n.size.height = n.size.width / n.aspectRatio), (g = !1)),
            (n.position.left = o.helper ? a.left : 0)),
          l.top < (n._helper ? a.top : 0) &&
            ((n.size.height =
              n.size.height + (n._helper ? n.position.top - a.top : n.position.top)),
            r && ((n.size.width = n.size.height * n.aspectRatio), (g = !1)),
            (n.position.top = n._helper ? a.top : 0)),
          ...
          s && h
            ...
            : ((n.offset.left = n.element.offset().left), (n.offset.top = n.element.offset().top)),
          (i = Math.abs(
            n.sizeDiff.width + (n._helper ? n.offset.left - p.left : n.offset.left - a.left)
          )),
          (e = Math.abs(
            n.sizeDiff.height + (n._helper ? n.offset.top - p.top : n.offset.top - a.top)
          )),
          i + n.size.width >= n.parentData.width &&
            ((n.size.width = n.parentData.width - i),
            r && ((n.size.height = n.size.width / n.aspectRatio), (g = !1))),
          e + n.size.height >= n.parentData.height &&
            ((n.size.height = n.parentData.height - e),
            r && ((n.size.width = n.size.height * n.aspectRatio), (g = !1))),
          g ||
            ((n.position.left = n.prevPosition.left),
            (n.position.top = n.prevPosition.top),
            (n.size.width = n.prevSize.width),
            (n.size.height = n.prevSize.height))
      },
      stop: function() {
        ...
        t._helper &&
          ...
          w(this).css({ left: o.left - s.left - e.left, width: a, height: l }),
          t._helper &&
            !i.animate &&
    ...
    w.ui.plugin.add('resizable', 'alsoResize', {
      ...
      resize: function(t, e) {
        ...
        w(s.alsoResize).each(function() {
          var t = w(this),
            ...
            h = {},
            i = t.parents(e.originalElement[0]).length
              ? ['width', 'height']
              : ['width', 'height', 'top', 'left']
          w.each(i, function(t, i) {
            var e = (s[i] || 0) + (o[i] || 0)
            e && 0 <= e && (h[i] = e || null)
          }),
            t.css(h)
      ...
      stop: function() {
        w(this).removeData('ui-resizable-alsoresize')
      }
    }),
    ...
    w.ui.plugin.add('resizable', 'grid', {
      resize: function() {
        var t,
          ...
          d = Math.round((s.height - h.height) / r) * r,
          g = h.width + p,
          u = h.height + d,
          f = e.maxWidth && e.maxWidth < g,
          c = e.maxHeight && e.maxHeight < u,
        ...
        ;(e.grid = a),
          ...
          c && (u -= r),
          /^(se|s|e)$/.test(o)
            ? ((i.size.width = g), (i.size.height = u))
            : /^(ne)$/.test(o)
            ? ((i.size.width = g), (i.size.height = u), (i.position.top = n.top - d))
            : /^(sw)$/.test(o)
            ? ((i.size.width = g), (i.size.height = u), (i.position.left = n.left - p))
            : ((u - r <= 0 || g - l <= 0) && (t = i._getPaddingPlusBorderDimensions(this)),
              0 < u - r
                ? ((i.size.height = u), (i.position.top = n.top - d))
                : ((u = r - t.height),
                  (i.size.height = u),
                  (i.position.top = n.top + h.height - u)),
              0 < g - l
                ? ((i.size.width = g), (i.position.left = n.left - p))
                : ((g = l - t.width), (i.size.width = g), (i.position.left = n.left + h.width - g)))
      }
    }),
    w.ui.resizable
  )
