...
!(function(t) {
  ...
  return a.effects.define('clip', 'hide', function(t, e) {
    var i,
      o = {},
      n = a(this),
    ...
    ;(i = n.cssClip()),
      ...
      a.effects.createPlaceholder(n),
      'show' === t.mode && (n.cssClip(o.clip), (o.clip = i)),
      n.animate(o, { queue: !1, duration: t.duration, easing: t.easing, complete: e })
  })
})
