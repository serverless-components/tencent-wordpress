...
!(function(e) {
  'function' == typeof define && define.amd
    ? define(['jquery', './draggable', './mouse', './core'], e)
    : e(jQuery)
})(function(a) {
  a.widget('ui.droppable', {
    ...
    _setOption: function(e, t) {
      if ('accept' === e)
        this.accept = a.isFunction(t)
          ? t
          : function(e) {
              return e.is(t)
            }
      else if ('scope' === e) {
        var i = a.ui.ddmanager.droppables[this.options.scope]
        ...
        (this.element
          ...
          .each(function() {
            ...
            if (
              e.options.greedy &&
              !e.options.disabled &&
              e.options.scope === i.options.scope &&
              e.accept.call(e.element[0], i.currentItem || i.element) &&
              l(i, a.extend(e, { offset: e.element.offset() }), e.options.tolerance, t)
            )
              return !(s = !0)
          }),
        !s &&
  ...
  var l = (a.ui.intersect = function(e, t, i, s) {
    if (!t.offset) return !1
    var o = (e.positionAbs || e.position.absolute).left + e.margins.left,
      r = (e.positionAbs || e.position.absolute).top + e.margins.top,
      n = o + e.helperProportions.width,
      a = r + e.helperProportions.height,
      l = t.offset.left,
      p = t.offset.top,
      d = l + t.proportions().width,
      c = p + t.proportions().height
    switch (i) {
      case 'fit':
        return l <= o && n <= d && p <= r && a <= c
      case 'intersect':
        return (
          l < o + e.helperProportions.width / 2 &&
          n - e.helperProportions.width / 2 < d &&
          p < r + e.helperProportions.height / 2 &&
          a - e.helperProportions.height / 2 < c
        )
      case 'pointer':
        return h(s.pageY, p, t.proportions().height) && h(s.pageX, l, t.proportions().width)
      case 'touch':
        return (
          ((p <= r && r <= c) || (p <= a && a <= c) || (r < p && c < a)) &&
          ((l <= o && o <= d) || (l <= n && n <= d) || (o < l && d < n))
        )
      default:
        return !1
    }
  ...
  return (
    !(a.ui.ddmanager = {
      ...
      prepareOffsets: function(e, t) {
        var i,
          s,
          o = a.ui.ddmanager.droppables[e.options.scope] || [],
          r = t ? t.type : null,
          n = (e.currentItem || e.element).find(':data(ui-droppable)').addBack()
        e: for (i = 0; i < o.length; i++)
          if (
            !(
              o[i].options.disabled ||
              (e && !o[i].accept.call(o[i].element[0], e.currentItem || e.element))
            )
          ) {
            for (s = 0; s < n.length; s++)
              if (n[s] === o[i].element[0]) {
                o[i].proportions().height = 0
                continue e
              }
            ;(o[i].visible = 'none' !== o[i].element.css('display')),
              o[i].visible &&
                ('mousedown' === r && o[i]._activate.call(o[i], t),
          ...
          a.each((a.ui.ddmanager.droppables[e.options.scope] || []).slice(), function() {
            this.options &&
              ...
              !this.options.disabled &&
                ...
                ((this.isout = !0), (this.isover = !1), this._deactivate.call(this, t)))
          }),
          i
        )
      },
      ...
      drag: function(r, n) {
        r.options.refreshPositions && a.ui.ddmanager.prepareOffsets(r, n),
          a.each(a.ui.ddmanager.droppables[r.options.scope] || [], function() {
            if (!this.options.disabled && !this.greedyChild && this.visible) {
              var e,
                t,
                i,
                s = l(r, this, this.options.tolerance, n),
              ...
              o &&
                (this.options.greedy &&
                  ...
                  (i = this.element.parents(':data(ui-droppable)').filter(function() {
                    return a(this).droppable('instance').options.scope === t
                  })).length && ((e = a(i[0]).droppable('instance')).greedyChild = 'isover' === o)),
                e && 'isover' === o && ((e.isover = !1), (e.isout = !0), e._out.call(e, n)),
                (this[o] = !0),
                (this['isout' === o ? 'isover' : 'isout'] = !1),
                this['isover' === o ? '_over' : '_out'].call(this, n),
                e && 'isout' === o && ((e.isout = !1), (e.isover = !0), e._over.call(e, n)))
            }
          })
      },
