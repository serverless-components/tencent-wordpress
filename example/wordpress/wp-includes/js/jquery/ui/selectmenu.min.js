 ...
 */
!(function(e) {
  'function' == typeof define && define.amd ? define(['jquery', './menu', './core'], e) : e(jQuery)
})(function(u) {
  return u.widget('ui.selectmenu', [
    u.ui.formResetMixin,
    {
      version: '1.12.1',
      ...
      _drawMenu: function() {
        ...
        ;(this.menu = u('<ul>', {
          ...
          (this.menuWrap = u('<div>').append(this.menu)),
            ...
            .menu({
              ...
              focus: function(e, t) {
                ...
                null != n.focusIndex &&
                  ...
                  (n._trigger('focus', e, { item: i }), n.isOpen || n._select(i, e)),
      ...
      _position: function() {
        this.menuWrap.position(u.extend({ of: this.button }, this.options.position))
      },
      close: function(e) {
        this.isOpen &&
          ((this.isOpen = !1),
      ...
      _renderMenu: function(n, e) {
        ...
        u.each(e, function(e, t) {
          var i
          t.optgroup !== o &&
            ((i = u('<li>', { text: t.optgroup })),
            s._addClass(
              i,
              'ui-selectmenu-optgroup',
              'ui-menu-divider' +
                (t.element.parent('optgroup').prop('disabled') ? ' ui-state-disabled' : '')
            ),
            i.appendTo(n),
            (o = t.optgroup)),
      ...
      _renderItem: function(e, t) {
        var i = u('<li>'),
          n = u('<div>', { title: t.element.attr('title') })
        return (
          t.disabled && this._addClass(i, null, 'ui-state-disabled'),
        ...
        this.isOpen
          ...
          (n =
            'first' === e || 'last' === e
              ...
              : i[e + 'All'](s).eq(0)).length && this.menuInstance.focus(t, n)
      },
      ...
      _setSelection: function() {
        ...
        this.range &&
          (window.getSelection
            ? ((e = window.getSelection()).removeAllRanges(), e.addRange(this.range))
            : this.range.select(),
          this.button.focus())
      },
      _documentClick: {
        mousedown: function(e) {
          this.isOpen &&
            (u(e.target).closest('.ui-selectmenu-menu, #' + u.ui.escapeSelector(this.ids.button))
              .length ||
              this.close(e))
        }
      },
      _buttonEvents: {
        mousedown: function() {
          var e
          window.getSelection
            ? (e = window.getSelection()).rangeCount && (this.range = e.getRangeAt(0))
      ...
      _appendTo: function() {
        ...
        return (
          ((e = e && (e.jquery || e.nodeType ? u(e) : this.document.find(e).eq(0))) && e[0]) ||
      ...
      _resizeButton: function() {
        ...
        !1 !== e
          ? (null === e && ((e = this.element.show().outerWidth()), this.element.hide()),
