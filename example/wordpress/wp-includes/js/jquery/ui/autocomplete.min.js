  ...
  return (
    u.widget('ui.autocomplete', {
            ...
            mousedown: function(e) {
              e.preventDefault(),
                ...
                this._delay(function() {
                  delete this.cancelBlur,
                    this.element[0] !== u.ui.safeActiveElement(this.document[0]) &&
      ...
      _isEventTargetInWidget: function(e) {
        ...
        return e.target === this.element[0] || e.target === t || u.contains(t, e.target)
      },
        ...
        return e.length && e[0].label && e[0].value
          ...
          : u.map(e, function(e) {
              return 'string' == typeof e
                ? { label: e, value: e }
                : u.extend({}, e, { label: e.label || e.value, value: e.value || e.label })
            })
      },
      _suggest: function(e) {
        ...
        this._renderMenu(t, e),
          ...
          t.show(),
          this._resizeMenu(),
          t.position(u.extend({ of: this.element }, this.options.position)),
