  ...
  return (
    P.widget('ui.draggable', P.ui.mouse, {
      ...
      _mouseCapture: function(t) {
        var e = this.options
        return (
          !(this.helper || e.disabled || 0 < P(t.target).closest('.ui-resizable-handle').length) &&
      ...
      _mouseStop: function(t) {
        var e = this,
          s = !1
        return (
          P.ui.ddmanager && !this.options.dropBehaviour && (s = P.ui.ddmanager.drop(this, t)),
          this.dropped && ((s = this.dropped), (this.dropped = !1)),
          ('invalid' === this.options.revert && !s) ||
          ('valid' === this.options.revert && s) ||
          !0 === this.options.revert ||
          (P.isFunction(this.options.revert) && this.options.revert.call(this.element, s))
      ...
      _createHelper: function(t) {
        ...
        return (
          i.parents('body').length ||
            i.appendTo('parent' === e.appendTo ? this.element[0].parentNode : e.appendTo),
          s && i[0] === this.element[0] && this._setPositionRelative(),
          i[0] === this.element[0] ||
            ...
            ? 'window' !== i.containment
              ? 'document' !== i.containment
                ...
                : (this.containment = [
                    0,
                    0,
                    P(o).width() - this.helperProportions.width - this.margins.left,
                    (P(o).height() || o.body.parentNode.scrollHeight) -
                      this.helperProportions.height -
                      this.margins.top
                  ])
              : (this.containment = [
                  P(window).scrollLeft() - this.offset.relative.left - this.offset.parent.left,
                  P(window).scrollTop() - this.offset.relative.top - this.offset.parent.top,
                  P(window).scrollLeft() +
                    P(window).width() -
                    this.helperProportions.width -
                    this.margins.left,
                  P(window).scrollTop() +
                    (P(window).height() || o.body.parentNode.scrollHeight) -
                    this.helperProportions.height -
                    this.margins.top
                ])
      ...
      start: function(e, t, s) {
        ...
        ;(s.sortables = []),
          P(s.options.connectToSortable).each(function() {
            ...
            t &&
              !t.options.disabled &&
              (s.sortables.push(t), t.refreshPositions(), t._trigger('activate', e, i))
          })
      },
      stop: function(e, t, s) {
        var i = P.extend({}, t, { item: s.element })
        ...
        n !== r && 'HTML' !== n.tagName
          ...
          : ((i.axis && 'x' === i.axis) ||
              (t.pageY - P(r).scrollTop() < i.scrollSensitivity
                ...
                : P(window).height() - (t.pageY - P(r).scrollTop()) < i.scrollSensitivity &&
                  (o = P(r).scrollTop(P(r).scrollTop() + i.scrollSpeed))),
            (i.axis && 'y' === i.axis) ||
              (t.pageX - P(r).scrollLeft() < i.scrollSensitivity
                ? (o = P(r).scrollLeft(P(r).scrollLeft() - i.scrollSpeed))
                : P(window).width() - (t.pageX - P(r).scrollLeft()) < i.scrollSensitivity &&
                  (o = P(r).scrollLeft(P(r).scrollLeft() + i.scrollSpeed)))),
    ...
    P.ui.plugin.add('draggable', 'snap', {
      start: function(t, e, s) {
        var i = s.options
        ;(s.snapElements = []),
          P(i.snap.constructor !== String ? i.snap.items || ':data(ui-draggable)' : i.snap).each(
            function() {
              var t = P(this),
                e = t.offset()
              this !== s.element[0] &&
      ...
      drag: function(t, e, s) {
        ...
        for (c = s.snapElements.length - 1; 0 <= c; c--)
          (a = (l = s.snapElements[c].left - s.margins.left) + s.snapElements[c].width),
            (p = (h = s.snapElements[c].top - s.margins.top) + s.snapElements[c].height),
            m < l - g ||
            a + g < u ||
            _ < h - g ||
            p + g < v ||
            !P.contains(s.snapElements[c].item.ownerDocument, s.snapElements[c].item)
              ? (s.snapElements[c].snapping &&
                  s.options.snap.release &&
                  s.options.snap.release.call(
                    s.element,
                    t,
                    P.extend(s._uiHash(), { snapItem: s.snapElements[c].item })
                  ),
              ...
              : ('inner' !== d.snapMode &&
                  ...
                  r &&
                    (e.position.left = s._convertPositionTo('relative', { top: 0, left: a }).left)),
                (f = i || o || n || r),
                'outer' !== d.snapMode &&
                  ((i = Math.abs(h - v) <= g),
                  (o = Math.abs(p - _) <= g),
                  ...
                  n &&
                    (e.position.left = s._convertPositionTo('relative', { top: 0, left: l }).left),
                  r &&
                    (e.position.left = s._convertPositionTo('relative', {
                      top: 0,
    ...
    P.ui.plugin.add('draggable', 'stack', {
      start: function(t, e, s) {
        ...
        n.length &&
          ((i = parseInt(P(n[0]).css('zIndex'), 10) || 0),
          P(n).each(function(t) {
