...
!(function(e) {
  ...
  function n() {
    b.datepicker._isDisabledDatepicker(r.inline ? r.dpDiv.parent()[0] : r.input[0]) ||
      (b(this)
    ...
    b.extend(e.prototype, {
      ...
      _attachments: function(e, t) {
        ...
        t.append && t.append.remove(),
          r &&
            ((t.append = b("<span class='" + this._appendClass + "'>" + r + '</span>')),
            ...
            (t.trigger = b(
              this._get(t, 'buttonImageOnly')
                ...
                : b("<button type='button'></button>")
                    .addClass(this._triggerClass)
                    .html(s ? b('<img/>').attr({ src: s, alt: i, title: i }) : i)
            )),
            e[n ? 'before' : 'after'](t.trigger),
            t.trigger.on('click', function() {
              return (
                b.datepicker._datepickerShowing && b.datepicker._lastInput === e[0]
      ...
      _autoSize: function(e) {
        if (this._get(e, 'autoSize') && !e.inline) {
          ...
          n.match(/[DM]/) &&
            ...
            r.setDate(
              t(this._get(e, n.match(/DD/) ? 'dayNames' : 'dayNamesShort')) + 20 - r.getDay()
            )),
      ...
      _enableDatepicker: function(t) {
        ...
        i.hasClass(this.markerClassName) &&
          ('input' === (e = t.nodeName.toLowerCase())
            ...
            : ('div' !== e && 'span' !== e) ||
              ((a = i.children('.' + this._inlineClass))
                .children()
      ...
      _disableDatepicker: function(t) {
        ...
        i.hasClass(this.markerClassName) &&
          ('input' === (e = t.nodeName.toLowerCase())
            ...
            : ('div' !== e && 'span' !== e) ||
              ((a = i.children('.' + this._inlineClass)).children().addClass('ui-state-disabled'),
      ...
      _optionDatepicker: function(e, t, a) {
        ...
        ;(i = t || {}),
          ...
          d &&
            ...
            'disabled' in i &&
              (i.disabled ? this._disableDatepicker(e) : this._enableDatepicker(e)),
      ...
      _doKeyDown: function(e) {
        var t,
          a,
          i,
          s = b.datepicker._getInst(e.target),
          r = !0,
            ...
            case 13:
              return (
                (i = b(
                  ...
                  s.dpDiv
                ))[0] && b.datepicker._selectDay(e.target, s.selectedMonth, s.selectedYear, i[0]),
                (t = b.datepicker._get(s, 'onSelect'))
                  ? ((a = b.datepicker._formatDate(s)),
                    t.apply(s.input ? s.input[0] : null, [a, s]))
                  : b.datepicker._hideDatepicker(),
                !1
              )
            case 27:
      ...
      _doKeyPress: function(e) {
        ...
        if (b.datepicker._get(i, 'constrainInput'))
          return (
            (t = b.datepicker._possibleChars(b.datepicker._get(i, 'dateFormat'))),
      ...
      _showDatepicker: function(e) {
        ...
        'input' !== (e = e.target || e).nodeName.toLowerCase() && (e = b('input', e.parentNode)[0]),
          b.datepicker._isDisabledDatepicker(e) ||
            ...
            !1 !== (i = (a = b.datepicker._get(t, 'beforeShow')) ? a.apply(e, [e, t]) : {}) &&
              (h(t.settings, i),
              (t.lastVal = null),
              (b.datepicker._lastInput = e),
              b.datepicker._setDateFromField(t),
              ...
              (r = { left: b.datepicker._pos[0], top: b.datepicker._pos[1] }),
              ...
              t.inline ||
                ((n = b.datepicker._get(t, 'showAnim')),
                ...
                b.effects && b.effects.effect[n]
                  ? t.dpDiv.show(n, b.datepicker._get(t, 'showOptions'), d)
                  : t.dpDiv[n || 'show'](n ? d : null),
                b.datepicker._shouldFocusInput(t) && t.input.trigger('focus'),
                (b.datepicker._curInst = t))))
      },
      _updateDatepicker: function(e) {
        ...
        0 < s.length && n.apply(s.get(0)),
          ...
          e === b.datepicker._curInst &&
            b.datepicker._datepickerShowing &&
            b.datepicker._shouldFocusInput(e) &&
      ...
      _findPos: function(e) {
        for (
          var t, a = this._getInst(e), i = this._get(a, 'isRTL');
          e && ('hidden' === e.type || 1 !== e.nodeType || b.expr.filters.hidden(e));
      ...
      _hideDatepicker: function(e) {
        var t,
          ...
          r = this._curInst
        !r ||
          (e && r !== b.data(e, 'datepicker')) ||
          (this._datepickerShowing &&
            ((t = this._get(r, 'showAnim')),
            (a = this._get(r, 'duration')),
            (i = function() {
              b.datepicker._tidyDialog(r)
            }),
            b.effects && (b.effects.effect[t] || b.effects[t])
              ? r.dpDiv.hide(t, b.datepicker._get(r, 'showOptions'), a, i)
              : r.dpDiv['slideDown' === t ? 'slideUp' : 'fadeIn' === t ? 'fadeOut' : 'hide'](
                  t ? a : null,
                  i
                ),
            t || i(),
            ...
            (s = this._get(r, 'onClose')) &&
              s.apply(r.input ? r.input[0] : null, [r.input ? r.input.val() : '', r]),
      ...
      _checkExternalClick: function(e) {
        if (b.datepicker._curInst) {
          ...
          ;((t[0].id === b.datepicker._mainDivId ||
            0 !== t.parents('#' + b.datepicker._mainDivId).length ||
            t.hasClass(b.datepicker.markerClassName) ||
            t.closest('.' + b.datepicker._triggerClass).length ||
            !b.datepicker._datepickerShowing ||
            (b.datepicker._inDialog && b.blockUI)) &&
            (!t.hasClass(b.datepicker.markerClassName) || b.datepicker._curInst === a)) ||
            b.datepicker._hideDatepicker()
        }
      },
      _adjustDate: function(e, t, a) {
        ...
        this._isDisabledDatepicker(i[0]) ||
          (this._adjustInstDate(s, t + ('M' === a ? this._get(s, 'showCurrentAtPos') : 0), a),
      ...
      _selectDay: function(e, t, a, i) {
        ...
        b(i).hasClass(this._unselectableClass) ||
          ...
          (((s = this._getInst(r[0])).selectedDay = s.currentDay = b('a', i).html()),
      ...
      _selectDate: function(e, t) {
        ...
        ;(t = null != t ? t : this._formatDate(s)),
          ...
          (a = this._get(s, 'onSelect'))
            ? a.apply(s.input ? s.input[0] : null, [t, s])
      ...
      parseDate: function(a, r, e) {
        ...
        if (h < r.length && ((o = r.substr(h)), !/^\s+/.test(o)))
        ...
        if (
          (-1 === D
            ...
            : D < 100 &&
              (D +=
                new Date().getFullYear() - (new Date().getFullYear() % 100) + (D <= p ? 0 : -100)),
          -1 < v)
        )
          for (m = 1, y = v; ; ) {
        ...
        if (
          (l = this._daylightSavingAdjust(new Date(D, m - 1, y))).getFullYear() !== D ||
          l.getMonth() + 1 !== m ||
          l.getDate() !== y
        )
          throw 'Invalid date'
        ...
        var a,
          ...
          s =
            null == e || '' === e
              ...
              ? (function(e) {
                  try {
                    return b.datepicker.parseDate(
                      ...
                      e,
                      b.datepicker._getFormatConfig(d)
                    )
                  } catch (e) {}
                  for (
                    var t =
                        (e.toLowerCase().match(/^c/) ? b.datepicker._getDate(d) : null) ||
                        new Date(),
                      a = t.getFullYear(),
                      i = t.getMonth(),
                      s = t.getDate(),
              ...
              : new Date(e.getTime())
        return (
          (s = s && 'Invalid Date' === s.toString() ? t : s) &&
        ...
        if ((G < 0 && ((G += 12), ee--), $))
          for (
            t = this._daylightSavingAdjust(
              new Date($.getFullYear(), $.getMonth() - J[0] * J[1] + 1, $.getDate())
            ),
              t = Z && t < Z ? Z : t;
        ...
        for (
          e.drawMonth = G,
            ...
            a = B
              ? this.formatDate(
                  a,
                  this._daylightSavingAdjust(new Date(ee, G - q, 1)),
          ...
          for (b = '', this.maxRows = 4, w = 0; w < J[1]; w++) {
            if (
              ((C = this._daylightSavingAdjust(new Date(ee, G, e.selectedDay))),
              (I = ' ui-corner-all'),
              (x = ''),
              Q)
            ) {
            ...
            for (
              x +=
                ...
                this._generateMonthYearHeader(e, G, ee, Z, $, 0 < M || 0 < w, g, _) +
              ...
              Y +=
                "<th scope='col'" +
                (5 <= (v + l + 6) % 7 ? " class='ui-datepicker-week-end'" : '') +
                "><span title='" +
                u[(S = (v + l) % 7)] +
                "'>" +
                p[S] +
            ...
            for (
              x += Y + '</tr></thead><tbody>',
                F = this._getDaysInMonth(ee, G),
                ee === e.selectedYear &&
                  G === e.selectedMonth &&
                  (e.selectedDay = Math.min(e.selectedDay, F)),
                N = (this._getFirstDayOfMonth(ee, G) - l + 7) % 7,
                T = Math.ceil((N + F) / 7),
                A = Q && this.maxRows > T ? this.maxRows : T,
                this.maxRows = A,
                K = this._daylightSavingAdjust(new Date(ee, G, 1 - N)),
                j = 0;
              j < A;
              j++
            ) {
              for (
                ...
                (R = f ? f.apply(e.input ? e.input[0] : null, [K]) : [!0, '']),
                  ...
                  (O +=
                    "<td class='" +
                    (5 <= (v + l + 6) % 7 ? ' ui-datepicker-week-end' : '') +
                    (L ? ' ui-datepicker-other-month' : '') +
                    ((K.getTime() === C.getTime() && G === e.selectedMonth && e._keyEvent) ||
                    (m.getTime() === K.getTime() && m.getTime() === C.getTime())
                      ? ' ' + this._dayOverClass
                      : '') +
    ...
    (b.fn.datepicker = function(e) {
      ...
      return 'string' != typeof e || ('isDisabled' !== e && 'getDate' !== e && 'widget' !== e)
        ? 'option' === e && 2 === arguments.length && 'string' == typeof arguments[1]
          ...
          : this.each(function() {
              'string' == typeof e
                ? b.datepicker['_' + e + 'Datepicker'].apply(b.datepicker, [this].concat(t))
