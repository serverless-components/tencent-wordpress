...
!(function(t) {
  'function' == typeof define && define.amd
    ? define(['jquery', './button', './core'], t)
    : t(jQuery)
})(function(o) {
  function i(i) {
    return function() {
      var t = this.element.val()
      i.apply(this, arguments), this._refresh(), t !== this.element.val() && this._trigger('change')
    }
  }
  return (
    o.widget('ui.spinner', {
      ...
      _getCreateOptions: function() {
        var e = this._super(),
          s = this.element
        return (
          o.each(['min', 'max', 'step'], function(t, i) {
            var n = s.attr(i)
            null != n && n.length && (e[i] = n)
          }),
          e
        )
      },
      _events: {
        ...
        'mousedown .ui-spinner-button': function(t) {
          ...
          ;(i =
            ...
            !1 !== this._start(t) &&
              this._repeat(null, o(t.currentTarget).hasClass('ui-spinner-up') ? 1 : -1, t)
        },
        ...
        'mouseenter .ui-spinner-button': function(t) {
          if (o(t.currentTarget).hasClass('ui-state-active'))
            return (
              !1 !== this._start(t) &&
              void this._repeat(null, o(t.currentTarget).hasClass('ui-spinner-up') ? 1 : -1, t)
            )
        },
      ...
      _repeat: function(t, i, n) {
        ;(t = t || 500),
          ...
          this._spin(i * this.options.step, n)
      },
      _spin: function(t, i) {
        var n = this.value() || 0
        this.counter || (this.counter = 1),
          (n = this._adjustValue(n + t * this._increment(this.counter))),
          (this.spinning && !1 === this._trigger('spin', i, { value: n })) ||
      ...
      _adjustValue: function(t) {
        var i,
          ...
          e = this.options
        return (
          (n = t - (i = null !== e.min ? e.min : 0)),
          (t = i + (n = Math.round(n / e.step) * e.step)),
      ...
      _setOption: function(t, i) {
        ...
        ;('max' !== t && 'min' !== t && 'step' !== t) ||
          ('string' == typeof i && (i = this._parse(i))),
          'icons' === t &&
            ((e = this.buttons.first().find('.ui-icon')),
            this._removeClass(e, null, this.options.icons.up),
            this._addClass(e, null, i.up),
      ...
      _value: function(t, i) {
        ...
        '' !== t &&
          ...
          (i || (n = this._adjustValue(n)), (t = this._format(n))),
          this.element.val(t),
          this._refresh()
      },
      _destroy: function() {
    ...
    !1 !== o.uiBackCompat &&
      o.widget('ui.spinner', o.ui.spinner, {
        _enhance: function() {
          this.uiSpinner = this.element
            .attr('autocomplete', 'off')
