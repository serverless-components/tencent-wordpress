      ...
      return 'area' === l
        ? ((n = (i = t.parentNode).name),
          !(!t.href || !n || 'map' !== i.nodeName.toLowerCase()) &&
            0 < (o = x("img[usemap='#" + n + "']")).length &&
            o.is(':visible'))
        : (/^(input|select|textarea|button|object)$/.test(l)
            ? (s = !t.disabled) && (r = x(t).closest('fieldset')[0]) && (s = !r.disabled)
            : (s = ('a' === l && t.href) || e),
          s &&
            x(t).is(':visible') &&
            (function(t) {
      ...
      fit: {
        left: function(t, e) {
          var i,
            ...
            l = o - r,
            a = r + e.collisionWidth - s - o
          e.collisionWidth > s
            ? 0 < l && a <= 0
              ? ((i = t.left + l + e.collisionWidth - s - o), (t.left += l - i))
              : (t.left = 0 < a && l <= 0 ? o : a < l ? o + s - e.collisionWidth : o)
            : 0 < l
            ? (t.left += l)
            : 0 < a
            ? (t.left -= a)
            : (t.left = W(t.left - r, t.left))
        },
        top: function(t, e) {
          var i,
            n = e.within,
            ...
            l = o - r,
            a = r + e.collisionHeight - s - o
          e.collisionHeight > s
            ? 0 < l && a <= 0
              ? ((i = t.top + l + e.collisionHeight - s - o), (t.top += l - i))
              : (t.top = 0 < a && l <= 0 ? o : a < l ? o + s - e.collisionHeight : o)
            : 0 < l
            ? (t.top += l)
            : 0 < a
            ? (t.top -= a)
            : (t.top = W(t.top - r, t.top))
        }
      },
      flip: {
        left: function(t, e) {
          var i,
            ...
            h = a - l,
            c = a + e.collisionWidth - r - l,
            f = 'left' === e.my[0] ? -e.elemWidth : 'right' === e.my[0] ? e.elemWidth : 0,
            u = 'left' === e.at[0] ? e.targetWidth : 'right' === e.at[0] ? -e.targetWidth : 0,
            d = -2 * e.offset[0]
          h < 0
            ? ((i = t.left + f + u + d + e.collisionWidth - r - s) < 0 || i < C(h)) &&
              (t.left += f + u + d)
            : 0 < c &&
              (0 < (n = t.left - e.collisionPosition.marginLeft + f + u + d - l) || C(n) < c) &&
              (t.left += f + u + d)
        },
        top: function(t, e) {
          var i,
            ...
            h = a - l,
            c = a + e.collisionHeight - r - l,
            f = 'top' === e.my[1] ? -e.elemHeight : 'bottom' === e.my[1] ? e.elemHeight : 0,
            u = 'top' === e.at[1] ? e.targetHeight : 'bottom' === e.at[1] ? -e.targetHeight : 0,
            d = -2 * e.offset[1]
          h < 0
            ? ((n = t.top + f + u + d + e.collisionHeight - r - s) < 0 || n < C(h)) &&
              (t.top += f + u + d)
            : 0 < c &&
              (0 < (i = t.top - e.collisionPosition.marginTop + f + u + d - l) || C(i) < c) &&
              (t.top += f + u + d)
        }
      },
      flipfit: {
    ...
    (x.fn.scrollParent = function(t) {
      var e = this.css('position'),
        ...
        o = this.parents()
          ...
          .eq(0)
      return 'fixed' !== e && o.length ? o : x(this[0].ownerDocument || document)
    }),
    /*!
  ...
  ;(x.cleanData =
    ...
    (x.Widget.prototype = {
      ...
      _on: function(r, l, t) {
        var a,
          h = this
        'boolean' != typeof r && ((t = l), (l = r), (r = !1)),
          t
            ? ((l = a = x(l)), (this.bindings = this.bindings.add(l)))
            : ((t = l), (l = this.element), (a = this.widget())),
          x.each(t, function(t, e) {
            function i() {
              if (r || (!0 !== h.options.disabled && !x(this).hasClass('ui-state-disabled')))
                return ('string' == typeof e ? h[e] : e).apply(h, arguments)
            }
            'string' != typeof e && (i.guid = e.guid = e.guid || i.guid || x.guid++)
            var n = t.match(/^([\w:-]*)\s*(.*)$/),
              o = n[1] + h.eventNamespace,
              s = n[2]
            s ? a.on(o, s, i) : l.on(o, i)
          })
      },
      _off: function(t, e) {
    ...
    x.each({ show: 'fadeIn', hide: 'fadeOut' }, function(s, r) {
      x.Widget.prototype['_' + s] = function(e, t, i) {
        ...
        var o = t ? (!0 === t || 'number' == typeof t ? r : t.effect || r) : s
