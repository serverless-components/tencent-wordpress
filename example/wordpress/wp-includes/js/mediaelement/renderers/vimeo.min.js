        ...
        var T = {
            ...
            load: function(e) {
              'undefined' != typeof Vimeo
                ? T._createPlayer(e)
                : ((T.promise =
                    T.promise || mejs.Utils.loadScript('https://player.vimeo.com/api/player.js')),
          ...
          r = {
            ...
            create: function(f, e, t) {
              var v = [],
                ...
                w = null,
                n = ''
              ;(h.options = e), (h.id = f.id + '_' + e.prefix), (h.mediaElement = f)
              for (
                var N = function(e) {
              ...
              window['__ready__' + h.id] = function(e) {
                ...
                w.on('loaded', function() {
                  w.getDuration()
                    .then(function(e) {
                      if (0 < (b = e) && ((j = b * e), f.originalNode.autoplay)) {
                        U = y = !1
                ...
                for (
                  var d = 0,
                    p = (s = ['rendererready', 'loadedmetadata', 'loadeddata', 'canplay']).length;
                  d < p;
                  d++
                ) {
              ...
              var p = f.originalNode.height,
                ...
                V = []
              return (
                f.originalNode.autoplay && -1 === A.indexOf('autoplay') && V.push('autoplay=1'),
