        ...
        var VimeoApi = {
          ...
          load: function load(settings) {
            if (typeof Vimeo !== 'undefined') {
              ...
              VimeoApi.promise =
                VimeoApi.promise || mejs.Utils.loadScript('https://player.vimeo.com/api/player.js')
        ...
        var vimeoIframeRenderer = {
          ...
          create: function create(mediaElement, options, mediaFiles) {
            ...
            var height = mediaElement.originalNode.height,
              ...
              standardUrl =
                'https://player.vimeo.com/video/' + VimeoApi.getVimeoId(mediaFiles[0].src)

            var queryArgs = ~mediaFiles[0].src.indexOf('?')
              ? '?' + mediaFiles[0].src.slice(mediaFiles[0].src.indexOf('?') + 1)
              : ''
            var args = []
