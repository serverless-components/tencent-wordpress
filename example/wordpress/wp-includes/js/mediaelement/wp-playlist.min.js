!(function(r, e, i) {
  ...
  var t = i.View.extend({
    initialize: function(t) {
      ;(this.index = 0),
        (this.settings = {}),
        (this.data = t.metadata || r.parseJSON(this.$('script.wp-playlist-script').html())),
        ...
        e.bindAll(this, 'bindPlayer', 'bindResetPlayer', 'setPlayer', 'ended', 'clickTrack'),
        e.isUndefined(window._wpmejsSettings) || (this.settings = e.clone(_wpmejsSettings)),
    ...
    setPlayer: function(t) {
      this.player &&
        (this.player.pause(), this.player.remove(), (this.playerNode = this.$(this.data.type))),
        t &&
          (this.playerNode.attr('src', this.current.get('src')),
    ...
    renderCurrent: function() {
      ...
      'video' === this.data.type
        ? (this.data.images &&
            ...
            -1 === this.current.get('image').src.indexOf('wp-includes/images/media/video.png') &&
    ...
    loadCurrent: function() {
      ...
      this.mejs && this.mejs.pause(),
        t !== e
          ? this.setPlayer(!0)
          : (this.playerNode.attr('src', this.current.get('src')), this.playCurrentSrc())
    },
    setCurrent: function() {
  ...
  ;(window.wp.playlist = { initialize: s }), r(document).ready(s), (window.WPPlaylistView = t)
})(jQuery, _, Backbone)
