      ...
      function(i, r, e) {
        ;(function(e) {
          ...
          'undefined' != typeof document
            ? (t = document)
            : (t = n['__GLOBAL_DOCUMENT_CACHE@4']) || (t = n['__GLOBAL_DOCUMENT_CACHE@4'] = o),
            (r.exports = t)
        }.call(
          this,
        ...
        var d = {
          ...
          language: function() {
            ...
            if (null != t && t.length) {
              ...
              ;(d.lang = t[0]),
                void 0 === d[t[0]]
                  ? ((t[1] = null !== t[1] && void 0 !== t[1] && 'object' === a(t[1]) ? t[1] : {}),
            ...
            if ('string' == typeof e && e.length) {
              ...
              return (
                void 0 !== d[i] &&
                  ...
                  null !== t &&
                    'number' == typeof t &&
                    ((o = d[i]['mejs.plural-form']), (n = r.apply(null, [n, t, o])))),
                !n &&
                  d.en &&
                  ((n = d.en[e]),
                  null !== t &&
                    'number' == typeof t &&
                    ((o = d.en['mejs.plural-form']), (n = r.apply(null, [n, t, o])))),
                (n = n || e),
              ...
              if (n.isVideo) {
                ...
                if (
                  ...
                  t.addEventListener('click', function() {
                    ;(m.HAS_TRUE_NATIVE_FULLSCREEN && m.IS_FULLSCREEN) || n.isFullScreen
                      ? n.exitFullScreen()
                      : n.enterFullScreen()
                  }),
                  (n.fullscreenBtn = t),
                  ...
                  (o.exitFullscreenCallback = function(e) {
                    ...
                    o.options.enableKeyboard &&
                      27 === t &&
                      ((m.HAS_TRUE_NATIVE_FULLSCREEN && m.IS_FULLSCREEN) || o.isFullScreen) &&
                      n.exitFullScreen()
                  }),
            ...
            detectFullscreenMode: function() {
              ...
              return (
                m.HAS_TRUE_NATIVE_FULLSCREEN && e
                  ...
                  : m.HAS_TRUE_NATIVE_FULLSCREEN && !e
                  ? (t = 'plugin-native')
                  : this.usePluginFullScreen && m.SUPPORT_POINTER_EVENTS && (t = 'plugin-click'),
            ...
            enterFullScreen: function() {
              ...
              if (o.isVideo)
                if (
                  ...
                  o.media.originalNode.canPlayType((0, g.getTypeFromFile)(o.media.getSrc()))
                )
                  ...
                  if (
                    ...
                    for (
                      var n = o.getElement(o.container).querySelectorAll('embed, object, video'),
                        i = n.length,
                        r = 0;
                      r < i;
                      r++
                  ...
                  o.fullscreenBtn &&
                    ((0, v.removeClass)(o.fullscreenBtn, o.options.classPrefix + 'fullscreen'),
                    (0, v.addClass)(o.fullscreenBtn, o.options.classPrefix + 'unfullscreen')),
                    o.setControlsSize(),
                    (o.isFullScreen = !0)
                  var d = Math.min(screen.width / o.width, screen.height / o.height),
                    u = o
                      .getElement(o.container)
                      .querySelector('.' + o.options.classPrefix + 'captions-text')
                  u &&
              ...
              if (e.isVideo) {
                if (
                  ...
                  if (
                    ...
                    for (
                      var n = e.getElement(e.container).querySelectorAll('embed, object, video'),
                        o = n.length,
                        i = 0;
                      i < o;
                      i++
                ...
                e.fullscreenBtn &&
                  ((0, v.removeClass)(e.fullscreenBtn, e.options.classPrefix + 'unfullscreen'),
                  (0, v.addClass)(e.fullscreenBtn, e.options.classPrefix + 'fullscreen')),
                  e.setControlsSize(),
                  (e.isFullScreen = !1)
                var l = e
          ...
          Object.assign(i.default.prototype, {
            buildprogress: function(h, s, e, d) {
              ...
              ;(o.className = g.options.classPrefix + 'time-rail'),
                ...
                g.options.keyActions.push(
                  {
                    ...
                    action: function(e) {
                      if (!isNaN(e.duration) && 0 < e.duration) {
                        ...
                        var t = e
                          .getElement(e.container)
                          .querySelector('.' + g.options.classPrefix + 'time-total')
                        t && t.focus()
                        var n = Math.max(
                          e.currentTime - e.options.defaultSeekBackwardInterval(e),
                          0
                        )
                        e.paused || e.pause(),
                          setTimeout(function() {
                  ...
                  },
                  {
                    ...
                    action: function(e) {
                      if (!isNaN(e.duration) && 0 < e.duration) {
                        ...
                        t && t.focus()
                        var n = Math.min(
                          e.currentTime + e.options.defaultSeekForwardInterval(e),
                          e.duration
                        )
                        e.paused || e.pause(),
                          setTimeout(function() {
                ...
                (g.rail = s.querySelector('.' + g.options.classPrefix + 'time-rail')),
                (g.total = s.querySelector('.' + g.options.classPrefix + 'time-total')),
                (g.loaded = s.querySelector('.' + g.options.classPrefix + 'time-loaded')),
                (g.current = s.querySelector('.' + g.options.classPrefix + 'time-current')),
                (g.handle = s.querySelector('.' + g.options.classPrefix + 'time-handle')),
                (g.timefloat = s.querySelector('.' + g.options.classPrefix + 'time-float')),
                (g.timefloatcurrent = s.querySelector(
                  '.' + g.options.classPrefix + 'time-float-current'
                )),
                (g.slider = s.querySelector('.' + g.options.classPrefix + 'time-slider')),
                (g.hovered = s.querySelector('.' + g.options.classPrefix + 'time-hovered')),
                (g.buffer = s.querySelector('.' + g.options.classPrefix + 'time-buffering')),
                (g.newTime = 0),
                  ...
                  if (
                    ...
                    if (
                      ...
                      v &&
                        ...
                        g.newTime.toFixed(4) !== g.getCurrentTime().toFixed(4) &&
                        (g.setCurrentRailHandle(g.newTime), g.updateCurrent(g.newTime)),
                      !y.IS_IOS && !y.IS_ANDROID)
                    ) {
                      if (
                        (l < 0 && (l = 0),
                        g.options.useSmoothHover && null !== r && void 0 !== window[r])
                      ) {
                      ...
                      if (g.timefloat) {
                        ...
                        ;(s =
                          d - p.left < g.timefloat.offsetWidth
                            ? f
                            : d - p.left >= g.getElement(g.container).offsetWidth - f
                            ? g.total.offsetWidth - f
                            : l),
                          (0, b.hasClass)(
                            g.getElement(g.container),
                            g.options.classPrefix + 'long-video'
                          ) && (s += parseFloat(m.marginLeft) / 2 + g.timefloat.offsetWidth / 2),
                          (g.timefloat.style.left = s + 'px'),
                          (g.timefloatcurrent.innerHTML = (0, E.secondsToTimeCode)(
                            g.newTime,
                    ...
                    y.IS_IOS ||
                      ...
                      !g.timefloat ||
                      ((s =
                        g.timefloat.offsetWidth + o >= g.getElement(g.container).offsetWidth
                  ...
                  if (
                    ...
                    var t = e.which || e.keyCode || 0,
                      ...
                      a = g
                        ...
                        .querySelector('.' + g.options.classPrefix + 'volume-slider')
                    if (38 === t || 40 === t) {
                      a && (a.style.display = 'block'),
                        g.isVideo && (g.showControls(), g.startControlsTimer())
                      var s = 38 === t ? Math.min(g.volume + 0.1, 1) : Math.max(g.volume - 0.1, 0),
                        l = s <= 0
              ...
              for (var a = 0, l = r.length; a < l; a++)
                g.slider.addEventListener(
                  ...
                  function(e) {
                    if (
                      ((g.forcedHandlePause = !1),
                      g.getDuration() !== 1 / 0 && (1 === e.which || 0 === e.which))
                    ) {
                      g.paused || (g.pause(), (g.forcedHandlePause = !0)), (v = !0), i(e)
                      for (var t = ['mouseup', 'touchend'], n = 0, o = t.length; n < o; n++)
                        g.getElement(g.container).addEventListener(t[n], function(e) {
                          var t = e.target
                          ;(t === g.slider ||
                            t.closest('.' + g.options.classPrefix + 'time-slider')) &&
                            i(e)
                        })
              ...
              g.slider.addEventListener('mouseenter', function(e) {
                e.target === g.slider &&
                  g.getDuration() !== 1 / 0 &&
                  (g.getElement(g.container).addEventListener('mousemove', function(e) {
                    var t = e.target
                    ;(t === g.slider || t.closest('.' + g.options.classPrefix + 'time-slider')) &&
                      i(e)
                  }),
                  !g.timefloat || y.IS_IOS || y.IS_ANDROID || (g.timefloat.style.display = 'block'),
                  g.hovered &&
                    !y.IS_IOS &&
                    !y.IS_ANDROID &&
                ...
                (g.broadcastCallback = function(e) {
                  var t,
                    ...
                    o,
                    i,
                    r = s.querySelector('.' + g.options.classPrefix + 'broadcast')
                    ...
                    r && ((g.slider.style.display = ''), r.remove()),
                      ...
                      d.paused
                        ? (g.slider.setAttribute('aria-label', n),
                          ...
                          g.slider.setAttribute('aria-valuemax', isNaN(i) ? 0 : i),
                ...
                g.getElement(g.container).addEventListener('controlsresize', function(e) {
                  g.getDuration() !== 1 / 0 &&
                    (h.setProgressRail(e), g.forcedHandlePause || h.setCurrentRail(e))
                })
            },
            ...
            buildduration: function(e, t, n, o) {
              ...
              if (t.lastChild.querySelector('.' + i.options.classPrefix + 'currenttime'))
                ...
                t.querySelector('.' + i.options.classPrefix + 'currenttime') &&
                  (0, l.addClass)(
                    t.querySelector('.' + i.options.classPrefix + 'currenttime').parentNode,
                    i.options.classPrefix + 'currenttime-container'
                  )
                var r = a.default.createElement('div')
                ;(r.className =
                  i.options.classPrefix + 'time ' + i.options.classPrefix + 'duration-container'),
                  (r.innerHTML =
                    '<span class="' +
                    i.options.classPrefix +
                    'duration">' +
            ...
            updateCurrent: function() {
              ...
              5 < n.length
                ...
                e
                  ...
                  (e
                    .getElement(e.controls)
                    .querySelector('.' + e.options.classPrefix + 'currenttime').innerText = n)
            },
            updateDuration: function() {
              ...
              5 < n.length
                ...
                e.getElement(e.controls).querySelector('.' + e.options.classPrefix + 'duration') &&
                  ...
                  (e
                    .getElement(e.controls)
                    .querySelector('.' + e.options.classPrefix + 'duration').innerHTML = n)
            }
          })
      },
        ...
        Object.assign(o.config, {
          ...
          Object.assign(i.default.prototype, {
            ...
            buildtracks: function(o, e, t, n) {
              if (
                (this.findTracks(), o.tracks.length || (o.trackFiles && 0 !== !o.trackFiles.length))
              ) {
                var i = this,
                ...
                i.cleartracks(o),
                  ...
                  (o.captions.className =
                    i.options.classPrefix + 'captions-layer ' + i.options.classPrefix + 'layer'),
                  ...
                  (o.captionsButton.className =
                    i.options.classPrefix + 'button ' + i.options.classPrefix + 'captions-button'),
                  ...
                  (o.chaptersButton.className =
                    i.options.classPrefix + 'button ' + i.options.classPrefix + 'chapters-button'),
                ...
                for (var u = 0, c = 0; c < l; c++) {
                  ...
                  o.tracks[c].src.trim() &&
                    ('subtitles' === f || 'captions' === f
                      ? u++
                      : 'chapters' !== f ||
                        e.querySelector('.' + i.options.classPrefix + 'chapter-selector') ||
                ...
                for (var p = 0; p < l; p++) {
                  ...
                  !o.tracks[p].src.trim() ||
                    ...
                    o.addTrackButton(o.tracks[p].trackId, o.tracks[p].srclang, o.tracks[p].label)
                }
                o.loadNextTrack()
                ...
                if (i.options.toggleCaptionsButtonWhenOnlyOne && 1 === u)
                  ...
                  for (
                    var g = o.captionsButton.querySelectorAll(
                      ...
                      y = o.captionsButton.querySelectorAll('input[type=radio]'),
                      E = 0,
                      b = h.length;
                    E < b;
                    E++
                ...
                for (var k = 0, _ = h.length; k < _; k++)
                  o.chaptersButton.addEventListener(h[k], function() {
                    this.querySelector('.' + i.options.classPrefix + 'chapters-selector-list')
                      .children.length &&
                      (0, I.removeClass)(
                        this.querySelector('.' + i.options.classPrefix + 'chapters-selector'),
                ...
                o.chaptersButton.addEventListener('keydown', function(e) {
                  ...
                  o.options.alwaysShowControls
                    ? (0, I.addClass)(
                        o
                          .getElement(o.container)
                          .querySelector('.' + i.options.classPrefix + 'captions-position'),
            ...
            setTrack: function(e, t) {
              ...
              for (var l = 0, d = i.length; l < d; l++)
                (0, I.removeClass)(i[l], n.options.classPrefix + 'captions-selected')
              r.checked = !0
              for (
                ...
                (0, I.addClass)(u[c], n.options.classPrefix + 'captions-selected')
              if ('none' === e)
                (n.selectedTrack = null),
                  (0, I.removeClass)(n.captionsButton, n.options.classPrefix + 'captions-enabled')
              else
                for (var p = 0, m = n.tracks.length; p < m; p++) {
                  var h = n.tracks[p]
                  if (h.trackId === e) {
                    null === n.selectedTrack &&
                      (0, I.addClass)(n.captionsButton, n.options.classPrefix + 'captions-enabled'),
                      (n.selectedTrack = h),
                      ...
                      (e.captionsText.innerHTML = (function(e) {
                        ...
                        for (var i = t.getElementsByTagName('*'), r = 0, a = i.length; r < a; r++)
                          for (
                            ...
                            l[d].name.startsWith('on') || l[d].value.startsWith('javascript')
                              ? i[r].remove()
                              : 'style' === l[d].name && i[r].removeAttribute(l[d].name)
                        return t.innerHTML
                      })(o)),
              ...
              if (t) {
                ...
                for (var n = 0; n < t; n++)
                  r.chaptersButton.querySelector('ul').innerHTML +=
                    ...
                    '</label></li>'
                for (
                  var o = r.chaptersButton.querySelectorAll('input[type="radio"]'),
                  ...
                  (o[a].disabled = !1),
                    ...
                    o[a].addEventListener('click', function(e) {
                      ...
                      ;(this.checked = !0),
                        ...
                        (0, I.addClass)(n, r.options.classPrefix + 'chapters-selected'),
                        (0, I.removeClass)(
            ...
            dfxp: {
              parse: function(e) {
                ...
                for (var d = 0, u = n.length; d < u; d++) {
                  ...
                  if (
                    (n.eq(d).attr('begin') &&
                      (f.start = (0, m.convertSMPTEtoSeconds)(n.eq(d).attr('begin'))),
                    !f.start &&
                      n.eq(d - 1).attr('end') &&
                      (f.start = (0, m.convertSMPTEtoSeconds)(n.eq(d - 1).attr('end'))),
                    n.eq(d).attr('end') &&
                      (f.stop = (0, m.convertSMPTEtoSeconds)(n.eq(d).attr('end'))),
                    !f.stop &&
                      n.eq(d + 1).attr('begin') &&
                      (f.stop = (0, m.convertSMPTEtoSeconds)(n.eq(d + 1).attr('begin'))),
                    r)
                  )
              ...
              if ((!P.IS_ANDROID && !P.IS_IOS) || !this.options.hideVolumeOnTouchDevices) {
                ...
                if (
                  ...
                  a.options.keyActions.push(
                    {
                      ...
                      action: function(e) {
                        var t = e
                          .getElement(e.container)
                          .querySelector('.' + a.options.classPrefix + 'volume-slider')
                  ...
                  ;(u.className = a.options.classPrefix + 'horizontal-volume-slider'),
                    ...
                    u.setAttribute('aria-label', w.default.t('mejs.volume-slider')),
                ...
                var c = !1,
                  ...
                  h =
                    'vertical' === s
                      ? a
                          .getElement(a.container)
                          .querySelector('.' + a.options.classPrefix + 'volume-total')
                      : a
                          .getElement(a.container)
                  ...
                  v =
                    'vertical' === s
                      ? a
                          .getElement(a.container)
                          .querySelector('.' + a.options.classPrefix + 'volume-current')
                      : a
                          .getElement(a.container)
                  ...
                  g =
                    'vertical' === s
                      ? a
                          .getElement(a.container)
                          .querySelector('.' + a.options.classPrefix + 'volume-handle')
                      : a
                          .getElement(a.container)
                    ...
                    if (null !== e && !isNaN(e) && void 0 !== e) {
                      ...
                      'vertical' === s
                        ? ((v.style.bottom = 0),
                          (v.style.height = o),
                          (g.style.bottom = o),
                          (g.style.marginBottom = -parseFloat(i.height) / 2 + 'px'))
                        : ((v.style.left = 0),
                          (v.style.width = o),
                          (g.style.left = o),
                          (g.style.marginLeft = -parseFloat(i.width) / 2 + 'px'))
                    }
                  },
                  E = function(e) {
                    var t = (0, C.offset)(h),
                ...
                e.getElement(e.container).addEventListener('keydown', function(e) {
                  ...
                  d.addEventListener('focusout', function(e) {
                    ;(e.relatedTarget &&
                      (!e.relatedTarget ||
                        e.relatedTarget.matches('.' + a.options.classPrefix + 'volume-slider'))) ||
                      'vertical' !== s ||
                      (m.style.display = 'none')
                  }),
          ...
          function r(e, t) {
            ...
            if (((n.node = n.media = o), n.node)) {
              ...
              return (
                ...
                (0, c.calculateTimeFormat)(0, n.options, n.options.framesPerSecond || 25),
          ...
          return (
            o(r, [
              ...
              },
              {
                ...
                value: function() {
                  ...
                  if (
                    ...
                    (!n.isVideo &&
                      (n.isVideo ||
                        (!n.options.features.length && !n.options.useDefaultControls))) ||
                    ...
                    if (
                      ...
                      n.getElement(n.container).addEventListener('focus', function(e) {
                        if (!n.controlsAreVisible && !n.hasFocus && n.controlsEnabled) {
                          n.showControls(!0)
                          var t = (0, m.isNodeAfter)(e.relatedTarget, n.getElement(n.container))
                            ? '.' +
                              n.options.classPrefix +
                              'controls .' +
                              n.options.classPrefix +
                      ...
                      n.options.features.length ||
                        n.options.useDefaultControls ||
                        ((n.getElement(n.container).style.background = 'transparent'),
                        (n
                          .getElement(n.container)
                          .querySelector('.' + n.options.classPrefix + 'controls').style.display =
                          'none')),
                      n.isVideo &&
                      ...
                      ;(r.className = n.options.classPrefix + 'fill-container'),
                        n
                          .getElement(n.container)
                          .parentNode.insertBefore(r, n.getElement(n.container)),
                        r.appendChild(n.getElement(n.container))
                    }
                    w.IS_ANDROID &&
                      P.addClass(n.getElement(n.container), n.options.classPrefix + 'android'),
                      w.IS_IOS &&
                        P.addClass(n.getElement(n.container), n.options.classPrefix + 'ios'),
                      w.IS_IPAD &&
                        P.addClass(n.getElement(n.container), n.options.classPrefix + 'ipad'),
                      w.IS_IPHONE &&
                        P.addClass(n.getElement(n.container), n.options.classPrefix + 'iphone'),
                      P.addClass(
                        n.getElement(n.container),
                        n.isVideo
                      ...
                      ((n.media.player = n).controls = n
                        .getElement(n.container)
                        .querySelector('.' + n.options.classPrefix + 'controls')),
                      (n.layers = n
                        .getElement(n.container)
                    ...
                    -1 < n.options[a + 'Width'].toString().indexOf('%')
                      ...
                      (n.initialAspectRatio =
                        n.height >= n.width ? n.width / n.height : n.height / n.width),
                  ...
                  if (((e = void 0 === e || e), !i.controlsAreVisible && i.isVideo)) {
                    if (e)
                      !(function() {
                        ...
                        for (
                          var n = i
                              ...
                              .querySelectorAll('.' + i.options.classPrefix + 'control'),
                            e = function(e, t) {
                      ...
                      for (
                        ...
                        P.removeClass(t[n], i.options.classPrefix + 'offscreen'),
                          (t[n].style.display = '')
                  ...
                  if (
                    ...
                    !0 === t ||
                      !(
                        ...
                        (i.paused &&
                          4 === i.readyState &&
                          ((!i.options.hideVideoControlsOnLoad && i.currentTime <= 0) ||
                            (!i.options.hideVideoControlsOnPause && 0 < i.currentTime))) ||
                    ...
                    if (e)
                      !(function() {
                        P.fadeOut(i.getElement(i.controls), 200, function() {
                          P.addClass(i.getElement(i.controls), i.options.classPrefix + 'offscreen'),
                            (i.getElement(i.controls).style.display = '')
                          ...
                          var n = i
                            ...
                            e = function(e, t) {
                              P.fadeOut(n[e], 200, function() {
                                P.addClass(n[e], i.options.classPrefix + 'offscreen'),
                                  (n[e].style.display = '')
                              })
                            },
                            t = 0,
                  ...
                  e.proxy && e.proxy.pause(),
                    ...
                    e.media.addEventListener('loadedmetadata', function() {
                      0 < e.getCurrentTime() &&
                        ...
                        (e.setCurrentTime(e.currentMediaTime), w.IS_IOS || w.IS_ANDROID || e.play())
                    })
                }
              },
              {
                ...
                value: function(e, t) {
                  ...
                  if (
                    ...
                    n.getElement(n.container) &&
                      n
                        .getElement(n.container)
                        .querySelector('.' + n.options.classPrefix + 'overlay-play') &&
                      (n
                        .getElement(n.container)
                    ...
                    if (
                      ...
                      n.getElement(n.container).dispatchEvent(s),
                        ...
                        n.isVideo &&
                          ...
                          (!w.IS_ANDROID && !w.IS_IOS) || n.options.alwaysShowControls
                          ...
                          for (var e in ((n.hasFocus = !0), f.default.players))
                            if (f.default.players.hasOwnProperty(e)) {
                              ...
                              t.id === n.id ||
                                ...
                                t.paused ||
                                t.ended ||
                                !0 === t.options.ignorePauseOtherPlayersOption ||
                      ...
                      n.media.addEventListener('timeupdate', function() {
                        isNaN(n.getDuration()) ||
                          l === n.getDuration() ||
                          ((l = n.getDuration()),
                          (0, c.calculateTimeFormat)(l, n.options, n.options.framesPerSecond || 25),
                          n.updateDuration && n.updateDuration(),
                          n.updateCurrent && n.updateCurrent(),
                          n.setControlsSize())
                      }),
                        ...
                        (n.globalResizeCallback = function() {
                          n.isFullScreen ||
                            (w.HAS_TRUE_NATIVE_FULLSCREEN && x.default.webkitIsFullScreen) ||
                            n.setPlayerSize(n.width, n.height),
                            n.setControlsSize()
                        }),
              ...
              },
              {
                ...
                value: function(e, t, n) {
                  var o = this,
                    i = o
                      .getElement(o.layers)
                      .querySelector('.' + o.options.classPrefix + 'overlay-play')
                  ...
                  a &&
                    o
                      .getElement(o.layers)
                      .querySelector('.' + o.options.classPrefix + 'overlay-error') &&
                    ((r.innerHTML = a),
                    (o
                      .getElement(o.layers)
                      .querySelector('.' + o.options.classPrefix + 'overlay-error').innerHTML =
                      '' + s + r.outerHTML),
                    (o
                      .getElement(o.layers)
                      .querySelector(
              ...
              },
              {
                ...
                value: function(e, t) {
                  var n = this
                  ;(e = (0, m.isString)(e) && -1 < e.indexOf('%') ? e : parseFloat(e) + 'px'),
                    (t = (0, m.isString)(t) && -1 < t.indexOf('%') ? t : parseFloat(t) + 'px'),
                ...
                value: function() {
                  ...
                  if (P.visible(t.getElement(t.container)))
                    if (t.rail && P.visible(t.rail)) {
                      ...
                      for (
                        var u = t.getElement(t.controls).children, c = 0, f = 0, p = u.length;
                        f < p;
                        f++
                      )
                        c += u[f].offsetWidth
                    ...
                    ;(e.id = t.media.id + '-iframe-overlay'),
                      ...
                      e.addEventListener('click', function(e) {
                        t.options.clickToPlayPause &&
                          (t.paused ? t.play() : t.pause(), e.preventDefault(), e.stopPropagation())
                      }),
              ...
              },
              {
                ...
                value: function(e, t, n, o) {
                  ...
                  ;(r.className =
                    i.options.classPrefix + 'poster ' + i.options.classPrefix + 'layer'),
                    n.appendChild(r)
              ...
              },
              {
                ...
                value: function(t, e, n, o) {
                  if (t.isVideo) {
                    ...
                    ;(r.style.display = 'none'),
                      (r.className =
                        i.options.classPrefix + 'overlay ' + i.options.classPrefix + 'layer'),
                      (r.innerHTML =
                        '<div class="' +
                        i.options.classPrefix +
                      ...
                      (a.className =
                        i.options.classPrefix + 'overlay ' + i.options.classPrefix + 'layer'),
                      (a.innerHTML =
                        '<div class="' + i.options.classPrefix + 'overlay-error"></div>'),
                      n.appendChild(a),
                      (s.className =
                        i.options.classPrefix +
                        'overlay ' +
                    ...
                    o.addEventListener('play', function() {
                      ...
                      o.addEventListener('seeked', function() {
                        ;(s.style.display = i.paused && !w.IS_STOCK_ANDROID ? '' : 'none'),
                          (r.style.display = 'none'),
                          (l = !1)
                      }),
                      o.addEventListener('pause', function() {
                ...
                value: function() {
                  ...
                  l.isDynamic
                    ? l
                        ...
                        .parentNode.insertBefore(l.node, l.getElement(l.container))
                    : (function() {
                        ...
                        var e = l
                          .getElement(l.container)
                          .querySelector('.' + l.options.classPrefix + 'poster>img')
                        ...
                        d && -1 < d.indexOf('iframe')) &&
                          x.default.getElementById(l.media.id + '-iframe-overlay').remove()
                        var i = l.node.cloneNode()
                        if (
                          ((i.style.display = ''),
                          l
                            .getElement(l.container)
                            .parentNode.insertBefore(i, l.getElement(l.container)),
                          l.node.remove(),
                          l.mediaFiles)
                        )
              ...
              return (
                'undefined' != typeof dashjs
                  ...
                  : ((e.options.path =
                    ...
                    (T.promise = T.promise || (0, r.loadScript)(e.options.path)),
                  ...
                  for (var t, n = dashjs.MediaPlayer.events, o = 0, i = f.length; o < i; o++)
                    'loadedmetadata' === (t = f[o]) &&
                      ...
                      'object' !== b(l.dash.drm) ||
                        ...
                        (0, P.isString)(l.dash.robustnessLevel) &&
                          l.dash.robustnessLevel &&
                          u.getProtectionController().setRobustnessLevel(l.dash.robustnessLevel)),
        ...
        var i = {
          create: function(e, t, n) {
            ...
            ;(C.default['__ready__' + r.id] = function() {
              ...
              -1 === ['always', 'sameDomain'].indexOf(r.options.shimScriptAccess) &&
            ...
            e.originalNode.getAttribute('src') &&
              ...
              !0 === r.options.enablePseudoStreaming &&
                (y.push('pseudostreamstart=' + r.options.pseudoStreamingStartQueryParam),
                y.push('pseudostreamtype=' + r.options.pseudoStreamingType)),
              r.options.streamDelimiter &&
                y.push('streamdelimiter=' + encodeURIComponent(r.options.streamDelimiter)),
            ...
            if (F.IS_IE || F.IS_EDGE) {
              ...
              r.flashWrapper.appendChild(w),
                (x = F.IS_EDGE
                  ? [
                      ...
                      'data="' + r.options.pluginPath + r.options.filename + '"',
                      'id="__' + r.id + '"',
                      'width="' + S + '"',
                      'height="' + b + '\'"'
                    ]
              ...
              (x = [
                ...
                E
                  ...
                  : x.push('style="position: fixed; left: -9999em; top: -9999em;"'),
        ...
        var w = {
              ...
              return (
                'undefined' != typeof flvjs
                  ...
                  : ((e.options.path =
                    ...
                    (w.promise = w.promise || (0, r.loadScript)(e.options.path)),
          ...
          s = {
            ...
            create: function(s, a, e) {
              ...
              return (
                s.dispatchEvent(g), s.promises.push(w.load({ options: h, configs: v, id: l })), d
              )
            }
          }
        ...
        var w = {
          ...
          s = {
            ...
            create: function(d, i, u) {
                        ...
                        if (-1 === b.default.html5media.readOnlyProperties.indexOf(o))
                          if ('src' === o) {
                            if (
                              ...
                              ;(c = w._createPlayer({ options: i.hls, id: r })).loadSource(e),
                                c.attachMedia(f)
                            }
                          } else f[o] = e
                      })
                            ...
                            if ('hlsError' === e && (console.warn(t), (t = t[1]).fatal))
                              switch (t.type) {
                                case 'mediaError':
                                  ...
                                  if (!s || 3e3 < n - s)
                                    (s = new Date().getTime()), c.recoverMediaError()
                                  else if (!l || 3e3 < n - l)
                                    (l = new Date().getTime()),
                                      console.warn(
              ...
              return d.dispatchEvent(g), d.promises.push(w.load({ options: i.hls, id: r })), f
            }
          }
        i.typeChecks.push(function(e) {
        ...
        var k = {
            ...
            enqueueIframe: function(e) {
              ;(k.isLoaded = 'undefined' != typeof YT && YT.loaded),
                k.isLoaded ? k.createIframe(e) : (k.loadIframeApi(), k.iframeQueue.push(e))
            },
            loadIframeApi: function() {
              k.isIframeStarted ||
                ((0, r.loadScript)('https://www.youtube.com/player_api'), (k.isIframeStarted = !0))
            },
            ...
            getYouTubeId: function(e) {
              ...
              return (
                0 < e.indexOf('?')
                  ? '' === (t = k.getYouTubeIdFromParam(e)) && (t = k.getYouTubeIdFromUrl(e))
          ...
          s = {
            ...
            create: function(m, n, o) {
              ...
              return (
                (p || m.originalNode.hasAttribute('playsinline')) && (x.playerVars.playsinline = 1),
      ...
      function(e, t, n) {
        ...
        function a(e) {
          ...
          return (
            ...
            n &&
              (T +=
                (m = (m = (h % s).toFixed(0)) <= 0 ? 0 : m) < 10 && E.f ? u + '0' + m : '' + u + m),
            T
          )
        }
        function s(e) {
          ...
          if ((0 < e.indexOf(';') && (e = e.replace(';', ':')), !/\d{2}(\:\d{2}){0,3}/i.test(e)))
          ...
          return (
            (o = C(t)
              ? c * i + f * r + u * a + s - d * ((l = 60 * i + r) - Math.floor(l / 10))
              : (c * i + f * r + t * a + s) / t),
