        ...
        Object.assign(_player2.default.prototype, {
          ...
          buildfullscreen: function buildfullscreen(player) {
            ...
            fullscreenBtn.className =
              t.options.classPrefix + 'button ' + t.options.classPrefix + 'fullscreen-button'
          ...
          detectFullscreenMode: function detectFullscreenMode() {
            var t = this,
              isNative =
                t.media.rendererName !== null && /(native|html5)/i.test(t.media.rendererName)
          ...
          enterFullScreen: function enterFullScreen() {
            var t = this,
              isNative =
                t.media.rendererName !== null && /(html5|native)/i.test(t.media.rendererName),
            ...
            if (
              ...
              t.media.originalNode.canPlayType((0, _media.getTypeFromFile)(t.media.getSrc()))
            ) {
            ...
            if (captionText) {
              ...
              t
                .getElement(t.container)
                .querySelector('.' + t.options.classPrefix + 'captions-position').style.bottom =
          ...
          buildprogress: function buildprogress(player, controls, layers, media) {
                ...
                action: function action(player) {
                  if (!isNaN(player.duration) && player.duration > 0) {
                    ...
                    var newTime = Math.max(
                      player.currentTime - player.options.defaultSeekBackwardInterval(player),
                      0
                    )
                ...
                action: function action(player) {
                  if (!isNaN(player.duration) && player.duration > 0) {
                    ...
                    var newTime = Math.min(
                      player.currentTime + player.options.defaultSeekForwardInterval(player),
                      player.duration
                    )
            ...
            var handleMouseMove = function handleMouseMove(e) {
                ...
                if (t.getDuration()) {
                  ...
                  if (!_constants.IS_IOS && !_constants.IS_ANDROID) {
                    ...
                    if (t.timefloat) {
                      ...
                      if (
                        ...
                        leftPos +=
                          parseFloat(tooltipStyles.marginLeft) / 2 + t.timefloat.offsetWidth / 2
                      }
                  ...
                  leftPos =
                    t.timefloat.offsetWidth + width >= t.getElement(t.container).offsetWidth
            ...
            t.slider.addEventListener('keydown', function(e) {
              ...
              if (t.options.enableKeyboard && t.options.keyActions.length) {
                ...
                if (keyCode === 38 || keyCode === 40) {
                  ...
                  var newVolume =
                      keyCode === 38 ? Math.min(t.volume + 0.1, 1) : Math.max(t.volume - 0.1, 0),
      ...
      function(_dereq_, module, exports) {
        ...
        Object.assign(_player2.default.prototype, {
          ...
          buildduration: function buildduration(player, controls, layers, media) {
            ...
            if (currTime) {
              ...
              if (controls.querySelector('.' + t.options.classPrefix + 'currenttime')) {
                ;(0, _dom.addClass)(
                  controls.querySelector('.' + t.options.classPrefix + 'currenttime').parentNode,
              ...
              duration.className =
                t.options.classPrefix + 'time ' + t.options.classPrefix + 'duration-container'
              duration.innerHTML =
                '<span class="' +
                t.options.classPrefix +
                'duration">' +
          ...
          updateCurrent: function updateCurrent() {
            ...
            if (
              t.getElement(t.controls).querySelector('.' + t.options.classPrefix + 'currenttime')
            ) {
              t
                .getElement(t.controls)
                .querySelector('.' + t.options.classPrefix + 'currenttime').innerText = timecode
            }
          },
          updateDuration: function updateDuration() {
            ...
            if (
              t.getElement(t.controls).querySelector('.' + t.options.classPrefix + 'duration') &&
              duration > 0
            ) {
              t
                .getElement(t.controls)
                .querySelector('.' + t.options.classPrefix + 'duration').innerHTML = timecode
            }
          }
        })
      },
        ...
        Object.assign(_player2.default.prototype, {
          ...
          buildtracks: function buildtracks(player, controls, layers, media) {
            ...
            player.captions.className =
              t.options.classPrefix + 'captions-layer ' + t.options.classPrefix + 'layer'
            ...
            player.captionsButton.className =
              t.options.classPrefix + 'button ' + t.options.classPrefix + 'captions-button'
            ...
            player.chaptersButton.className =
              t.options.classPrefix + 'button ' + t.options.classPrefix + 'chapters-button'
            ...
            for (var _i = 0; _i < total; _i++) {
              ...
              if (src.trim()) {
                if (kind === 'subtitles' || kind === 'captions') {
                  ...
                  kind === 'chapters' &&
                  !controls.querySelector('.' + t.options.classPrefix + 'chapter-selector')
                ) {
            ...
            if (t.options.toggleCaptionsButtonWhenOnlyOne && subtitleCount === 1) {
              ...
              for (var _i3 = 0, _total = inEvents.length; _i3 < _total; _i3++) {
                player.captionsButton.addEventListener(inEvents[_i3], function() {
                  ;(0,
                  _dom.removeClass)(this.querySelector('.' + t.options.classPrefix + 'captions-selector'), t.options.classPrefix + 'offscreen')
                })
              }
              ...
              for (var _i4 = 0, _total2 = outEvents.length; _i4 < _total2; _i4++) {
                player.captionsButton.addEventListener(outEvents[_i4], function() {
                  ;(0,
                  _dom.addClass)(this.querySelector('.' + t.options.classPrefix + 'captions-selector'), t.options.classPrefix + 'offscreen')
                })
              }
            ...
            for (var _i7 = 0, _total5 = inEvents.length; _i7 < _total5; _i7++) {
              player.chaptersButton.addEventListener(inEvents[_i7], function() {
                if (
                  this.querySelector('.' + t.options.classPrefix + 'chapters-selector-list')
                    .children.length
                ) {
                  ;(0, _dom.removeClass)(
                    this.querySelector('.' + t.options.classPrefix + 'chapters-selector'),
            ...
            for (var _i8 = 0, _total6 = outEvents.length; _i8 < _total6; _i8++) {
              player.chaptersButton.addEventListener(outEvents[_i8], function() {
                ;(0,
                _dom.addClass)(this.querySelector('.' + t.options.classPrefix + 'chapters-selector'), t.options.classPrefix + 'offscreen')
              })
            }
              ...
              player.getElement(player.container).addEventListener('controlshidden', function() {
                if (!media.paused) {
                  ;(0, _dom.removeClass)(
                    player
                      .getElement(player.container)
                      .querySelector('.' + t.options.classPrefix + 'captions-position'),
            ...
            if (track !== null && track.isLoaded) {
              ...
              if (i > -1) {
                ...
                t.captionsText.className =
                  t.options.classPrefix + 'captions-text ' + (track.entries[i].identifier || '')
        ...
        Object.assign(_player2.default.prototype, {
          buildvolume: function buildvolume(player, controls, layers, media) {
            ...
            var t = this,
              ...
              volumeControlText = (0, _general.isString)(t.options.allyVolumeControlText)
            ...
            var volumeSlider =
                mode === 'vertical'
                  ...
                  : t
                      .getElement(t.container)
                      .querySelector('.' + t.options.classPrefix + 'horizontal-volume-slider'),
              volumeTotal =
                mode === 'vertical'
                  ? t
                      .getElement(t.container)
                      .querySelector('.' + t.options.classPrefix + 'volume-total')
                  : t
                      .getElement(t.container)
                      .querySelector('.' + t.options.classPrefix + 'horizontal-volume-total'),
              volumeCurrent =
                mode === 'vertical'
                  ? t
                      .getElement(t.container)
                      .querySelector('.' + t.options.classPrefix + 'volume-current')
                  : t
                      .getElement(t.container)
                      .querySelector('.' + t.options.classPrefix + 'horizontal-volume-current'),
              volumeHandle =
                mode === 'vertical'
                  ? t
                      .getElement(t.container)
                      .querySelector('.' + t.options.classPrefix + 'volume-handle')
                  : t
                      .getElement(t.container)
                      .querySelector('.' + t.options.classPrefix + 'horizontal-volume-handle'),
            ...
            mute.addEventListener('focusout', function(e) {
              if (
                (!e.relatedTarget ||
                  (e.relatedTarget &&
                    !e.relatedTarget.matches('.' + t.options.classPrefix + 'volume-slider'))) &&
                mode === 'vertical'
              ) {
                volumeSlider.style.display = 'none'
              }
          ...
          _createClass(MediaElementPlayer, [
            ...
            },
            {
              ...
              value: function init() {
                ...
                if (
                  ...
                  (t.isVideo ||
                    (!t.isVideo && (t.options.features.length || t.options.useDefaultControls))) &&
                  ...
                  if (!t.options.features.length && !t.options.useDefaultControls) {
                    ...
                    t
                      .getElement(t.container)
                      .querySelector('.' + t.options.classPrefix + 'controls').style.display =
                      'none'
                  }
              ...
              value: function hideControls(doAnimation, forceHide) {
                ...
                if (
                  ...
                  (!t.controlsAreVisible ||
                    ...
                    (t.paused &&
                      t.readyState === 4 &&
                      ((!t.options.hideVideoControlsOnLoad && t.currentTime <= 0) ||
                        (!t.options.hideVideoControlsOnPause && t.currentTime > 0))) ||
            ...
            },
            {
              ...
              value: function startControlsTimer(timeout) {
                ...
                timeout =
                  typeof timeout !== 'undefined' ? timeout : t.options.controlsTimeoutDefault
            ...
            },
            {
              ...
              value: function _meReady(media, domNode) {
                var t = this,
                  ...
                  isNative =
                    media.rendererName !== null && /(native|html5)/i.test(t.media.rendererName)
                ...
                if (
                  ...
                  t
                    .getElement(t.container)
                    .querySelector('.' + t.options.classPrefix + 'overlay-play').style.display = ''
                }
                  ...
                  t.getElement(t.container).addEventListener('focusout', function(e) {
                    setTimeout(function() {
                      if (e.relatedTarget) {
                        if (
                          t.keyboardAction &&
                          !e.relatedTarget.closest('.' + t.options.classPrefix + 'container')
                        ) {
            ...
            },
            {
              ...
              value: function _handleError(e, media, node) {
                ...
                if (
                  ...
                  t
                    .getElement(t.layers)
                    .querySelector('.' + t.options.classPrefix + 'overlay-error')
                ) {
                  errorContainer.innerHTML = errorContent
                  t
                    .getElement(t.layers)
                    .querySelector('.' + t.options.classPrefix + 'overlay-error').innerHTML =
            ...
            },
            {
              ...
              value: function hasFluidMode() {
                ...
                return (
                  ...
                  (t.node && t.node.currentStyle && t.node.currentStyle.maxWidth === '100%')
                )
              }
            },
            {
              ...
              value: function setResponsiveMode() {
                ...
                if (
                  ...
                  t.getElement(t.container).parentNode.tagName.toLowerCase() === 'body'
                ) {
                  parentWidth =
                    _window2.default.innerWidth ||
                    _document2.default.documentElement.clientWidth ||
                ...
                if (t.rail && dom.visible(t.rail)) {
                  var totalStyles = t.total ? getComputedStyle(t.total, null) : null,
                    totalMargin = totalStyles
                      ? parseFloat(totalStyles.marginLeft) + parseFloat(totalStyles.marginRight)
                      : 0,
                    railStyles = getComputedStyle(t.rail),
                    railMargin =
                      parseFloat(railStyles.marginLeft) + parseFloat(railStyles.marginRight)
                  ...
                  siblingsWidth +=
                    totalMargin + (totalMargin === 0 ? railMargin * 2 : railMargin) + 1
            ...
            },
            {
              ...
              value: function createIframeLayer() {
                ...
                if (
                  ...
                  !_document2.default.getElementById(t.media.id + '-iframe-overlay')
                ) {
            ...
            },
            {
              ...
              value: function buildoverlays(player, controls, layers, media) {
                ...
                loading.className =
                  t.options.classPrefix + 'overlay ' + t.options.classPrefix + 'layer'
                loading.innerHTML =
                  '<div class="' +
                  t.options.classPrefix +
                  'overlay-loading">' +
                ...
                bigPlay.innerHTML =
                  ...
                  ('aria-label="' + _i18n2.default.t('mejs.play') + '" aria-pressed="false"></div>')
            ...
            },
            {
              ...
              value: function remove() {
                ...
                if (_typeof(t.getElement(t.container)) === 'object') {
                  var offscreen = t
                    .getElement(t.container)
                    .parentNode.querySelector('.' + t.options.classPrefix + 'offscreen')
                  offscreen.remove()
    ...
    28: [
      function(_dereq_, module, exports) {
        ...
        function getTypeFromFile(url) {
          ...
          if (normalizedExt) {
            if (
              ~['mp4', 'm4v', 'ogg', 'ogv', 'webm', 'flv', 'mpeg', 'mov'].indexOf(normalizedExt)
            ) {
    ...
    30: [
      function(_dereq_, module, exports) {
        ...
        function secondsToTimeCode(time) {
          ...
          var timeFormat =
            arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 'hh:mm:ss'
          ...
          if (isDropFrame(fps)) {
            ...
            if (m > dropFrames) {
              f =
                f +
                dropFrames * Math.floor((m - dropFrames) / Math.round(timeBase * 60 - dropFrames))
            }
          ...
          if (showFrameCount) {
            ...
            result +=
              frames < 10 && timeFormatSettings.f ? frameSep + '0' + frames : '' + frameSep + frames
          }
