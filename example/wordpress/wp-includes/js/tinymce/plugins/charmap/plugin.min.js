!(function() {
  ...
  var e = tinymce.util.Tools.resolve('tinymce.PluginManager'),
    ...
    u = function(e) {
      ...
      for (
        t = '<table role="presentation" cellspacing="0" class="mce-charmap"><tbody>', i = 0;
        i < n;
        i++
      ) {
        for (t += '<tr>', a = 0; a < r; a++) {
      ...
      var o,
        e = {
          ...
          onmouseover: function(e) {
            var t = d(e.target)
            t && t.firstChild
              ? (o.find('#preview').text(t.firstChild.firstChild.data),
                o.find('#previewTitle').text(t.title))
              : (o.find('#preview').text(' '), o.find('#previewTitle').text(' '))
          }
        }
