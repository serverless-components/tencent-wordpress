!(function(u) {
  ...
  var e,
    ...
    m = tinymce.util.Tools.resolve('tinymce.util.VK'),
    ...
    A = function(e, n) {
      if (y(e)) return { container: e, offset: n }
      var t = d.getNode(e, n)
      return y(t)
        ? { container: t, offset: n >= e.childNodes.length ? t.data.length : 0 }
        : t.previousSibling && y(t.previousSibling)
        ? { container: t.previousSibling, offset: t.previousSibling.data.length }
      ...
      var i = {},
        e = function(e) {
          ...
          ;(t = o[e ? 'startContainer' : 'endContainer']),
            ...
            1 === t.nodeType &&
              ((n = R.create('span', { 'data-mce-type': 'bookmark' })),
              t.hasChildNodes()
                ? ((r = Math.min(r, t.childNodes.length - 1)),
                  e ? t.insertBefore(n, t.childNodes[r]) : R.insertAfter(n, t.childNodes[r]))
                : t.appendChild(n),
              (t = n),
              (r = 0)),
    ...
    re = function(e, n) {
      return (function(e) {
        for (var n = [], t = 0, r = e.length; t < r; ++t) {
          if (!z(e[t])) throw new Error('Arr.flatten item ' + t + ' was not an array, input: ' + e)
          G.apply(n, e[t])
        }
        return n
      })(J(e, n))
    ...
    oe = function(e) {
      return 0 === e.length ? q.none() : q.some(e[0])
    },
    ie = function(e) {
      return 0 === e.length ? q.none() : q.some(e[e.length - 1])
    },
    ue =
      (X(Array.from) && Array.from,
      'undefined' != typeof u.window ? u.window : Function('return this;')()),
    se = function(e, n) {
      return (function(e, n) {
        for (
          var t = n !== undefined && null !== n ? n : ue, r = 0;
          r < e.length && t !== undefined && null !== t;
          ++r
        )
          t = t[e[r]]
        return t
    ...
    ce = function(e) {
      var n,
        t = se('ownerDocument.defaultView', e)
      return ((n = t), ae('HTMLElement', n)).prototype.isPrototypeOf(e)
    },
    fe = tinymce.util.Tools.resolve('tinymce.dom.DomQuery'),
    de = function(e) {
    ...
    ve = {
      ...
      getSelectedListRoots: function(e) {
        var n,
          ...
          r,
          o =
            ((t = ge((n = e), n.selection.getStart())),
            (r = ee(n.selection.getSelectedBlocks(), S)),
            t.toArray().concat(r))
        return pe(e, o)
      }
    },
    ...
    ye = {
      fromHtml: function(e, n) {
        var t = (n || u.document).createElement('div')
        if (((t.innerHTML = e), !t.hasChildNodes() || 1 < t.childNodes.length))
          throw (u.console.error('HTML does not have a single root node', e),
          new Error('HTML must have a single root node'))
        return he(t.childNodes[0])
      },
      fromTag: function(e, n) {
        var t = (n || u.document).createElement(e)
        return he(t)
      },
      fromText: function(e, n) {
        var t = (n || u.document).createTextNode(e)
        return he(t)
      },
      fromDom: he,
      fromPoint: function(e, n, t) {
        var r = e.dom()
        return q.from(r.elementFromPoint(n, t)).map(he)
      }
    },
    Ne = function(e, n, t) {
    ...
    be = function(e, n) {
      return Oe(e, n, Ce().DOCUMENT_POSITION_CONTAINED_BY)
    },
    Te = function(e, n) {
      var t = (function(e, n) {
    ...
    Ae = function(e) {
      ...
      return {
        ...
        version: e.version,
        isEdge: ke('Edge', n),
        isChrome: ke('Chrome', n),
        isIE: ke('IE', n),
        isOpera: ke('Opera', n),
        isFirefox: ke(we, n),
        isSafari: ke('Safari', n)
      }
    },
    xe = {
      unknown: function() {
        return Ae({ current: undefined, version: De.unknown() })
      },
      nu: Ae,
      edge: P('Edge'),
      chrome: P('Chrome'),
    ...
    Ue = {
      unknown: function() {
        return Me({ current: undefined, version: De.unknown() })
      },
      nu: Me,
      windows: P(Re),
      ios: P('iOS'),
    ...
    je = function(e, t) {
      return Fe(e, t).map(function(e) {
        var n = De.detect(e.versionRegexes, t)
    ...
    ze = [
      ...
      { name: 'OSX', search: We('os x'), versionRegexes: [/.*?os\ x\ ?([0-9]+)_([0-9]+).*/] },
    ...
    Xe = function(e) {
      var n,
        ...
        l = Ke.browsers(),
        m = Ke.oses(),
        g = je(l, e).fold(xe.unknown, xe.nu),
        p = He(m, e).fold(Ue.unknown, Ue.nu)
      return {
        browser: g,
        os: p,
        deviceType:
          ...
          (s = n.isAndroid() && 4 === n.version.major),
          (a = o || u || (s && !0 === /mobile/i.test(r))),
          (c = n.isiOS() || n.isAndroid()),
          (f = c && !a),
          (d = t.isSafari() && n.isiOS() && !1 === /safari/i.test(r)),
          {
            isiPad: P(o),
            isiPhone: P(i),
            isTablet: P(a),
    ...
    Qe = {
      detect:
        ...
        function() {
          for (var e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n]
          return s || ((s = !0), (i = o.apply(null, e))), i
        })
    },
    Ye =
      (u.Node.ATTRIBUTE_NODE,
      u.Node.CDATA_SECTION_NODE,
      u.Node.COMMENT_NODE,
      u.Node.DOCUMENT_NODE,
      u.Node.DOCUMENT_TYPE_NODE,
      u.Node.DOCUMENT_FRAGMENT_NODE,
      u.Node.ELEMENT_NODE),
    Ge =
      (u.Node.TEXT_NODE,
      u.Node.PROCESSING_INSTRUCTION_NODE,
      u.Node.ENTITY_REFERENCE_NODE,
      u.Node.ENTITY_NODE,
      u.Node.NOTATION_NODE,
      Ye),
    Je = function(e, n) {
      return e.dom() === n.dom()
    },
    Ze = Qe.detect().browser.isIE()
      ? function(e, n) {
          return be(e.dom(), n.dom())
        }
      : function(e, n) {
          var t = e.dom(),
            r = n.dom()
    ...
    nn = function(e) {
      return q.from(e.dom().parentNode).map(ye.fromDom)
    },
    tn = function(e) {
      return J(e.dom().childNodes, ye.fromDom)
    },
    rn = function(e, n) {
      var t = e.dom().childNodes
      return q.from(t[n]).map(ye.fromDom)
    },
    on = function(e) {
      return rn(e, 0)
    },
    un = function(e) {
      return rn(e, e.dom().childNodes.length - 1)
    },
    sn =
      ((function() {
        for (var e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n]
    ...
    ln =
      ((a = Ye),
      function(e) {
        return e.dom().nodeType === a
      }),
    mn = function(e, n) {
      var t = e.dom()
      !(function(e, n) {
        for (var t = Se(e), r = 0, o = t.length; r < o; r++) {
          var i = t[r]
          n(e[i], i)
        }
      })(n, function(e, n) {
    ...
    pn = function(e, n, t) {
      ...
      var r
      ;(r = e).style !== undefined && X(r.style.getPropertyValue) && e.style.setProperty(n, t)
    },
    vn = function(e) {
      return (n = e), (t = !0), ye.fromDom(n.dom().cloneNode(t))
      var n, t
    },
    hn = function(e, n) {
      var t,
        ...
        o,
        i,
        u = ((t = e), (r = n), (o = ye.fromTag(r)), (i = gn(t)), mn(o, i), o)
      sn(e, u)
      var s = tn(e)
      return cn(u, s), fn(e), u
    },
    yn = function(e, n) {
      an(e.item, n.list)
    },
      ...
      return (
        ie(n).each(function(e) {
          ...
          ;(u = c),
            ...
            (i.item = u),
            (a = d),
            dn((s = e).list) !== a.listType && (s.list = hn(s.list, a.listType)),
            mn(s.list, a.listAttributes)
        }),
        n
      )
    },
        ...
        o = (function(e, n, t) {
          for (var r, o, i, u = [], s = 0; s < t; s++)
            u.push(
              ((r = e),
              (o = n.listType),
              (i = { list: ye.fromTag(o, r), item: ye.fromTag('li', r) }),
              an(i.list, i.item),
              i)
            )
          return u
      ...
      return (
        ...
        (function(e, n) {
          for (var t = 0; t < e.length - 1; t++)
            (r = e[t].item), (o = 'list-style-type'), (i = 'none'), (u = r.dom()), pn(u, o, i)
          var r, o, i, u
          ie(e).each(function(e) {
            mn(e.list, n.listAttributes), mn(e.item, n.itemAttributes), cn(e.item, n.content)
          })
        })(o, t),
        (r = o),
        Ne(ie(n), oe(r), yn),
    ...
    Dn =
      ...
      function() {
        ...
        for (var t = {}, r = 0; r < e.length; r++) {
          var o = e[r]
          for (var i in o) Ln.call(o, i) && (t[i] = c(t[i], o[i]))
        }
        return t
      }),
    wn = function(n) {
      Z(n, function(r, e) {
        ;(function(e, n) {
          for (var t = e[n].depth, r = n - 1; 0 <= r; r--) {
            if (e[r].depth === t) return q.some(e[r])
            if (e[r].depth < t) break
          }
          return q.none()
        })(n, e).each(function(e) {
          var n, t
          ;(t = e), ((n = r).listType = t.listType), (n.listAttributes = Dn({}, t.listAttributes))
        })
      })
    },
    kn = function(e) {
    ...
    xn = function(n, t, r, e) {
      return re(tn(e), function(e) {
        return (Cn(e) ? xn : An)(n + 1, t, r, e)
      })
    },
    Rn = tinymce.util.Tools.resolve('tinymce.Env'),
    In = function(e, n) {
      var t,
        r,
        o,
      ...
      if (
        ...
        o &&
          ...
          L(n.firstChild, s) || a.appendChild(r)),
        n)
      )
        for (; (t = n.firstChild); ) {
          var c = t.nodeName
          i || ('SPAN' === c && 'bookmark' === t.getAttribute('data-mce-type')) || (i = !0),
            L(t, s)
              ? (a.appendChild(t), (r = null))
              : o
              ? (r || ((r = u.create(o)), a.appendChild(r)), r.appendChild(t))
              : a.appendChild(t)
        }
      return (
        e.settings.forced_root_block
          ? i ||
            (Rn.ie && !(10 < Rn.ie)) ||
            r.appendChild(u.create('br', { 'data-mce-bogus': '1' }))
    ...
    _n = function(i, e) {
      return J(e, function(e) {
        var n,
          ...
          o =
            ((n = e.content),
            (r = (t || u.document).createDocumentFragment()),
            Z(n, function(e) {
              r.appendChild(e.dom())
            }),
            ye.fromDom(r))
        return ye.fromDom(In(i, o.dom()))
      })
    },
    Bn = function(e, n) {
      return (
    ...
    Pn = function(e) {
      var n,
        t,
        r = J(ve.getSelectedListItems(e), ye.fromDom)
      return Ne(te(r, M(On)), te(((n = r), (t = Y.call(n, 0)).reverse(), t), M(On)), function(
        e,
        n
      ) {
    ...
    Mn = function(s, e, a) {
      var n,
        ...
        o =
          ...
          (r = kn(!1)),
          J(n, function(e) {
            return { sourceList: e, entries: xn(0, t, r, e) }
          }))
      Z(o, function(e) {
        var n, t, r, o, i, u
        ;(n = e.entries),
          (t = a),
          Z(ee(n, Tn), function(e) {
            return (function(e, n) {
              switch (e) {
                case 'Indent':
                  n.depth++
    ...
    Fn = function(e, n, t) {
      var r, o, i, u, s, a
      for (
        i = Un.select('span[data-mce-type="bookmark"]', n),
          s = In(e, t),
          (r = Un.createRng()).setStartAfter(t),
          r.setEndAfter(n),
      ...
      e.dom.isEmpty(o) || Un.insertAfter(o, n),
        Un.insertAfter(s, n),
        w(e.dom, t.parentNode) &&
          ((a = t.parentNode),
          v.each(i, function(e) {
          ...
          : function(e) {
              return (
                ...
                void (en((t = e), 'dd')
                  ? hn(t, 'dt')
                  : en(t, 'dt') &&
                    nn(t).each(function(e) {
                      return Fn(n, e.dom(), t.dom())
                    }))
              )
              var n, t
            }
    ...
    $n = function(e, n) {
      var t = J(ve.getSelectedListRoots(e), ye.fromDom),
        r = J(ve.getSelectedDlItems(e), ye.fromDom),
        o = !1
    ...
    Kn = function(e, n, t) {
      ...
      ;(r = e),
        ...
        (s = e),
        zn((a = n), (c = t)['list-attributes']),
        v.each(s.select('li', a), function(e) {
          zn(e, c['list-item-attributes'])
        })
    },
    Xn = function(e, n, t, r) {
      var o, i
      for (
        o = n[t ? 'startContainer' : 'endContainer'],
          ...
          !t && T(o.nextSibling) && (o = o.nextSibling);
        o.parentNode !== r;
    ...
    Qn = function(f, d, l) {
      void 0 === l && (l = {})
      var e,
        n = f.selection.getRng(!0),
        m = 'LI',
        t = ve.getClosestListRootElm(f, f.selection.getStart(!0)),
        g = f.dom
      'false' !== g.getContentEditable(f.selection.getNode()) &&
        ('DL' === (d = d.toUpperCase()) && (m = 'DT'),
        (e = I(n)),
        v.each(
          (function(t, e, r) {
            for (
              var o, i = [], u = t.dom, n = Xn(t, e, !0, r), s = Xn(t, e, !1, r), a = [], c = n;
              c && (a.push(c), c !== s);
              c = c.nextSibling
            );
            return (
              v.each(a, function(e) {
                if (E(t, e)) return i.push(e), void (o = null)
                if (u.isBlock(e) || T(e)) return T(e) && u.remove(e), void (o = null)
                var n = e.nextSibling
                p.isBookmarkNode(e) && (E(t, n) || (!n && e.parentNode === r))
                  ? (o = null)
                  : (o || ((o = u.create('p')), e.parentNode.insertBefore(o, e), i.push(o)),
                    o.appendChild(e))
              }),
              i
            )
          ...
          function(e) {
            ...
            i === (u = null === u ? '' : u))
              ? ((n = t), (e = g.rename(e, m)), t.appendChild(e))
              : ((n = g.create(d)),
              ...
              v.each(c, function(e) {
                var n
                return s.setStyle(a, (((n = {})[e] = ''), n))
              }),
              Kn(g, n, l),
              Gn(f.dom, n)
          }
        ),
        f.selection.setRng(_(e)))
    },
    Yn = function(e, n, t) {
      return (
        (a = t),
        (s = n) &&
          a &&
          N(s) &&
          s.nodeName === a.nodeName &&
          ((i = n),
          (u = t),
          (o = e).getStyle(i, 'list-style-type', !0) === o.getStyle(u, 'list-style-type', !0)) &&
    ...
    Gn = function(e, n) {
      var t, r
      if (((t = n.nextSibling), Yn(e, n, t))) {
        for (; (r = t.firstChild); ) n.appendChild(r)
        e.remove(t)
      }
      if (((t = n.previousSibling), Yn(e, n, t))) {
        for (; (r = t.lastChild); ) n.insertBefore(r, n.firstChild)
        e.remove(t)
      }
    },
    Jn = function(n, e, t, r, o) {
      if (e.nodeName !== r || Zn(o)) {
        ...
        ;(t = t || {}),
          r && 0 < o.length
            ...
            : (function(e, n, t, r) {
                if (n !== e.getBody())
                  if (n)
                    if (n.nodeName !== t || Zn(r)) {
                      var o = I(e.selection.getRng(!0))
                      Kn(e.dom, n, r), Gn(e.dom, e.dom.rename(n, t)), e.selection.setRng(_(o))
                    } else Vn(e)
                  else Qn(e, t, r)
              })(e, r, n, t)
      },
      mergeWithAdjacentLists: Gn
    },
    nt = g.DOM,
    tt = function(e, n) {
      var t,
      ...
      'LI' === r.nodeName &&
        r.firstChild === n &&
        ((t = r.previousSibling) && 'LI' === t.nodeName
          ? (t.appendChild(n), w(e, r) && nt.remove(r))
          : nt.setStyle(r, 'listStyleType', 'none')),
    ...
    ot = function(e, n, t, r) {
      var o,
        ...
        u = n.startContainer,
        s = n.startOffset
      if (3 === u.nodeType && (t ? s < u.data.length : 0 < s)) return u
      for (
        o = e.schema.getNonEmptyElements(),
          1 === u.nodeType && (u = d.getNode(u, s)),
          i = new l(u, r),
          t && D(e.dom, u) && i.next();
        (u = i[t ? 'next' : 'prev2']());

      ) {
        if ('LI' === u.nodeName && !u.hasChildNodes()) return u
        if (o[u.nodeName]) return u
        if (3 === u.nodeType && 0 < u.data.length) return u
      }
    },
    it = function(e, n) {
      var t = n.childNodes
    ...
    ut = function(e, n, t) {
      var r, o, i, u
      if (
        ((o = it(e, t) ? t.firstChild : t),
        it((i = e), (u = n)) && i.remove(u.firstChild, !0),
        !w(e, n, !0))
      )
    ...
    st = function(n, e, t) {
      var r,
        ...
        i = e.parentNode
      if (k(n, e) && k(n, t)) {
        N(t.lastChild) && (o = t.lastChild),
          i === t.lastChild && T(i.previousSibling) && n.remove(i.previousSibling),
          (r = t.lastChild) && T(r) && e.hasChildNodes() && n.remove(r),
          w(n, t, !0) && n.$(t).empty(),
          ut(n, e, t),
          o && t.appendChild(o)
        var u = Ze(ye.fromDom(t), ye.fromDom(e)) ? n.getParents(e, N, t) : []
        n.remove(e),
          Z(u, function(e) {
            w(n, e) && e !== n.getRoot() && n.remove(e)
          })
      }
    },
    at = function(e, n, t, r) {
      ...
      if (s.isEmpty(r))
        ...
        var a = I(n)
        st(s, t, r), e.selection.setRng(_(a))
      }
    },
    ct = function(e, n) {
      var t,
        ...
        u = e.selection,
        s = u.getStart(),
        a = ve.getClosestListRootElm(e, s),
        c = i.getParent(u.getStart(), 'LI', a)
      if (c) {
        if ((t = c.parentNode) === e.getBody() && w(i, t)) return !0
        if (((r = x(u.getRng(!0))), (o = i.getParent(ot(e, r, n, a), 'LI', a)) && o !== c))
          return (
            n
              ? at(e, r, o, c)
              : (function(e, n, t, r) {
      ...
      return (
        ...
        (function(o, i) {
          var u = o.dom,
            ...
            s = ve.getClosestListRootElm(o, e),
            a = u.getParent(e, u.isBlock, s)
          if (a && u.isEmpty(a)) {
            var n = x(o.selection.getRng(!0)),
              c = u.getParent(ot(o, n, i, s), 'LI', s)
            if (c)
              return (
                o.undoManager.transact(function() {
                  ...
                  ;(n = a),
                    ...
                    et.mergeWithAdjacentLists(u, c.parentNode),
    ...
    dt = function(e, n) {
      return e.selection.isCollapsed()
        ...
        : ((r = (t = e).selection.getStart()),
          ...
          !!(t.dom.getParent(r, 'LI,DT,DD', o) || 0 < ve.getSelectedListItems(t).length) &&
    ...
    lt = function(n) {
      n.on('keydown', function(e) {
        e.keyCode === m.BACKSPACE
          ? dt(n, !1) && e.preventDefault()
          : e.keyCode === m.DELETE && dt(n, !0) && e.preventDefault()
      })
    },
    mt = dt,
    gt = function(n) {
    ...
    vt = function(t) {
      t.on('BeforeExecCommand', function(e) {
        ...
        'indent' === n ? qn(t) : 'outdent' === n && Wn(t)
      }),
        t.addCommand('InsertUnorderedList', function(e, n) {
          et.toggleList(t, 'UL', n)
        }),
        t.addCommand('InsertOrderedList', function(e, n) {
          et.toggleList(t, 'OL', n)
        }),
        t.addCommand('InsertDefinitionList', function(e, n) {
          et.toggleList(t, 'DL', n)
        }),
        t.addCommand('RemoveList', function() {
          Vn(t)
        }),
        t.addQueryStateHandler('InsertUnorderedList', pt(t, 'UL')),
        t.addQueryStateHandler('InsertOrderedList', pt(t, 'OL')),
        t.addQueryStateHandler('InsertDefinitionList', pt(t, 'DL'))
    },
    ht = function(e) {
        ...
        (n = e).on('keydown', function(e) {
          e.keyCode !== m.TAB ||
            ...
            n.undoManager.transact(function() {
              ;(e.shiftKey ? Wn(n) : qn(n)) && e.preventDefault()
            })
        }),
        lt(e)
    },
    ...
    St = function(e) {
      ...
      ;(t = 'advlist'),
        ...
        -1 === v.inArray(r.split(/[ ,]/), t) &&
          (e.addButton('numlist', {
            active: !1,
            title: 'Numbered list',
            cmd: 'InsertOrderedList',
            onPostRender: Nt(e, 'OL')
          }),
          e.addButton('bullist', {
            active: !1,
            title: 'Bullet list',
            cmd: 'InsertUnorderedList',
            onPostRender: Nt(e, 'UL')
          })),
        e.addButton('indent', { icon: 'indent', title: 'Increase indent', cmd: 'Indent' })
    }
  f.add('lists', function(e) {
    return yt(e), St(e), vt(e), gt(e)
  })
})(window)
