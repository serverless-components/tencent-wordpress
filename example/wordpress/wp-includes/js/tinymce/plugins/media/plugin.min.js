!(function() {
  ...
  var e,
    ...
    _ = x,
    S = function(e) {
      return null === e || e === undefined ? O : j(e)
    },
    k = Object.hasOwnProperty,
    N = function(e, t) {
      return M(e, t) ? S(e[t]) : _()
    },
    M = function(e, t) {
      return k.call(e, t)
    },
    T = tinymce.util.Tools.resolve('tinymce.dom.DOMUtils'),
    z = tinymce.util.Tools.resolve('tinymce.html.SaxParser'),
    A = function(e, t) {
    ...
    P = function(a, e) {
      ...
      return (
        z({
          ...
          start: function(e, t) {
            if (c.get());
            else if (M(t.map, 'data-ephox-embed-iri'))
              c.set(!0),
                (i = (n = t).map.style),
                (o = i ? C.parseStyle(i) : {}),
                (u = {
                  type: 'ephox-embed-iri',
                  source1: n.map['data-ephox-embed-iri'],
                  source2: '',
                  poster: '',
                  width: N(o, 'max-width')
                    .map($)
                    .getOr(''),
                  height: N(o, 'max-height')
                    .map($)
                    .getOr('')
                })
            else {
              if (
                (u.source1 || 'param' !== e || (u.source1 = t.map.movie),
                ('iframe' !== e &&
                  'object' !== e &&
                  'embed' !== e &&
                  'video' !== e &&
                  'audio' !== e) ||
                  (u.type || (u.type = e), (u = v.extend(t.map, u))),
                'script' === e)
              ) {
                var r = A(a, t.map.src)
                if (!r) return
                u = { type: 'script', source1: t.map.src, width: r.width, height: r.height }
              }
              'source' === e &&
                (u.source1 ? u.source2 || (u.source2 = t.map.src) : (u.source1 = t.map.src)),
                'img' !== e || u.poster || (u.poster = t.map.src)
            }
            var n, i, o
          }
        }).parse(e),
        (u.source1 = u.source1 || u.src || u.data),
        (u.source2 = u.source2 || ''),
        (u.poster = u.poster || ''),
        u
      )
    },
    F = tinymce.util.Tools.resolve('tinymce.util.Promise'),
    D = function(e) {
      var t = {
        mp3: 'audio/mpeg',
        wav: 'audio/wav',
    ...
    L = tinymce.util.Tools.resolve('tinymce.html.Schema'),
    E = tinymce.util.Tools.resolve('tinymce.html.Writer'),
    J = T.DOM,
    R = function(e) {
      ...
      for (var r in t) {
        ...
        if (e.map[r])
          for (var i = e.length; i--; ) {
            var o = e[i]
            o.name === r &&
              (n ? ((e.map[r] = n), (o.value = n)) : (delete e.map[r], e.splice(i, 1)))
          }
        else n && (e.push({ name: r, value: n }), (e.map[r] = n))
      }
    },
    W = function(e, c, u) {
      var s,
            ...
            start: function(e, t, r) {
              if (m.get());
                ...
                m.set(!0),
                  (n = c),
                  (o = (i = t).map.style),
                  ((a = o ? J.parseStyle(o) : {})['max-width'] = R(n.width)),
                  (a['max-height'] = R(n.height)),
                  U(i, { style: J.serializeStyle(a) })
              else {
                switch (e) {
                  case 'video':
                  case 'object':
                  ...
                  case 'iframe':
                    c.height !== undefined &&
                      c.width !== undefined &&
                      U(t, { width: c.width, height: c.height })
                }
                if (u)
                  switch (e) {
                    case 'video':
                      U(t, { poster: c.poster, src: '' }), c.source2 && U(t, { src: '' })
                      break
                    case 'iframe':
                      U(t, { src: c.source1 })
                      break
                    case 'source':
                      if (
                        ++d <= 2 &&
                        (U(t, { src: c['source' + d], type: c['source' + d + 'mime'] }),
                        !c['source' + d])
                      )
                        return
                      break
                ...
                if ('video' === e && u)
                  for (var t = 1; t <= 2; t++)
                    if (c['source' + t]) {
                      ...
                      ;(r.map = {}),
                        d < t &&
                          (U(r, { src: c['source' + t], type: c['source' + t + 'mime'] }),
                          l.start('source', r, !0))
                    }
                if (c.poster && 'object' === e && u && !s) {
                  var n = []
                  ;(n.map = {}),
                    U(n, { src: c.poster, width: c.width, height: c.height }),
                    l.start('img', n, !0)
                }
              }
              l.end(e)
    ...
    I = function(r, e) {
      var n = v.extend({}, e)
      if (!n.source1 && (v.extend(n, P(w(r), n.embed)), !n.source1)) return ''
      n.source2 || (n.source2 = ''),
        n.poster || (n.poster = ''),
        (n.source1 = r.convertURL(n.source1, 'source')),
        (n.source2 = r.convertURL(n.source2, 'source')),
        (n.source1mime = D(n.source1)),
        (n.source2mime = D(n.source2)),
      ...
      if (
        (o &&
          ...
          (n.width = n.width || o.w),
          (n.height = n.height || o.h)),
        n.embed)
      )
        return W(n.embed, n, !0)
      var a = A(w(r), n.source1)
      a && ((n.type = 'script'), (n.width = a.width), (n.height = a.height))
      var c,
        u,
        s,
        l,
      ...
      return (
        ...
        'iframe' === n.type
          ? ((f = (h = n).allowFullscreen ? ' allowFullscreen="1"' : ''),
            '<iframe src="' +
              h.source1 +
              '" width="' +
              h.width +
          ...
          ? ((d =
            ...
            m.poster &&
              (d +=
                '<img src="' + m.poster + '" width="' + m.width + '" height="' + m.height + '" />'),
            (d += '</object>'))
      ...
      return c
        ? ((i = t),
          ...
          new F(function(t, e) {
            var r = function(e) {
              return (
                e.html && (q[i.source1] = e), t({ url: i.source1, html: e.html ? e.html : o(i) })
              )
            }
            q[i.source1] ? r(q[i.source1]) : a({ url: i.source1 }, r, e)
          }))
        : ((r = t),
          (n = V(e)),
          new F(function(e) {
            e({ html: n(r), url: r.source1 })
          }))
    },
    G = function(e) {
    ...
    Q = function(n) {
      return function(e, t) {
        var r
        e && (e.style[n] = /^[0-9.]+$/.test((r = t)) ? r + 'px' : r)
      }
    },
    X = {
      getMaxWidth: K('maxWidth'),
      getMaxHeight: K('maxHeight'),
      setMaxWidth: Q('maxWidth'),
      setMaxHeight: Q('maxHeight')
    },
    Y = function(e, t) {
    ...
    Z = function(e, t) {
      ...
      r && n && i && t(r, n, i.checked())
    },
    ee = function(e, t, r) {
      var n = e.state.get('oldVal'),
      ...
      r &&
        ...
        a &&
        (o !== n
          ? ((a = Math.round((o / n) * a)), isNaN(a) || t.value(a))
          : ((o = Math.round((a / i) * o)), isNaN(o) || e.value(o))),
        Y(e, t)
    },
    te = function(e) {
      Z(e, ee)
    ...
    ie = te,
    oe = o.ie && o.ie <= 8 ? 'onChange' : 'onInput',
    ae = function(r) {
      return function(e) {
        var t =
          e && e.msg
    ...
    ce = function(i, o) {
      return function(e) {
        var t = e.html,
          r = i.find('#embed')[0],
          n = v.extend(P(w(o), t), { source1: e.url })
        i.fromJSON(n), r && (r.value(t), ie(i))
      }
    },
    ue = function(e, t) {
      ...
      e.insertContent(t),
        (function(e, t) {
          var r,
            n,
            i = e.dom.select('img[data-mce-object]')
          for (r = 0; r < t.length; r++)
            for (n = i.length - 1; 0 <= n; n--) t[r] === i[n] && i.splice(n, 1)
    ...
    se = function(n) {
      ...
      if (
        ...
        var u = re(function(e) {
          e(i), (t = i.toJSON()), i.find('#embed').value(W(t.embed, t))
        })
        a.push(u)
      }
      ;(r = (e = n).selection.getNode()),
        (o = r.getAttribute('data-ephox-embed-iri')),
        (t = o
          ? {
              source1: o,
              'data-ephox-embed-iri': o,
              width: X.getMaxWidth(r),
              height: X.getMaxHeight(r)
            }
          : r.getAttribute('data-mce-object')
          ? P(w(e), e.serializer.serialize(r, { selection: !0 }))
          : {})
      var s = {
        id: 'mcemediasource',
        type: 'textbox',
      ...
      s[oe] = function() {
        ;(t = v.extend({}, P(w(n), this.value()))),
          this.parent()
            .parent()
            .fromJSON(t)
      }
      var l = [
        { title: 'General', type: 'form', items: a },
        {
          title: 'Embed',
          type: 'container',
          layout: 'flex',
          ...
          spacing: 10,
          items: [
            { type: 'label', text: 'Paste your embed code below:', forId: 'mcemediasource' },
            s
          ]
        }
      ]
      0 < c.length && l.push({ title: 'Advanced', type: 'form', items: c }),
        (i = n.windowManager.open({
    ...
    de = tinymce.util.Tools.resolve('tinymce.html.Node'),
    he = function(o, e) {
      if (!1 === u(o)) return e
      var a,
        c = E()
              ...
              if (((a = !0), 'script' !== e && 'noscript' !== e && 'svg' !== e)) {
                for (var n = t.length - 1; 0 <= n; n--) {
                  ...
                  0 === i.indexOf('on') && (delete t.map[i], t.splice(n, 1)),
                    'style' === i &&
                      (t[n].value = o.dom.serializeStyle(o.dom.parseStyle(t[n].value), e))
                }
                c.start(e, t, r), (a = !1)
              }
            },
    ...
    pe = function(e, t) {
      ...
      return (
        ...
        (i = new de('span', 1)).attr('class', 'mce-shim'),
        r.append(n),
        r.append(i),
        r
      )
    ...
    ge = function(e, t, r) {
      ...
      ;(c = t.firstChild && t.firstChild.value) &&
        (r.attr('data-mce-html', escape(he(e, c))), (r.firstChild = null))
    },
    ve = function(e) {
        ...
        for (var t, r, n = e.length; n--; )
          (t = e[n]).parent &&
            (t.parent.attr('data-mce-object') ||
              (('script' !== t.name || (r = A(w(i), t.attr('src')))) &&
                (r &&
                  (r.width && t.attr('width', r.width.toString()),
                  r.height && t.attr('height', r.height.toString())),
                'iframe' === t.name && a(i) && o.ceFalse
                  ? ve(t) || t.replace(pe(i, t))
                  : ve(t) || t.replace(fe(i, t)))))
      }
    },
    be = function(d) {
      d.on('preInit', function() {
        ...
        v.each('webkitallowfullscreen mozallowfullscreen allowfullscreen'.split(' '), function(e) {
          ...
          d.parser.addNodeFilter('iframe,video,audio,object,embed,script', we(d)),
              ...
              if ((r = e[l]).parent) {
                for (
                  u = r.attr(t),
                    ...
                    'audio' !== u &&
                      'script' !== u &&
                      ((s = r.attr('class')) && -1 !== s.indexOf('mce-preview-object')
                        ? n.attr({
                            width: r.firstChild.attr('width'),
                            height: r.firstChild.attr('height')
                          })
                        : n.attr({ width: r.attr('width'), height: r.attr('height') })),
                ...
                'script' === u && n.attr('type', 'text/javascript'),
                  (a = r.attr('data-mce-html')) &&
                    (((c = new de('#text', 3)).raw = !0),
                    (c.value = he(d, unescape(a))),
                    n.append(c)),
                  r.replace(n)
              }
          })
      ...
      t.on('click keyup', function() {
        ...
        t.on('objectResized', function(e) {
          ...
          r.getAttribute('data-mce-object') &&
            ...
            ((t = unescape(t)),
            r.setAttribute('data-mce-html', escape(W(t, { width: e.width, height: e.height }))))
        })
    },
    Oe = function(e) {
      e.addButton('media', {
  ...
  i.add('media', function(e) {
    return me(e), Oe(e), ye(e), be(e), xe(e), le(e)
  })
})()
