...
;(function(tinymce) {
  tinymce.PluginManager.add('wpview', function(editor) {
    ...
    editor.on(
      ...
      function(event) {
        editor
          .$('div[data-wpview-text], p[data-wpview-marker]', event.node)
    ...
    editor.on('beforeaddundo', function(event) {
      var lastContent
      var newContent =
        event.level.content || (event.level.fragments && event.level.fragments.join(''))
      ...
      if (!event.lastLevel) {
        ...
        lastContent =
          ...
          (event.lastLevel.fragments && event.lastLevel.fragments.join(''))
      }
