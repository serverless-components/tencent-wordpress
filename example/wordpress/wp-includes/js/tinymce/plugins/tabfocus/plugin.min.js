!(function(c) {
  ...
  var e = tinymce.util.Tools.resolve('tinymce.PluginManager'),
    ...
    m = function(e) {
      return e.getParam('tab_focus', e.getParam('tabfocus_elements', ':prev,:next'))
    },
    v = t.DOM,
    n = function(e) {
    ...
    i = function(r) {
      function e(n) {
        var i, o, e, l
        if (
          !(n.keyCode !== d.TAB || n.ctrlKey || n.altKey || n.metaKey || n.isDefaultPrevented()) &&
          (1 === (e = f.explode(m(r))).length && ((e[1] = e[0]), (e[0] = ':prev')),
          (o = n.shiftKey
            ? ':prev' === e[0]
              ? u(-1)
              : v.get(e[0])
        ...
        function u(e) {
          function t(t) {
            return (
              /INPUT|TEXTAREA|BUTTON/.test(t.tagName) &&
              s.get(n.id) &&
              -1 !== t.tabIndex &&
              (function e(t) {
                return (
          ...
          } else for (l = i - 1; 0 <= l; l--) if (t(o[l])) return o[l]
          return null
        }
      }
      r.on('init', function() {
        r.inline && v.setAttrib(r.getBody(), 'tabIndex', null),
          r.on('keyup', n),
          a.gecko ? r.on('keypress keydown', e) : r.on('keydown', e)
      })
    }
