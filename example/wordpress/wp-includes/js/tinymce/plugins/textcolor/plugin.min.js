!(function() {
  ...
  var t = tinymce.util.Tools.resolve('tinymce.PluginManager'),
    ...
    g = function(t) {
      var e,
        o = []
      for (e = 0; e < t.length; e += 2) o.push({ text: t[e + 1], color: '#' + t[e] })
      return o
    },
    r = function(t, e, o) {
    ...
    e = function(t, e) {
      t.undoManager.transact(function() {
        t.focus(), t.formatter.remove(e, { value: null }, null, !0), t.nodeChanged()
      })
    },
    o = function(o) {
    ...
    P = function(t, e, o, r) {
      ...
      for (
        (n = g(o)).push({ text: h.translate('No color'), color: 'transparent' }),
          l =
    ...
    x = function(o) {
      return function(t) {
        ...
        e._color
          ...
          : o.execCommand('mceRemoveTextcolor', e.settings.format)
      }
    },
    T = function(r, c) {
      return function(t) {
        ...
        F.DOM.getParent(t.target, '.mce-custom-color-btn') &&
          (a.hidePanel(),
          y(r).call(
            r,
            function(t) {
              ...
              for (
                e = i.map(n.rows[n.rows.length - 1].childNodes, function(t) {
                  return t.firstChild
                }),
                  r = 0;
                r < e.length && (o = e[r]).getAttribute('data-mce-color');
                r++
              );
              if (r === c)
          ...
          (e = t.target.getAttribute('data-mce-color'))
            ? (this.lastId && F.DOM.get(this.lastId).setAttribute('aria-selected', 'false'),
              t.target.setAttribute('aria-selected', !0),
              (this.lastId = t.target.id),
              'transparent' === e
                ? (r.execCommand('mceRemoveTextcolor', a.settings.format),
                  a.hidePanel(),
                  a.resetColor())
                : l(e))
            : null !== e && a.hidePanel()
    ...
    A = function(t) {
      t.addButton('forecolor', {
        ...
        tooltip: 'Text color',
        format: 'forecolor',
        panel: { role: 'application', ariaRemember: !0, html: _(t, !0), onclick: T(t, p(t)) },
        onclick: x(t)
      }),
        t.addButton('backcolor', {
          ...
          format: 'hilitecolor',
          panel: { role: 'application', ariaRemember: !0, html: _(t, !1), onclick: T(t, C(t)) },
          onclick: x(t)
        })
    }
