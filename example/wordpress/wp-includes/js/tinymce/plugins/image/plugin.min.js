!(function(l) {
  ...
  var i,
    ...
    k = P.DOM,
    M = function(e) {
      return e.style.marginLeft && e.style.marginRight && e.style.marginLeft === e.style.marginRight
        ? A(e.style.marginLeft)
        : ''
    },
    D = function(e) {
      return e.style.marginTop && e.style.marginBottom && e.style.marginTop === e.style.marginBottom
        ? A(e.style.marginTop)
        : ''
    },
    z = function(e) {
    ...
    W = function(e) {
      ...
      j(e)
        ...
        : ((t = e),
          ...
          k.insertAfter(n, t),
          n.appendChild(t),
          n.appendChild(k.create('figcaption', { contentEditable: !0 }, 'Caption')),
    ...
    le = function(t, e) {
      var n = (function(e, t) {
        ...
        if ((ne(e, E(t, { caption: !1 }), n), F(n, 'alt', t.alt), t.caption)) {
          ...
          return (
            r.appendChild(n),
            r.appendChild(k.create('figcaption', { contentEditable: !0 }, 'Caption')),
              ...
              function(e) {
                ...
                if (u(o)) {
                  ...
                  n.find('#vspace').value(''),
                    ...
                    n.find('#style').value(t.serializeStyle(t.parseStyle(t.serializeStyle(a))))
                }
              })
          },
          {
    ...
    ye = function(s, e) {
      var t = [
        {
          ...
          onchange: function(e) {
            ...
            ;(n = s),
              ...
              (l = t.control),
              (u = l.rootControl),
              (c = u.find('#image-list')[0]) && c.value(n.convertURL(l.value(), 'src')),
              ...
              i.width ||
                ...
                (a = m(n)),
                (o = new RegExp('^(?:[a-z]+:)?//', 'i')),
                a && !o.test(r) && r.substring(0, a.length) !== a && (r = a + r),
                l.value(r),
                _(n.documentBaseURI.toAbsolute(l.value()), function(e) {
                  e.width &&
                    e.height &&
                    d(n) &&
                    (u.find('#width').value(e.width), u.find('#height').value(e.height), he(u))
                }))
          },
          onbeforecall: be
        },
      ...
      return (
        r(s) && t.push({ name: 'alt', type: 'textbox', label: 'Image description' }),
        a(s) && t.push({ name: 'title', type: 'textbox', label: 'Image Title' }),
        d(s) && t.push(pe()),
        n(s) &&
          t.push({
            name: 'class',
            ...
            values: T(n(s), function(e) {
              e.value &&
                (e.textStyle = function() {
                  return s.formatter.getCssText({ inline: 'img', classes: [e.value] })
                })
            })
          }),
  ...
  var Re = function(u) {
      return function(e) {
        var t = _e.get('Throbber'),
          ...
          a = e.control.value(),
          o = Se(a),
          i = Ae({ url: f(u), basePath: h(u), credentials: v(u), handler: p(u) }),
          l = function() {
            r.hide(), Ne(o)
          }
        return (
        ...
        items: [
          {
            ...
            spacing: 10,
            items: [
              { text: 'Browse for an image', type: 'browsebutton', accept: Ie, onchange: Re(e) },
              { text: 'OR', type: 'label' }
            ]
          },
          { text: 'Drop an image here', type: 'dropzone', accept: Ie, height: 100, onchange: Re(e) }
        ]
      }
    }
  function Le(r) {
      ...
      if (
        (e &&
          (t = {
            ...
            onselect: function(e) {
              var t = n.find('#alt')
              ;(!t.value() || (e.lastControl && t.value() === e.lastControl.text())) &&
      ...
      return function(e) {
        for (
          ...
          (t = e[r]),
            (n = t.attr('class')) &&
              /\bimage\b/.test(n) &&
              (t.attr('contenteditable', o ? 'false' : null), C.each(t.getAll('figcaption'), a))
      }
    },
    Me = function(e) {
