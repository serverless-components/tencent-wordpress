;(function() {
  var modern = (function(domGlobals) {
    ...
    var addContextualToolbars = function(editor) {
      ...
      var reposition = function(match, shouldShow) {
        ...
        if (relPos) {
          ...
          movePanelTo(
            panel,
            userConstrain(handler, relRect.x, relRect.y, elementRect, contentAreaRect, panelRect)
          )
        } else {
    ...
    var getWindowViewPort = function() {
      ...
      var x = Math.max(
        win.pageXOffset,
        domGlobals.document.body.scrollLeft,
        domGlobals.document.documentElement.scrollLeft
      )
      var y = Math.max(
        win.pageYOffset,
        domGlobals.document.body.scrollTop,
        domGlobals.document.documentElement.scrollTop
      )
    ...
    global$2.each('fire on off show hide append prepend before after reflow'.split(' '), function(
      name
    ) {
      proto[name] = function() {
        ...
        function repaintScroll() {
          ...
          function repaintAxis(axisName, posName, sizeName, contentSizeName, hasScroll, ax) {
            ...
            if (scrollBarElm) {
              ...
              global$9(self.getEl('absend')).css(
                posNameLower,
          ...
          function addScrollAxis(axisName, posName, sizeName, deltaPosName, ax) {
            ...
            self.draghelper = new DragHelper(axisId + 't', {
              ...
              drag: function(e) {
                ...
                containerSize -=
                  hasScrollH && hasScrollV ? self.getEl('scroll' + axisName)['client' + ax] : 0
    ...
    var render$1 = function(editor, theme, args) {
      ...
      var reposition = function() {
        if (panel && panel.moveRel && panel.visible() && !panel._fixed) {
          ...
          panel
            .fixed(false)
            .moveRel(body, editor.rtl ? ['tr-br', 'br-tr'] : ['tl-bl', 'bl-tl', 'tr-br'])
    ...
    var renderUI = function(editor, theme, args) {
      ...
      return isInline(editor)
        ? Inline.render(editor, theme, args)
        : Iframe.render(editor, theme, args)
    }
    ...
    var Notification = Control$1.extend({
      ...
      renderHtml: function() {
        ...
        if (self.closeButton) {
          closeButton =
            '<button type="button" class="' + prefix + 'close" aria-hidden="true">\xD7</button>'
        }
        if (self.progressBar) {
    ...
    function toggleBodyFullScreenClasses(classPrefix, state) {
      if (checkFullscreenWindows() && state === false) {
        global$9([domGlobals.document.documentElement, domGlobals.document.body]).removeClass(
      ...
      Statics: {
        ...
        msgBox: function(settings) {
          ...
          return new Window({
            ...
            .renderTo(domGlobals.document.body)
            .reflow()
        },
    ...
    var Button = Widget.extend({
      ...
      renderHtml: function() {
        ...
        ariaPressed =
          typeof settings.active === 'boolean' ? ' aria-pressed="' + settings.active + '"' : ''
        return (
          '<div id="' +
          id +
          '" class="' +
    ...
    var ComboBox = Widget.extend({
      init: function(settings) {
        ...
        self.on('mouseover', function(e) {
          ...
          if (
            self.statusLevel() &&
            e.target.className.indexOf(self.classPrefix + 'status') !== -1
          ) {
      ...
      renderHtml: function() {
        ...
        statusHtml =
          '<i id="' + id + '-status" class="mce-status mce-ico" style="display: none"></i>'
        if (self.disabled()) {
    ...
    var FilePicker = ComboBox.extend({
      ...
      init: function(settings) {
        ...
        fileBrowserCallbackTypes =
          editorSettings.file_picker_types || editorSettings.file_browser_callback_types
    ...
    var FlexLayout = AbsoluteLayout.extend({
      recalc: function(container) {
        ...
        availableSpace =
          contLayoutRect[innerSizeName] - contPaddingBox[beforeName] - contPaddingBox[beforeName]
        ...
        if (availableSpace < 0) {
          rect[minSizeName] =
            contLayoutRect[minSizeName] - availableSpace + contLayoutRect[deltaSizeName]
        } else {
          rect[minSizeName] =
            contLayoutRect[innerSizeName] - availableSpace + contLayoutRect[deltaSizeName]
        }
        ...
        if (
          ...
          (rect.minW !== contLayoutRect.minW || rect.minH !== contLayoutRect.minH)
        ) {
          rect.w = rect.minW
          rect.h = rect.minH
        ...
        for (i = 0, l = items.length; i < l; i++) {
          ...
          if (align === 'center') {
            rect[alignAxisName] = Math.round(
              contLayoutRect[alignInnerSizeName] / 2 - ctrlLayoutRect[alignSizeName] / 2
            )
    ...
    var createCustomMenuItems = function(editor, names) {
      ...
      if (typeof names === 'string') {
        ...
        return flatten(
          global$2.map(names, function(names) {
    ...
    var setupUiContainer = function(editor) {
      if (editor.settings.ui_container) {
        global$8.container = descendant(
          Element.fromDom(domGlobals.document.body),
    ...
    var MenuItem = Widget.extend({
      ...
      renderHtml: function() {
        ...
        return (
          ...
          iconHtml +
          (text !== '-'
            ? '<span id="' + id + '-text" class="' + prefix + 'text">' + text + '</span>'
            : '') +
          (shortcut
            ? '<div id="' +
              id +
    ...
    function updateSliderHandle(ctrl, value) {
      ...
      styleValue =
        maxHandlePos * ((value - ctrl._minValue) / (ctrl._maxValue - ctrl._minValue)) + 'px'
        ...
        function handleDrag(minValue, maxValue, handleEl) {
          ...
          self._dragHelper = new DragHelper(self._id, {
            ...
            start: function(e) {
              ...
              maxHandlePos =
                (self.layoutRect()[shortSizeName] || 100) - funcs.getSize(handleEl)[sizeName]
              self.fire('dragstart', { value: value })
            },
            drag: function(e) {
    ...
    var SplitButton = MenuButton.extend({
      ...
      renderHtml: function() {
        ...
        return (
          ...
          prefix +
          'open" hidefocus="1" tabindex="-1">' +
          (self._menuBtnText ? (icon ? '\xA0' : '') + self._menuBtnText : '') +
          ' <i class="' +
          prefix +
          'caret"></i>' +
          '</button>' +
          ...
          if (e.control === this) {
            while (node) {
              if (
                ...
                (node.nodeName === 'BUTTON' && node.className.indexOf('open') === -1)
              ) {
                e.stopImmediatePropagation()
                if (onClickHandler) {
