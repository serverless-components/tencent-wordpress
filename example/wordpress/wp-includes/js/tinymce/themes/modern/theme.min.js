!(function(_) {
  ...
  var e,
          ...
          w.each(e.split(/[ ,]/), function(t) {
            ...
            '|' === t
              ...
              : (o || ((o = { type: 'buttongroup', items: [] }), s.push(o)),
                i.buttons[t] &&
                  ((e = t),
                  'function' == typeof (t = i.buttons[e]) && (t = t()),
                  (t.type = t.type || 'button'),
                  (t.size = r),
                  (t = v.create(t)),
                  o.items.push(t),
                  i.initialized ? n() : i.on('init', n)))
          }),
    ...
    I = function(e, t, n, i, r, o) {
      return (
        (o = L({ x: t, y: n, w: o.w, h: o.h })),
        e && (o = e({ elementRect: L(i), contentAreaRect: L(r), panelRect: o })),
        o
      )
    },
    F = function(x) {
        ...
        n = function(e, t) {
          ...
          if (!x.removed) {
            ...
            ;(l = ['bc-tc', 'tc-bc', 'tl-bl', 'bl-tl', 'tr-br', 'br-tr']),
              ...
              (h = x.dom.getRect(d)),
              'BODY' === (m = x.dom.getRoot()).nodeName &&
                ((h.x -= m.ownerDocument.documentElement.scrollLeft || m.scrollLeft),
                (h.y -= m.ownerDocument.documentElement.scrollTop || m.scrollTop)),
              (h.x += f.x),
              (h.y += f.y),
              (r = h),
              (i = B.getRect(s.getEl())),
        ...
        a = function(e) {
          ...
          for (
            ...
            for (n = r.length - 1; 0 <= n; n--)
              if (r[n].predicate(i[t])) return { toolbar: r[n], element: i[t] }
          return null
        }
      ...
      return (
        ...
        a ||
          w.each(n, function(e, t) {
            e.context !== i ||
              te(s, t) ||
              ('before' === e.separator && s.push({ name: '|', item: { text: '|' } }),
              e.prependToContext ? s.unshift(ee(t, e)) : s.push(ee(t, e)),
              'after' === e.separator && s.push({ name: '|', item: { text: '|' } }))
          }),
        (r.menu = G(
          ((l = t),
          (u = Z(s, function(e) {
    ...
    ae = function(e, t, n) {
      ...
      ;(i = e.getContainer()),
        ...
        null !== t &&
          ...
          oe.setStyle(i, 'width', t + (o.width - s.width)),
          oe.setStyle(r, 'width', t)),
      ...
      if (
          ...
          items: [
            {
              ...
              classes: 'top-part',
              items: [
                !1 === d(t) ? null : { type: 'menubar', border: '0 0 1 0', items: re(t) },
                A(t, f(t))
              ]
            },
            he(t)
        ...
        'none' !== g(t) &&
          (r = {
            ...
            onResize: function(e) {
              'both' === g(t)
                ? le(t, o.width + e.deltaX, o.height + e.deltaY)
                : le(t, null, o.height + e.deltaY)
            }
          }),
        ...
        var l = b.translate([
          ...
          u = t.getParam('branding', !0, 'boolean')
            ? { type: 'label', classes: 'branding', html: ' ' + l }
            : null
        i.add({
          type: 'panel',
          name: 'statusbar',
          ...
          border: '1 0 0 0',
          ariaRoot: !0,
          items: [{ type: 'elementpath', editor: t }, r, u]
        })
      }
      return (
        x(t),
  ...
  w.extend(We.prototype, {
    add: function(e) {
      return (
        e && !this.contains(e) && ((this.cls._map[e] = !0), this.cls.push(e), this._change()), this
      )
    },
    remove: function(e) {
      if (this.contains(e)) {
      ...
      set: function(t, n) {
        ...
        return (
          (function e(t, n) {
            ...
            ((this.data[t] = n),
            (r = { target: this, name: t, value: n, oldValue: o }),
            this.fire('change:' + t, r),
            this.fire('change', r)),
          this
        )
      },
      ...
      repaint: function() {
        ...
        ;(l = _.document.createRange
          ...
          c._hasBody &&
            i.innerW !== a.innerW &&
            ((u = l(i.innerW)),
            (n = c.getEl('body')) && ((t = n.style).width = (0 <= u ? u : 0) + 'px'),
            (a.innerW = i.innerW)),
          c._hasBody &&
            i.innerH !== a.innerH &&
            ((u = l(i.innerH)),
            (n = n || c.getEl('body')) && ((t = t || n.style).height = (0 <= u ? u : 0) + 'px'),
            (a.innerH = i.innerH)),
  ...
  function it(a) {
    ...
    function c(e) {
      e.preventDefault(),
        'mousewheel' === e.type
          ? ((e.deltaY = -0.025 * e.wheelDelta),
            e.wheelDeltaX && (e.deltaX = -0.025 * e.wheelDeltaX))
          : ((e.deltaX = 0), (e.deltaY = e.detail)),
        (e = a.fire('wheel', e))
    }
  ...
  w.each('text title visible disabled active value'.split(' '), function(t) {
    tt[t] = function(e) {
      return 0 === arguments.length
        ? this.state.get(t)
        : (void 0 !== e && this.state.set(t, e), this)
    }
  })
    ...
    lt = rt.extend({
      ...
      renderNew: function() {
        ...
        return (
          i.items().each(function(e, t) {
            var n
            e.parent(i),
              e.state.get('rendered') ||
                ((n = i.getEl('body')).hasChildNodes() && t <= n.childNodes.length - 1
                  ? ye(n.childNodes[t]).before(e.renderHtml())
                  : ye(n).append(e.renderHtml()),
                e.postRender(),
                Ke.add(e))
          }),
      ...
      insert: function(e, t, n) {
        ...
        return (
          ...
          0 <= t &&
            t < i.length &&
            ((r = i.slice(0, t).toArray()), (o = i.slice(t).toArray()), i.set(r.concat(e, o))),
          this.renderNew()
        )
      },
      fromJSON: function(e) {
      ...
      reflow: function() {
        ...
        if ((Ke.remove(this), this.visible())) {
          for (
            rt.repaintControls = [],
              rt.repaintControls.map = {},
              this.recalc(),
              e = rt.repaintControls.length;
            e--;
      ...
      renderScroll: function() {
        ...
        function n() {
          ...
          function t(e, t, n, i, r, o) {
            ...
            if ((a = p.getEl('scroll' + e))) {
              if (
                ((f = t.toLowerCase()),
                (h = n.toLowerCase()),
                ye(p.getEl('absend')).css(f, p.layoutRect()[i] - 1),
                !r)
              )
                return void ye(a).css('display', 'none')
          ...
          ;(e = p.getEl('body')),
            ...
            (g = e.scrollHeight > e.clientHeight),
            t('h', 'Left', 'Width', 'contentW', m, 'Height'),
            t('v', 'Top', 'Height', 'contentH', g, 'Width')
        }
          ...
          (p._hasScroll ||
            ...
            (function() {
              ...
              p.classes.add('scroll'),
                e('v', 'Top', 'Height', 'Y', 'Width'),
                e('h', 'Left', 'Width', 'X', 'Height')
            })(),
  ...
  function _t(r) {
    ...
    function t(e, t) {
      for (var n, i = 0; i < bt.length; i++)
        if (bt[i] !== r)
          for (n = bt[i].parent(); n && (n = n.parent()); )
            n === r &&
              bt[i]
                .fixed(e)
                .moveBy(0, t)
  ...
  function Rt(e, t) {
    ...
    i ? ye(o).css('z-index', i.zIndex - 1) : o && (o.parentNode.removeChild(o), (mt = !1)),
      (Ct.currentZIndex = r)
  }
  var Ct = pt.extend({
    Mixins: [He, vt],
      ...
      i._super(e),
          ...
          (function() {
            if (!ht) {
              var e = _.document.documentElement,
                ...
                n = e.clientHeight
              ;(ht = function() {
                ;(_.document.all && t === e.clientWidth && n === e.clientHeight) ||
                  ((t = e.clientWidth), (n = e.clientHeight), Ct.hideAll())
              }),
        ...
        i.on('postrender show', function(e) {
          if (e.control === i) {
            ...
            i.modal &&
              !mt &&
              ((t = ye('#' + n + 'modal-block', i.getContainerElm()))[0] ||
                (t = ye(
      ...
      c = function() {
        ...
        a
          ...
          : ((a = n.panel = v.create({
              ...
              border: 1,
              items: [
                !1 === d(s) ? null : { type: 'menubar', border: '0 0 1 0', items: re(s) },
                A(s, f(s))
              ]
            })),
  ...
  var St = function(e, t) {
    ...
    Tt = function(e, t, n) {
      ...
      return (
        i &&
          ...
          e.contentCSS.push(i + '/content' + (e.inline ? '.inline' : '') + '.min.css')),
        St(e, t),
        e.getParam('inline', !1, 'boolean') ? kt(e, t, n) : be(e, t, n)
      )
    },
    Mt = rt.extend({
      Mixins: [He],
    ...
    Nt = rt.extend({
          ...
          i.tooltip &&
            ...
            (r.on('mouseenter', function(e) {
              ...
              if (e.control === r) {
                ...
                t.classes.toggle('tooltip-n', 'bc-tc' === n),
                  t.classes.toggle('tooltip-nw', 'bc-tl' === n),
                  t.classes.toggle('tooltip-ne', 'bc-tr' === n),
                  t.moveRel(r.getEl(), n)
              } else t.hide()
            }),
      ...
      tooltip: function() {
        return (
          this._tooltip ||
            ((this._tooltip = new Mt({ type: 'tooltip' })),
            W.inheritUiContainer(this, this._tooltip),
    ...
    Dt = rt.extend({
      ...
      init: function(e) {
        ...
        t._super(e),
          ...
          e.timeout && (e.timeout < 0 || 0 < e.timeout) && !e.closeButton
            ? (t.closeButton = !1)
  ...
  var It = Ct.extend({
    ...
    recalc: function() {
      var e,
        ...
        o = r.statusbar
      r._fullscreen &&
        (r.layoutRect(we.getWindowSize()), (r.layoutRect().contentH = r.layoutRect().innerH)),
        r._super(),
        (e = r.layoutRect()),
        r.settings.title &&
          !r._fullscreen &&
          (t = e.headerW) > e.w &&
          ((n = e.x - Math.max(0, t / 2)), r.layoutRect({ w: t, x: n }), (i = !0)),
        o &&
          (o.layoutRect({ w: r.layoutRect().innerW }).recalc(),
          (t = o.layoutRect().minW + e.deltaW) > e.w &&
            ((n = e.x - Math.max(0, t - e.w)), r.layoutRect({ w: t, x: n }), (i = !0))),
        i && r.recalc()
    },
    initLayoutRect: function() {
      var e,
  ...
  !(function() {
    ...
    ye(_.window).on('resize', function() {
      ...
      for (e = 0; e < At.length; e++)
        (t = At[e].layoutRect()),
          At[e].moveTo(
            At[e].settings.x || Math.max(0, n.w / 2 - t.w / 2),
            At[e].settings.y || Math.max(0, n.h / 2 - t.h / 2)
          )
    })
  })()
  var Ft,
        ...
        msgBox: function(e) {
          ...
          switch (e.buttons) {
            ...
            case Yt.YES_NO_CANCEL:
              ;(t = [n('Yes', 1, !0), n('No', 0)]),
                e.buttons === Yt.YES_NO_CANCEL && t.push(n('Cancel', -1))
              break
            default:
              t = [n('Ok', !0, !0)]
          }
    ...
    jt = Nt.extend({
      ...
      renderHtml: function() {
        ...
        return (
          (e = l.image)
            ? ((o = 'none'),
              'string' != typeof e && (e = _.window.getSelection ? e[0] : e[1]),
        ...
        function s(e) {
          ...
          e
            ? (t[0] ||
              ...
              t.html(o.encode(e)))
            : t.remove(),
            o.classes.toggle('btn-has-text', !!e)
        }
        return (
    ...
    Jt = jt.extend({
      init: function(e) {
        ;(e = w.extend({ text: 'Browse...', multiple: !1, accept: null }, e)),
          this._super(e),
    ...
    Qt = Nt.extend({
      init: function(i) {
        ...
        r._super(i),
          ...
          r.on('click', function(e) {
            var t = e.target,
              n = r.getEl()
            if (ye.contains(n, t) || t === n)
              for (; t && t !== n; )
                t.id &&
                  -1 !== t.id.indexOf('-open') &&
                  (r.fire('action'), i.menu && (r.showMenu(), e.aria && r.menu.items()[0].focus())),
                  (t = t.parentNode)
          }),
          ...
          r.on('mouseover', function(e) {
            ...
            if (r.statusLevel() && -1 !== e.target.className.indexOf(r.classPrefix + 'status')) {
              ...
              t.classes.toggle('tooltip-n', 'bc-tc' === i),
                t.classes.toggle('tooltip-nw', 'bc-tl' === i),
                t.classes.toggle('tooltip-ne', 'bc-tr' === i),
                t.moveRel(e.target, i)
            }
          })
      },
      statusLevel: function(e) {
        return (
          0 < arguments.length && this.state.set('statusLevel', e), this.state.get('statusLevel')
        )
      },
      statusMessage: function(e) {
        return (
          0 < arguments.length && this.state.set('statusMessage', e),
      ...
      repaint: function() {
        ...
        var l = _.document
        return (
          l.all && (!l.documentMode || l.documentMode <= 8) && (t = n.layoutRect().h - 2 + 'px'),
      ...
      showAutoComplete: function(e, i) {
        ...
        if (0 !== e.length) {
          ...
          r.menu.layoutRect({ w: t, minW: 0, maxW: t }),
            r.menu.repaint(),
            r.menu.reflow(),
            r.menu.show(),
      ...
      bindStates: function() {
        ...
        return (
          r.on('keydown', function(e) {
            ...
            'INPUT' === e.target.nodeName &&
              (t === Zt.DOWN
                ? (e.preventDefault(), r.fire('autocomplete'), n(0, r.menu))
                : t === Zt.UP && (e.preventDefault(), n(-1, r.menu)))
          }),
          r._super()
        )
      },
    ...
    tn = jt.extend({
      showPanel: function() {
        ...
        t.panel.classes.toggle('start', 'l' === i.substr(-1)),
          t.panel.classes.toggle('end', 'r' === i.substr(-1))
        var r = 't' === i.substr(0, 1)
        t.panel.classes.toggle('bottom', !r),
          t.panel.classes.toggle('top', r),
          t.panel.moveRel(t.getEl(), i)
      },
      hidePanel: function() {
      ...
      postRender: function() {
        ...
        return (
          ...
          t.on('click', function(e) {
            e.control === t &&
              (t.panel && t.panel.visible()
                ? t.hidePanel()
                : (t.showPanel(), t.panel.focus(!!e.aria)))
          }),
          t._super()
        )
      },
    ...
    rn = tn.extend({
      ...
      color: function(e) {
        return e
          ? ((this._color = e), (this.getEl('preview').style.backgroundColor = e), this)
          : this._color
      },
      resetColor: function() {
      ...
      postRender: function() {
        ...
        return (
          t.on('click', function(e) {
            ;(e.aria && 'down' === e.aria.key) ||
              e.control !== t ||
              nn.getParent(e.target, '.' + t.classPrefix + 'open') ||
              (e.stopImmediatePropagation(), n.call(t, e))
          }),
    ...
    sn = Nt.extend({
      ...
      postRender: function() {
        ...
        function c(e, t) {
          var n = (360 - e.h) / 360
          we.css(r, { top: 100 * n + '%' }),
            t || we.css(s, { left: e.s + '%', top: 100 - e.v + '%' }),
            (o.style.background = on({ s: 100, v: 100, h: e.h }).toHex()),
            a.color().parse({ s: e.s, v: e.v, h: e.h })
        }
        function e(e) {
          var t
    ...
    an = Nt.extend({
      init: function(e) {
        ;(e = w.extend({ height: 100, text: 'Drop an image here', multiple: !1, accept: null }, e)),
          this._super(e),
    ...
    ln = Nt.extend({
      init: function(e) {
        ...
        e.delimiter || (e.delimiter = '\xbb'),
          ...
          n.on('click', function(e) {
            var t
            ;(t = e.target.getAttribute('data-index')) &&
              n.fire('select', { value: n.row()[t], index: t })
          }),
            ...
            s.on('nodeChange', function(e) {
              for (var t = [], n = e.parents, i = n.length; i--; )
                if (1 === n[i].nodeType && !a(n[i])) {
                  ...
                  if (
                    (r.isDefaultPrevented() || t.push({ name: r.name, element: n[i] }),
    ...
    gn = {
      fromHtml: function(e, t) {
        ...
        if (((n.innerHTML = e), !n.hasChildNodes() || 1 < n.childNodes.length))
          throw (_.console.error('HTML does not have a single root node', e),
    ...
    ri = function(e) {
      ...
      return Kn(
        ...
        Zn(e),
        '#' + n,
        ti((t = e)) ? parseInt(t.nodeName.substr(1), 10) : 0,
        function() {
          e.id = n
        }
      )
      ...
      return !1 === t.typeahead_urls
        ...
        ? ((n = [
            ...
            mi(
              e,
              ((a = f('anchor')),
              (l = fi(t, 'anchor_top', '#top')),
              (u = fi(t, 'anchor_bottom', '#bottom')),
              null !== l && a.unshift(di('<top>', l)),
              null !== u && a.push(di('<bottom>', u)),
              a)
            )
          ]),
          (o = function(e, t) {
    ...
    gi = function(r, i, o, s) {
      ...
      r.on('autocomplete', function() {
        ...
        r.on('selectitem', function(e) {
          ...
          'image' === s
            ? r.fire('change', { meta: { alt: i, attach: t.attach } })
        ...
        r.on('PostRender', function() {
          r.getRoot().on('submit', function(e) {
            ...
            e.isDefaultPrevented() ||
              ...
              (i = ui[(n = s)]),
              /^https?/.test(t) &&
                (i ? j(i, t).isNone() && (ui[n] = i.slice(0, 5).concat(t)) : (ui[n] = [t])))
          })
        })
    },
    pi = function(o, e, n) {
    ...
    yi = Xt.extend({
      recalc: function(e) {
        ...
        for (
          ...
          (m = (h = i[t]).layoutRect()),
            (d -= t < n - 1 ? u : 0),
            0 < (g = h.settings.flex) && ((c += g), m[E] && L.push(h), (m.flex = g)),
            (d -= m[R]),
            w < (p = o[D] + m[W] + o[O]) && (w = p)
        if (
          ...
          for (b = d / c, t = 0, n = L.length; t < n; t++)
            (v = (m = (h = L[t]).layoutRect())[E]) < (p = m[R] + m.flex * b)
              ? ((d -= m[E] - m[R]), (c -= m.flex), (m.flex = 0), (m.maxFlexSize = v))
              : (m.maxFlexSize = 0)
          for (
            b = d / c,
              x = o[k],
              ...
              0 === c &&
                ('end' === l
                  ? (x = d + o[k])
                  : 'center' === l
                  ? (x = Math.round(r[H] / 2 - (r[H] - d) / 2) + o[k]) < 0 && (x = o[k])
                  : 'justify' === l && ((x = o[k]), (u = Math.floor(d / (i.length - 1))))),
              y[M] = o[D],
              t = 0,
              n = i.length;
            t < n;
            ...
            (p = (m = (h = i[t]).layoutRect()).maxFlexSize || m[R]),
              'center' === a
                ? (y[M] = Math.round(r[N] / 2 - m[P] / 2))
                : 'stretch' === a
                ? ((y[P] = z(m[W] || 0, r[N] - o[D] - o[O])), (y[M] = o[D]))
                : 'end' === a && (y[M] = r[N] - m[P] - o.top),
              0 < m.flex && (p += m.flex * b),
              (y[_] = p),
              (y[C] = x),
              h.layoutRect(y),
          ...
          ((y.w = y.minW), (y.h = y.minH), e.layoutRect(y), this.recalc(e), null === e._lastRect)
        ) {
          var F = e.parent()
    ...
    wi = function(e, t) {
      return (
        (n = t),
        (r = (i = e) === undefined ? _.document : i.dom()),
        qn(r) ? N.none() : N.from(r.querySelector(n)).map(gn.fromDom)
      )
      var n, i, r
    },
    _i = function(e, t) {
            ...
            function() {
              ...
              s.on('init nodeChange', function(e) {
                ...
                if ((t = s.queryCommandValue('FontSize')))
                  for (i = 3; !r && 0 <= i; i--) (n = Mi(t, i)), (r = Ni(a, n, t))
    ...
    Oi = function(n, e) {
      ...
      return (
        e.items().each(function(e) {
          e.menu && e.visible(0 < Oi(n, e.menu)),
            !e.menu && e.settings.menu && e.visible(0 < Di(n, e.settings.menu))
          ...
          }),
          {
            ...
            items: i.settings.style_formats_merge
              ? i.settings.style_formats
                ? s(t.concat(i.settings.style_formats))
                : s(t)
              : s(i.settings.style_formats || t),
            onPostRender: function(e) {
            ...
            itemDefaults: {
              ...
              onPostRender: function() {
                ...
                n.parent().on('show', function() {
                  var e, t
                  ;(e = n.settings.format) &&
                    (n.disabled(!i.formatter.canApply(e)), n.active(i.formatter.match(e))),
                    (t = n.settings.cmd) && n.active(i.queryCommandState(t))
                })
              },
              onclick: function() {
                this.settings.format && _i(i, this.settings.format)(),
                  ...
                  w.each(e.parents, function(t) {
                    if (
                      (w.each(o, function(e) {
                        if (
                          (s
                            ? n.matchNode(t, s, { value: e.value }) && (i = e.value)
                            : n.matchNode(t, e.value) && (i = e.value),
                          i)
                        )
                          return !1
                      }),
      ...
      setup: function(e) {
        ...
        e.rtl && (rt.rtl = !0),
          ...
          (t = e).settings.ui_container &&
            (ce.container = wi(gn.fromDom(_.document.body), t.settings.ui_container).fold(
              k(null),
              function(e) {
                return e.dom()
              }
      ...
      recalc: function(e) {
        ...
        if (
          ...
          o.autoResize &&
            ...
            (l.contentH = l.minH - o.deltaH)),
            (N = 'start' === t.packV ? 0 : 0 < H ? Math.floor(H / n) : 0)
          var P = 0,
            W = t.flexWidths
          ...
          ((l.w = l.minW), (l.h = l.minH), e.layoutRect(l), this.recalc(e), null === e._lastRect)
        ) {
          var O = e.parent()
    ...
    Zi = Nt.extend({
      ...
      bindStates: function() {
        ...
        return (
          t.state.on('change:text', function(e) {
            ;(t.getEl('body').firstChild.data = t.encode(e.value)),
              t.state.get('rendered') && t.updateLayoutRect()
          }),
      ...
      initLayoutRect: function() {
        ...
        return (
          e.settings.multiline &&
            ...
            (t.startMinH = t.h = t.minH = Math.min(t.maxH, we.getSize(e.getEl()).height))),
          t
        )
      },
      repaint: function() {
          ...
          n.menu
            .on('show hide', function(e) {
              'hide' === e.type && e.control.parent() === n && n.classes.remove('opened-under'),
                e.control === n.menu &&
                  (n.activeMenu('show' === e.type), n.classes.toggle('opened', 'show' === e.type)),
    ...
    ir = Ct.extend({
      ...
      init: function(e) {
        if (
          ...
          'function' == typeof e.items && ((e.itemsFactory = e.items), (e.items = [])),
          e.itemDefaults)
        )
          for (var t = e.items, n = t.length; n--; ) t[n] = w.extend({}, e.itemDefaults, t[n])
        this._super(e),
          this.classes.add('menu'),
          e.animate && 11 !== ce.ie && this.classes.add('animate')
      },
      repaint: function() {
        return (
      ...
      init: function(i) {
        ...
        s._super(i),
            ...
            ('undefined' != typeof i.value &&
              (function e(t) {
                for (var n = 0; n < t.length; n++) {
                  if ((r = t[n].selected || i.value === t[n].value))
                    return (o = o || t[n].text), s.state.set('value', t[n].value), !0
          ...
          s.on('select', function(e) {
            var t = e.control
            n && (e.lastControl = n),
              i.multiple ? t.active(!t.active()) : s.value(e.control.value()),
              (n = t)
          })
      },
      value: function(n) {
    ...
    or = Nt.extend({
      ...
      showMenu: function() {
        ...
        if (
          ...
          t.moveRel(n.getEl(), r),
            (r = 'menu-sub-' + (t.rel = r)),
            t.classes.remove(t._lastRel).add(r),
            (t._lastRel = r),
  ...
  var ur = Nt.extend({
    ...
    renderHtml: function() {
      ...
      return (
        ...
        '<select id="' + t._id + '" class="' + t.classes + '"' + n + '>' + e + '</select>'
      )
    },
    bindStates: function() {
      var t = this
  ...
  var hr = Nt.extend({
        ...
        ;(e = m._minValue),
          ...
          (function(o, s) {
            function t(e) {
              var t, n, i, r
              ;(t = cr(
                (t = (((t = m.value()) + (r = n = o)) / ((i = s) - r) + 0.05 * e) * (i - n) - n),
                o,
                s
              )),
                m.value(t),
                m.fire('dragstart', { value: t }),
                m.fire('drag', { value: t }),
                m.fire('dragend', { value: t })
            }
          ...
          this.on('click', function(e) {
            ...
            if (e.control === this)
              for (; t; ) {
                if (
                  (e.aria && 'down' !== e.aria.key) ||
                  ('BUTTON' === t.nodeName && -1 === t.className.indexOf('open'))
                )
                  return e.stopImmediatePropagation(), void (n && n.call(this, e))
                t = t.parentNode
              }
          }),
    ...
    vr = pt.extend({
      ...
      activateTab: function(n) {
        var e
        this.activeTabId &&
          ((e = this.getEl(this.activeTabId)),
          ye(e).removeClass(this.classPrefix + 'active'),
