      ...
      _.extend(wp.Backbone.Subviews.prototype, {
          ...
          return (
            ...
            (i = this.get(n)) &&
              (t.add
                ? _.isUndefined(t.at)
                  ? (s = i.concat(e))
                  : (s = i).splice.apply(s, [t.at, 0].concat(e))
                : (_.each(s, function(e) {
                    e.__detach = !0
                  }),
                  _.each(i, function(e) {
            ...
            t.silent || this._attach(n, e, _.extend({ ready: this._isReady() }, t)),
            this
          )
        },
        add: function(e, t, i) {
          return (
            _.isString(e) || ((i = t), (t = e), (e = '')), this.set(e, t, _.extend({ add: !0 }, i))
          )
        },
        ...
        remove: function(e) {
          return (
            (e && e.silent) ||
              (this.parent &&
                this.parent.views &&
                this.parent.views.unset(this.selector, this.view, { silent: !0 }),
              delete this.parent,
        ...
        insert: function(e, t, i) {
          var n,
            s = i && i.at
          return (
            _.isNumber(s) && (n = e.children()).length > s ? n.eq(s).before(t) : e.append(t), this
          )
        },
        ready: function() {
      ...
      (wp.Backbone.View = Backbone.View.extend({
        ...
        render: function() {
          ...
          return (
            ...
            this.views.detach(),
            this.template &&
              ((e = e || {}), this.trigger('prepare', e), this.$el.html(this.template(e))),
            this.views.render(),
            this
          )
        },
