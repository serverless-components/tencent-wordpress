...
;(function(a) {
  ;(a.Jcrop = function(b, c) {
    ...
    function s(a) {
      return function(b) {
        return d.disabled
          ...
          : a === 'move' && !d.allowMove
          ? !1
          : ((e = l(D)), (W = !0), o(a, m(b)), b.stopPropagation(), b.preventDefault(), !1)
      }
    }
    function t(a, b, c) {
      var d = a.width(),
    ...
    function v(a) {
      var b = _.getFixed()
      b.w > d.minSelect[0] && b.h > d.minSelect[1] ? (bb.enableHandles(), bb.done()) : bb.release(),
        ...
        u = (function() {
          return function() {
            ;(q += (100 - q) / r),
              ...
              q < 100
                ? (bh(k), t())
                : (bb.done(), bb.animMode(!1), typeof b == 'function' && b.call(bs))
          }
        })()
      t()
    }
    ...
    function br(a) {
      d.allowResize ? (a ? bb.enableOnly() : bb.enableHandles()) : bb.disableHandles(),
        ...
        d.hasOwnProperty('trueSize') && ((T = d.trueSize[0] / E), (U = d.trueSize[1] / F)),
        d.hasOwnProperty('setSelect') && (bg(d.setSelect), bb.done(), delete d.setSelect),
        ba.refresh(),
        d.bgColor != N &&
          (bq(d.shade ? ba.getShades() : G, d.shade ? d.shadeColor || d.bgColor : d.bgColor),
          (N = d.bgColor)),
        O != d.bgOpacity && ((O = d.bgOpacity), d.shade ? ba.refresh() : bb.setBgOpacity(O)),
        (P = d.maxSize[0] || 0),
        (Q = d.maxSize[1] || 0),
        (R = d.minSize[0] || 0),
        (S = d.minSize[1] || 0),
        d.hasOwnProperty('outerImage') && (D.attr('src', d.outerImage), delete d.outerImage),
        bb.refresh()
    }
          ...
          return (
            ...
            n < f
              ? ((s = e),
                ...
                (r = j < 0 ? a - t : t + a),
                r < 0
                  ? ((r = 0), (u = Math.abs((r - a) / f)), (s = k < 0 ? b - u : u + b))
                  : r > E && ((r = E), (u = Math.abs((r - a) / f)), (s = k < 0 ? b - u : u + b)))
              : ((r = c),
                (u = l / f),
                (s = k < 0 ? b - u : b + u),
                s < 0
                  ? ((s = 0), (t = Math.abs((s - b) * f)), (r = j < 0 ? a - t : t + a))
                  : s > F && ((s = F), (t = Math.abs(s - b) * f), (r = j < 0 ? a - t : t + a))),
            r > a
      ...
      ba = (function() {
        ...
        function h(a) {
          e.top.css({ left: i(a.x), width: i(a.w), height: i(a.y) }),
            e.bottom.css({ top: i(a.y2), left: i(a.x), width: i(a.w), height: i(F - a.y2) }),
            e.right.css({ left: i(a.x2), width: i(E - a.x2) }),
            e.left.css({ width: i(a.x) })
        }
        function j() {
          return a('<div />')
            .css({ position: 'absolute', backgroundColor: d.shadeColor || d.bgColor })
            .appendTo(c)
        }
        function k() {
          b ||
        ...
        function n(a, e) {
          b &&
            (d.bgFade && !e
              ? c.animate({ opacity: 1 - a }, { queue: !1, duration: d.fadeTime })
              : c.css({ opacity: 1 - a }))
        }
        function o() {
      ...
      bc = (function() {
        function f(b) {
          M.css({ zIndex: 450 }),
            b
              ? a(document)
                  .bind('touchmove.jcrop', k)
                  .bind('touchend.jcrop', l)
              : e &&
                a(document)
                  .bind('mousemove.jcrop', h)
                  .bind('mouseup.jcrop', i)
        }
        function g() {
      ...
      bd = (function() {
        ...
        return (
          d.keySupport &&
            (b.keydown(i).blur(f),
            h || !d.fixedSupport
              ? (b.css({ position: 'absolute', left: '-20px' }), c.append(b).insertBefore(D))
              : b.insertBefore(D)),
          { watchKeys: e }
        )
      })()
