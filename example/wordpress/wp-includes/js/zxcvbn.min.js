...
;(function(f) {
  ...
  return (function e(t, n, r) {
  ...
  })(
    {
          ...
          ;(scoring = require('./scoring')),
            (feedback = {
              ...
              get_feedback: function(e, s) {
                ...
                for (n = s[0], i = s.slice(1), t = 0, r = i.length; t < r; t++)
                  (o = i[t]), o.token.length > n.token.length && (n = o)
                return (
                  (feedback = this.get_match_feedback(n, 1 === s.length)),
                  (a = 'Add another word or two. Uncommon words are better.'),
                  null != feedback
                    ? (feedback.suggestions.unshift(a),
                      null == feedback.warning && (feedback.warning = ''))
                    : (feedback = { warning: '', suggestions: [a] }),
                  feedback
                )
              },
              get_match_feedback: function(e, s) {
                ...
                switch (e.pattern) {
                  ...
                  case 'spatial':
                    return (
                      (a = e.graph.toUpperCase()),
                      (t =
                        1 === e.turns
                          ? 'Straight rows of keys are easy to guess'
                          : 'Short keyboard patterns are easy to guess'),
                      { warning: t, suggestions: ['Use a longer keyboard pattern with more turns'] }
                    )
                  case 'repeat':
                    return (
                      (t =
                        1 === e.base_token.length
                          ? 'Repeats like "aaa" are easy to guess'
                          : 'Repeats like "abcabcabc" are only slightly harder to guess than "abc"'),
                      { warning: t, suggestions: ['Avoid repeated words and characters'] }
                    )
                  case 'sequence':
                    return {
              ...
              get_dictionary_match_feedback: function(e, s) {
                ...
                return (
                  ...
                  o.match(scoring.START_UPPER)
                    ? r.push("Capitalization doesn't help very much")
                    : o.match(scoring.ALL_UPPER) &&
                      o.toLowerCase() !== o &&
                      r.push('All-uppercase is almost as easy to guess as all-lowercase'),
                  e.reversed &&
                    e.token.length >= 4 &&
                    r.push("Reversed words aren't much harder to guess"),
                  e.l33t &&
                    r.push(
                      "Predictable substitutions like '@' instead of 'a' don't help very much"
                    ),
                  (t = { warning: n, suggestions: r })
                )
              }
            }),
      ...
      4: [
        function(require, module, exports) {
          var feedback, matching, rot_13, scoring, time, time_estimates, zxcvbn
          ;(matching = require('./matching')),
            ...
            (zxcvbn = function(e, t) {
              var i, r, n, c, a, s, m, o, u, g, _
              for (null == t && (t = []), g = time(), u = [], n = 0, c = t.length; n < c; n++)
                (i = t[n]),
                  ('string' != (m = typeof i) && 'number' !== m && 'boolean' !== m) ||
                    u.push(rot_13(i.toString().toLowerCase()))
              matching.set_user_input_dictionary(u),
                (a = matching.omnimatch(e)),
                (o = scoring.most_guessable_match_sequence(e, a)),
                (o.calc_time = time() - g),
                (r = time_estimates.estimate_attack_times(o.guesses))
              for (s in r) (_ = r[s]), (o[s] = _)
      ...
      5: [
        function(require, module, exports) {
          ...
          ;(frequency_lists = require('./frequency_lists')),
            ...
            (build_ranked_dict = function(e) {
              var t, n, r, i, a
              for (i = {}, t = 1, r = 0, n = e.length; r < n; r++) (a = e[r]), (i[a] = t), (t += 1)
              return i
            }),
            (RANKED_DICTIONARIES = {})
          for (name in frequency_lists)
            (lst = frequency_lists[name]), (RANKED_DICTIONARIES[name] = build_ranked_dict(lst))
          ;(GRAPHS = {
            ...
            (matching = {
              ...
              translate: function(e, t) {
                ...
                return (function() {
                  var r, i, a, s
                  for (a = e.split(''), s = [], i = 0, r = a.length; i < r; i++)
                    (n = a[i]), s.push(t[n] || n)
                  return s
                })().join('')
              },
              ...
              omnimatch: function(e) {
                ...
                for (
                  ...
                  (n = r[a]), this.extend(i, n.call(this, e))
                return this.sorted(i)
              },
              dictionary_match: function(e, t) {
                var n, r, i, a, s, o, h, u, c, l, _, f, d, p
                null == t && (t = RANKED_DICTIONARIES),
                  (s = []),
                  (a = e.length),
                  (u = e.toLowerCase()),
                  (u = rot_13(u))
                for (n in t)
                  for (l = t[n], r = o = 0, _ = a; 0 <= _ ? o < _ : o > _; r = 0 <= _ ? ++o : --o)
                    for (i = h = f = r, d = a; f <= d ? h < d : h > d; i = f <= d ? ++h : --h)
                      u.slice(r, +i + 1 || 9e9) in l &&
                        ((p = u.slice(r, +i + 1 || 9e9)),
                        (c = l[p]),
                        s.push({
                          pattern: 'dictionary',
                ...
                for (
                  ...
                  (r = i[a]),
                    (r.token = r.token
                      ...
                      .join('')),
                    (r.reversed = !0),
                    (s = [e.length - 1 - r.j, e.length - 1 - r.i]),
                    (r.i = s[0]),
                    (r.j = s[1])
                return this.sorted(i)
              },
              ...
              relevant_l33t_subtable: function(e, t) {
                var n, r, i, a, s, o, h, u, c, l
                for (s = {}, o = e.split(''), a = 0, r = o.length; a < r; a++)
                  (n = o[a]), (s[n] = !0)
                l = {}
                for (i in t)
                  (c = t[i]),
                    (h = (function() {
                      var e, t, n
                      for (n = [], t = 0, e = c.length; t < e; t++) (u = c[t]), u in s && n.push(u)
                      return n
                    })()),
                    h.length > 0 && (l[i] = h)
                return l
              ...
              enumerate_l33t_subs: function(e) {
                var t, n, r, i, a, s, o, h, u, c, l, _, f, d, p
                ;(a = (function() {
                  var t
                  t = []
                  for (i in e) t.push(i)
                  ...
                  (n = function(e) {
                    var t, n, r, a, s, o, h, u
                    for (n = [], s = {}, o = 0, a = e.length; o < a; o++)
                      (h = e[o]),
                        (t = (function() {
                          var e, t, n
                          for (n = [], u = t = 0, e = h.length; t < e; u = ++t)
                            (i = h[u]), n.push([i, u])
                          return n
                        })()),
                        t.sort(),
                        (r = (function() {
                          var e, n, r
                          for (r = [], u = n = 0, e = t.length; n < e; u = ++n)
                            (i = t[u]), r.push(i + ',' + u)
                          return r
                        })().join('-')),
                        r in s || ((s[r] = !0), n.push(h))
                    return n
                  }),
                  (r = function(t) {
                    var i, a, s, o, h, u, c, l, _, f, d, g, m, A, E, y
                    if (t.length) {
                      for (
                        a = t[0], m = t.slice(1), c = [], d = e[a], l = 0, h = d.length;
                        l < h;
                        l++
                      )
                        for (o = d[l], _ = 0, u = p.length; _ < u; _++) {
                          for (
                            A = p[_], i = -1, s = f = 0, g = A.length;
                            0 <= g ? f < g : f > g;
                            s = 0 <= g ? ++f : --f
                          )
                            if (A[s][0] === o) {
                ...
                for (u = 0, o = p.length; u < o; u++) {
                  for (_ = p[u], f = {}, c = 0, h = _.length; c < h; c++)
                    (l = _[c]), (s = l[0]), (t = l[1]), (f[s] = t)
                  d.push(f)
                }
                return d
              },
              l33t_match: function(e, t, n) {
                var r, i, a, s, o, h, u, c, l, _, f, d, p, g, m, A
                for (
                  null == t && (t = RANKED_DICTIONARIES),
                    null == n && (n = L33T_TABLE),
                    u = [],
                    _ = this.enumerate_l33t_subs(this.relevant_l33t_subtable(e, n)),
                    c = 0,
                    a = _.length;
                  c < a && ((d = _[c]), !this.empty(d));
                  c++
                )
                  for (
                    g = this.translate(e, d), f = this.dictionary_match(g, t), l = 0, s = f.length;
                    l < s;
                    l++
                  )
                    if (
                      ((o = f[l]),
                      (m = e.slice(o.i, +o.j + 1 || 9e9)),
                      m.toLowerCase() !== o.matched_word)
                    ) {
                      h = {}
                      for (p in d) (r = d[p]), m.indexOf(p) !== -1 && (h[p] = r)
                      ;(o.l33t = !0),
                        (o.token = m),
                        (o.sub = h),
                        (o.sub_display = (function() {
                          var e
                          e = []
                          for (i in h) (A = h[i]), e.push(i + ' -> ' + A)
                          return e
                        })().join(', ')),
                        u.push(o)
                    }
              ...
              spatial_match_helper: function(e, t, n) {
                var r, i, a, s, o, h, u, c, l, _, f, d, p, g, m
                for (f = [], u = 0; u < e.length - 1; )
                  for (
                    c = u + 1,
                      l = null,
                      m = 0,
                      g =
                        ('qwerty' !== n && 'dvorak' !== n) || !this.SHIFTED_RX.exec(e.charAt(u))
                          ? 0
                          : 1;
                    ;
                    ...
                    if (
                      ...
                      for (a = e.charAt(c), d = 0, _ = i.length; d < _; d++)
                        if (((r = i[d]), (s += 1), r && r.indexOf(a) !== -1)) {
                          ;(o = !0),
                            (h = s),
                            1 === r.indexOf(a) && (g += 1),
                            l !== h && ((m += 1), (l = h))
              ...
              repeat_match: function(e) {
                var t, n, r, i, a, s, o, h, u, c, l, _, f, d, p
                for (
                  d = [], a = /(.+)\1+/g, c = /(.+?)\1+/g, l = /^(.+?)\1+$/, u = 0;
                  u < e.length &&
                  ((a.lastIndex = c.lastIndex = u), (s = a.exec(e)), (_ = c.exec(e)), null != s);

                )
                  s[0].length > _[0].length
                    ? ((f = s), (i = l.exec(f[0])[1]))
                    : ((f = _), (i = f[1])),
                    (p = [f.index, f.index + f[0].length - 1]),
                    (o = p[0]),
                    (h = p[1]),
                    (t = scoring.most_guessable_match_sequence(i, this.omnimatch(i))),
                    (r = t.sequence),
                    (n = t.guesses),
                    d.push({
                      pattern: 'repeat',
              ...
              sequence_match: function(e) {
                ...
                for (
                  ...
                  (t = e.charCodeAt(i) - e.charCodeAt(i - 1)),
                    null == a && (a = t),
                    t !== a && ((r = i - 1), u(n, r, a), (n = r), (a = t))
                return u(n, e.length - 1, a), h
              },
              regex_match: function(e, t) {
                var n, r, i, a
                null == t && (t = REGEXEN), (n = [])
                for (name in t)
                  for (r = t[name], r.lastIndex = 0; (i = r.exec(e)); )
                    (a = i[0]),
                      n.push({
                        pattern: 'regex',
                        token: a,
              ...
              date_match: function(e) {
                ...
                for (
                  ...
                  for (
                    o = A = I = s + 3, R = s + 7;
                    (I <= R ? A <= R : A >= R) && !(o >= e.length);
                    o = I <= R ? ++A : --A
                  )
                    if (((L = e.slice(s, +o + 1 || 9e9)), f.exec(L))) {
                      for (r = [], T = DATE_SPLITS[L.length], E = 0, c = T.length; E < c; E++)
                        (D = T[E]),
                          (h = D[0]),
                          (u = D[1]),
                          (a = this.map_ints_to_dmy([
                            parseInt(L.slice(0, h)),
                            parseInt(L.slice(h, u)),
                            parseInt(L.slice(u))
                          ])),
                          null != a && r.push(a)
                      if (r.length > 0) {
                        for (
                          ...
                          (n = k[y]), (i = p(n)), i < g && ((x = [n, i]), (t = x[0]), (g = x[1]))
                        _.push({
                          pattern: 'date',
                          token: L,
                          i: s,
                ...
                for (s = q = 0, j = e.length - 6; 0 <= j ? q <= j : q >= j; s = 0 <= j ? ++q : --q)
                  for (
                    o = C = b = s + 5, N = s + 9;
                    (b <= N ? C <= N : C >= N) && !(o >= e.length);
                    o = b <= N ? ++C : --C
                  )
                    (L = e.slice(s, +o + 1 || 9e9)),
                      (S = d.exec(L)),
                ...
                return this.sorted(
                  _.filter(function(e) {
                    var t, n, r, i
                    for (t = !1, i = 0, n = _.length; i < n; i++)
                      if (((r = _[i]), e !== r && r.i <= e.i && r.j >= e.j)) {
                        t = !0
                        break
                      }
                    return !t
              ...
              map_ints_to_dmy: function(e) {
                var t, n, r, i, a, s, o, h, u, c, l, _, f, d, p, g
                if (!(e[1] > 31 || e[1] <= 0)) {
                  for (o = 0, h = 0, p = 0, s = 0, r = e.length; s < r; s++) {
                    if (((n = e[s]), (99 < n && n < DATE_MIN_YEAR) || n > DATE_MAX_YEAR)) return
                    n > 31 && (h += 1), n > 12 && (o += 1), n <= 0 && (p += 1)
                  }
                  if (!(h >= 2 || 3 === o || p >= 2)) {
                    for (
                      c = [
                      ...
                      if (
                        ...
                        (g = _[0]),
                        (d = _[1]),
                        DATE_MIN_YEAR <= g && g <= DATE_MAX_YEAR)
                      )
                        return (
                          (t = this.map_ints_to_dm(d)),
                          null != t ? { year: g, month: t.month, day: t.day } : void 0
                        )
                    for (l = 0, a = c.length; l < a; l++)
                      if (
                        ...
                        return (
                          (g = this.two_to_four_digit_year(g)),
                          { year: g, month: t.month, day: t.day }
                        )
                  }
                }
              },
              map_ints_to_dm: function(e) {
                var t, n, r, i, a, s
                for (a = [e, e.slice().reverse()], i = 0, n = a.length; i < n; i++)
                  if (((s = a[i]), (t = s[0]), (r = s[1]), 1 <= t && t <= 31 && 1 <= r && r <= 12))
                    return { day: t, month: r }
              },
      ...
      6: [
        function(require, module, exports) {
          var BRUTEFORCE_CARDINALITY,
            ...
            v
          ;(adjacency_graphs = require('./adjacency_graphs')),
            (calc_average_degree = function(e) {
              var t, r, n, s, a, u
              t = 0
              for (n in e)
                (a = e[n]),
                  (t += (function() {
                    var e, t, r
                    for (r = [], t = 0, e = a.length; t < e; t++) (s = a[t]), s && r.push(s)
                    return r
                  })().length)
              return (t /= (function() {
                var t
            ...
            (scoring = {
              nCk: function(e, t) {
                ...
                if (t > e) return 0
                if (0 === t) return 1
                for (s = 1, r = n = 1, a = t; 1 <= a ? n <= a : n >= a; r = 1 <= a ? ++n : --n)
                  (s *= e), (s /= r), (e -= 1)
                return s
              },
              log10: function(e) {
              ...
              factorial: function(e) {
                var t, r, n, s
                if (e < 2) return 1
                for (t = 1, r = n = 2, s = e; 2 <= s ? n <= s : n >= s; r = 2 <= s ? ++n : --n)
                  t *= r
                return t
              },
              most_guessable_match_sequence: function(e, t, r) {
                var n, s, a, u, i, _, o, h, E, c, g, f, l, A, S, p, R, I, v, M, N, C, T, U
                for (
                  null == r && (r = !1),
                    l = e.length,
                    f = (function() {
                      var e, t, r
                      for (r = [], n = e = 0, t = l; 0 <= t ? e < t : e > t; n = 0 <= t ? ++e : --e)
                        r.push([])
                      return r
                    })(),
                    A = 0,
                ...
                for (
                  S = {
                    m: (function() {
                      var e, t, r
                      for (t = [], n = r = 0, e = l; 0 <= e ? r < e : r > e; n = 0 <= e ? ++r : --r)
                        t.push({})
                      return t
                    })(),
                    pi: (function() {
                    ...
                    T = (function(t) {
                      return function(n, s) {
                        var a, u, i, _, o, h
                        ;(_ = n.j),
                          (o = t.estimate_guesses(n, e)),
                          s > 1 && (o *= S.pi[n.i - 1][s - 1]),
                          (i = t.factorial(s) * o),
                          r || (i += Math.pow(MIN_GUESSES_BEFORE_GROWING_SEQUENCE, s - 1)),
                          (h = S.g[_])
                        for (u in h) if (((a = h[u]), !(u > s) && a <= i)) return
                        return (S.g[_][s] = i), (S.m[_][s] = n), (S.pi[_][s] = o)
                      }
                    })(this),
                    s = (function(e) {
                      return function(e) {
                            ...
                            a.push(
                              (function() {
                                ...
                                for (r in e)
                                  (n = e[r]),
                                    (r = parseInt(r)),
                                    'bruteforce' !== n.pattern && s.push(T(c, r + 1))
                                return s
                              })()
                            )
                        return a
                    ...
                    C = (function(e) {
                      return function(e) {
                        var t, r, n, s, a, u, i
                        ;(u = []), (s = e - 1), (a = void 0), (n = Infinity), (i = S.g[s])
                        for (r in i) (t = i[r]), t < n && ((a = r), (n = t))
                        for (; s >= 0; ) (c = S.m[s][a]), u.unshift(c), (s = c.i - 1), a--
                        return u
                      }
                    })(this),
                    u = N = 0,
                  ...
                  for (M = f[u], U = 0, h = M.length; U < h; U++)
                    if (((c = M[U]), c.i > 0))
                      for (i in S.m[c.i - 1]) (i = parseInt(i)), T(c, i + 1)
                    else T(c, 1)
                  s(u)
                }
                return (
                  (R = C(l)),
                  (p = R.length),
                  (a = 0 === e.length ? 1 : S.g[l - 1][p]),
                  { password: e, guesses: a, guesses_log10: this.log10(a), sequence: R }
                )
              },
              estimate_guesses: function(e, t) {
                ...
                return null != e.guesses
                  ...
                  : ((s = 1),
                    ...
                    (n = r[e.pattern].call(this, e)),
                    (e.guesses = Math.max(n, s)),
                    (e.guesses_log10 = this.log10(e.guesses)),
                    e.guesses)
              },
              bruteforce_guesses: function(e) {
                var t, r
                return (
                  (t = Math.pow(BRUTEFORCE_CARDINALITY, e.token.length)),
              ...
              regex_guesses: function(e) {
                ...
                if (
                  ...
                  return Math.pow(t[e.regex_name], e.token.length)
                switch (e.regex_name) {
                  case 'recent_year':
                    return (
                      (r = Math.abs(parseInt(e.regex_match[0]) - this.REFERENCE_YEAR)),
                      (r = Math.max(r, this.MIN_YEAR_SPACE))
                    )
                }
              },
              date_guesses: function(e) {
                var t, r
                return (
                  (r = Math.max(Math.abs(e.year - this.REFERENCE_YEAR), this.MIN_YEAR_SPACE)),
                  (t = 365 * r),
                  e.separator && (t *= 4),
                  t
                )
              ...
              spatial_guesses: function(e) {
                var t, r, n, s, a, u, i, _, o, h, E, c, g, f, l, A, S, p
                for (
                  'qwerty' === (E = e.graph) || 'dvorak' === E
                    ? ((l = this.KEYBOARD_STARTING_POSITIONS), (s = this.KEYBOARD_AVERAGE_DEGREE))
                  ...
                  for (
                    o = Math.min(S, u - 1), i = h = 1, g = o;
                    1 <= g ? h <= g : h >= g;
                    i = 1 <= g ? ++h : --h
                  )
                    a += this.nCk(u - 1, i - 1) * l * Math.pow(s, i)
                if (e.shifted_count)
                  if (
                    ((r = e.shifted_count),
              ...
              dictionary_guesses: function(e) {
                var t
                return (
                  (e.base_guesses = e.rank),
                  (e.uppercase_variations = this.uppercase_variations(e)),
                  (e.l33t_variations = this.l33t_variations(e)),
                  (t = (e.reversed && 2) || 1),
                  e.base_guesses * e.uppercase_variations * e.l33t_variations * t
                )
              },
              START_UPPER: /^[A-Z][^A-Z]+$/,
              END_UPPER: /^[^A-Z]+[A-Z]$/,
              ...
              uppercase_variations: function(e) {
                var t, r, n, s, a, u, i, _, o, h, E, c
                if (((c = e.token), c.match(this.ALL_LOWER) || c.toLowerCase() === c)) return 1
                for (
                  _ = [this.START_UPPER, this.END_UPPER, this.ALL_UPPER], u = 0, a = _.length;
                  u < a;
                  u++
                )
                  if (((h = _[u]), c.match(h))) return 2
                for (
                  r = (function() {
                    var e, t, r, s
                    for (r = c.split(''), s = [], t = 0, e = r.length; t < e; t++)
                      (n = r[t]), n.match(/[A-Z]/) && s.push(n)
                    return s
                  })().length,
                    t = (function() {
                      var e, t, r, s
              ...
              l33t_variations: function(e) {
                var t, r, n, s, a, u, i, _, o, h, E, c, g
                if (!e.l33t) return 1
                ;(g = 1), (o = e.sub)
                for (E in o)
                  if (
                    ((c = o[E]),
                    (s = e.token.toLowerCase().split('')),
                    (t = (function() {
                      var e, t, r
                      for (r = [], t = 0, e = s.length; t < e; t++) (n = s[t]), n === E && r.push(n)
                      return r
                    })().length),
                    (r = (function() {
                      var e, t, r
                      for (r = [], t = 0, e = s.length; t < e; t++) (n = s[t]), n === c && r.push(n)
                      return r
                    })().length),
                    0 === t || 0 === r)
                  )
        ...
        function(require, module, exports) {
          ...
          ;(time_estimates = {
            estimate_attack_times: function(e) {
              ...
              return {
                crack_times_seconds: n,
                crack_times_display: t,
            ...
            guesses_to_score: function(e) {
              var t
              return (
                (t = 5), e < 1e3 + t ? 0 : e < 1e6 + t ? 1 : e < 1e8 + t ? 2 : e < 1e10 + t ? 3 : 4
              )
            },
