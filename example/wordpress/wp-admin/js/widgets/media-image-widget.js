  ...
  ImageWidgetControl = component.MediaWidgetControl.extend(
    /** @lends wp.mediaWidgets.controlConstructors.media_image.prototype */ {
      ...
      getModelPropsFromMediaFrame: function getModelPropsFromMediaFrame(mediaFrame) {
        var control = this
        return _.omit(
          component.MediaWidgetControl.prototype.getModelPropsFromMediaFrame.call(
            control,
            mediaFrame
          ),
          'image_title'
      ...
      mapModelToPreviewTemplateProps: function mapModelToPreviewTemplateProps() {
        ...
        previewTemplateProps = component.MediaWidgetControl.prototype.mapModelToPreviewTemplateProps.call(
          control
        )
        previewTemplateProps.currentFilename = url
          ? url.replace(/\?.*$/, '').replace(/^.+\//, '')
          : ''
