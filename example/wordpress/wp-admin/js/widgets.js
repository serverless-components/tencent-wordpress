  ...
  window.wpWidgets = {
        ...
        if (0 !== dirtyWidgetIds.length) {
          ...
          unsavedWidgetsElements.each(function() {
            if (!$(this).hasClass('open')) {
              $(this)
                .find('.widget-title-action:first')
                .click()
            }
          })
          ...
          unsavedWidgetsElements.first().each(function() {
            ...
            $(this)
              .find('.widget-inside :tabbable:first')
              .focus()
          })
    ...
    saveOrder: function(sidebarId) {
      ...
      $('div.widgets-sortables').each(function() {
        if ($(this).sortable) {
          data['sidebars[' + $(this).attr('id') + ']'] = $(this)
            .sortable('toArray')
            .join(',')
        }
      })
    ...
    addWidget: function(chooser) {
      ...
      widget = $('#available-widgets')
        .find('.widget-in-question')
        .clone()
