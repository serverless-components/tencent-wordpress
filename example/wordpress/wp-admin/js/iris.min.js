...
!(function(a, b) {
  function c() {
    ...
    j
      ...
      : ((b = a('<div id="iris-gradtest" />')),
        ...
        k === !1 &&
          (b.css('background', '-webkit-gradient(linear,0% 0%,0% 100%,from(#fff),to(#000))'),
  ...
  function d(b, c) {
    return (
      (b = 'top' === b ? 'top' : 'left'),
      (c = a.isArray(c) ? c : Array.prototype.slice.call(arguments, 1)),
      'webkit' === k ? f(b, c) : l[k] + 'linear-gradient(' + b + ', ' + c.join(', ') + ')'
    )
  }
  function e(b, c) {
  ...
  function h(b) {
    ...
    for (; j < b.length - 1; )
      k || b[j] !== !1 ? k && b[j] !== !1 && ((i = j), (j = b.length)) : ((g = j - 1), (k = !0)),
        j++
    for (
      d = i - g,
  ...
  return (
    ...
    (l = ['-moz-', '-webkit-', '-o-', '-ms-']),
    j && q <= 7
      ? ((a.fn.iris = a.noop), void (a.support.iris = !1))
      : ((a.support.iris = !0),
        ...
        (n = {
          ...
          _create: function() {
            ...
            k === !1 && c(),
              ...
              (b.horizontalSlider = b.onlySlider && 'horizontal' === b.options.slider),
              b.onlySlider && ((b.options.controls.strip = 'h'), e || (e = 'hsl(10,100,50)')),
              ...
              switch (i[b]) {
                case 'h':
                  if ('hsv' === f) {
                    ...
                    c = g.toHsl()
                  } else c = 'strip' === b ? { s: g.s, l: g.l } : { s: 100, l: g.l }
                  ...
                  'hsv' === f
                    ...
                    : (c =
                        'vert' === b && 'h' === d.options.controls.horiz
                          ? ['hsla(0, 0%, ' + g.l + '%, 0)', 'hsla(0, 0%, ' + g.l + '%, 1)']
                          : ['hsl(' + g.h + ',0%,50%)', 'hsl(' + g.h + ',100%,50%)']),
                    h.gradient(a, c)
                  break
                case 'l':
                  ;(c =
                    'strip' === b
                      ...
                      : ['#fff', 'rgba(255,255,255,0) 50%', 'rgba(0,0,0,0) 50%', 'rgba(0,0,0,1)']),
                    h.gradient(a, c)
                  break
                case 'v':
                  ;(c =
          ...
          _stripOnlyDimensions: function() {
            var a = this,
              ...
              c = 0.12 * b
            a.horizontalSlider
              ? a.picker.css({ width: b, height: c }).addClass('iris-only-strip iris-strip-horiz')
              : a.picker.css({ width: c, height: b }).addClass('iris-only-strip iris-strip-vert')
          },
          _dimensions: function(b) {
            ...
            return (
              b &&
                (j.css('width', ''), k.css('width', ''), g.picker.css({ width: '', height: '' })),
          ...
          _addInputListeners: function(a) {
            ...
            a.on('change', d).on('keyup', b._debounce(d, c)),
              b.options.hide &&
          ...
          _paletteListeners: function() {
            ...
            b.picker
              ...
              .on('keydown.palette', '.iris-palette', function(b) {
                return (
                  (13 !== b.keyCode && 32 !== b.keyCode) ||
                  (b.stopPropagation(), void a(this).click())
                )
              })
          },
          _squareDrag: function(a, b) {
            var c = this,
              ...
              g =
                c._scale[d.horiz] - Math.round(((e.w - b.position.left) / e.w) * c._scale[d.horiz])
          ...
          _setOption: function(b, c) {
            ...
            switch (((g.options[b] = c), b)) {
              case 'color':
                g.onlySlider
                  ? ((c = parseInt(c, 10)),
                    (c = isNaN(c) || c < 0 || c > 359 ? h : 'hsl(' + c + ',100,50)'),
                    (g.options.color = g.options[b] = c),
                    (g._color = new Color(c).setHSpace(g.options.mode)),
                    (g.active = 'external'),
                    g._change())
                  : ((c = '' + c),
                    (d = c.replace(/^#/, '')),
                    (e = new Color(c).setHSpace(g.options.mode)),
                    e.error
                      ? (g.options[b] = h)
                      : ((g._color = e),
                        (g.options.color = g.options[b] = g._color.toString()),
                        (g.active = 'external'),
                        g._change()))
                break
              case 'palettes':
                ;(i = !0),
                  c ? g._addPalettes() : g.picker.find('.iris-palette-container').remove(),
                  h || g._paletteListeners()
                break
              case 'width':
                i = !0
                break
          ...
          _squareDimensions: function(a) {
            ...
            return a !== b && e.data('dimensions')
              ? e.data('dimensions')
              : ((d = this.controls.squareDrag),
                (c = { w: e.width(), h: e.height() }),
                e.data('dimensions', c),
                c)
          },
          ...
          _change: function() {
            ...
            'strip' === b.active ? (e = []) : 'external' !== b.active && e.pop(),
              ...
              (b.hue = b._color.h()),
              (b.options.color = b._color.toString()),
              b._inited && b._trigger('change', { type: b.active }, { color: b._color }),
              b.element.is(':input') &&
                !b._color.error &&
                (b.element.removeClass('iris-error'),
                b.onlySlider
                  ? b.element.val() !== b.hue && b.element.val(b.hue)
                  : b.element.val() !== b._color.toString() && b.element.val(b._color.toString())),
              b._paint(),
              (b._inited = !0),
              (b.active = !1)
          },
        ...
        a.widget('a8c.iris', n),
        void a('<style id="iris-css">' + m + '</style>').appendTo('head'))
  )
})(jQuery),
  (function(a, b) {
    var c = function(a, b) {
    ...
    c.fn = c.prototype = {
      ...
      _init: function(a) {
        ...
        switch (typeof a) {
          case 'object':
            return (
              a.a !== b && this.a(a.a),
              (c = a.r !== b ? 'fromRgb' : a.l !== b ? 'fromHsl' : a.v !== b ? 'fromHsv' : c),
              this[c](a)
            )
          case 'string':
      ...
      fromRgb: function(a, c) {
        return 'object' != typeof a || a.r === b || a.g === b || a.b === b
          ? this._error()
          : ((this.error = !1), this.fromInt(parseInt((a.r << 16) + (a.g << 8) + a.b, 10), c))
      },
      fromHex: function(a) {
        return (
      ...
      fromInt: function(a, c) {
        return (
          ...
          this._color > 16777215 ? (this._color = 16777215) : this._color < 0 && (this._color = 0),
          c === b && (this._hsv.h = this._hsv.s = this._hsl.h = this._hsl.s = 0),
          this
        )
      },
      ...
      toString: function() {
        ...
        if (a.length < 6) for (var b = 6 - a.length - 1; b >= 0; b--) a = '0' + a
        return '#' + a
      },
      toCSS: function(a, b) {
      ...
      toLuminosity: function() {
        ...
        for (var c in a)
          if (a.hasOwnProperty(c)) {
            var d = a[c] / 255
            b[c] = d <= 0.03928 ? d / 12.92 : Math.pow((d + 0.055) / 1.055, 2.4)
          }
      ...
      getReadableContrastingColor: function(a, d) {
        ...
        var e,
          ...
          g,
          h = d === b ? 5 : d,
          i = a.getDistanceLuminosityFrom(this)
        if (i >= h) return this
        if (((e = a.getMaxContrastColor()), (f = e.getDistanceLuminosityFrom(a)), f <= h)) return e
        for (
          g = 0 === e.toInt() ? -1 : 1;
          i < h &&
          (this.l(g, !0),
          (i = this.getDistanceLuminosityFrom(a)),
      ...
      _partial: function(a) {
        ...
        return function(d, e) {
          ...
          return d === b
            ...
            : (e === !0 && (d = f[a] + d),
              c.mod && (d %= c.mod),
              c.range && (d = d < c.range[0] ? c.range[0] : d > c.range[1] ? c.range[1] : d),
              (f[a] = d),
