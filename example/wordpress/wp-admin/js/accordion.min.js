    ...
    e('.accordion-container').on('click keydown', '.accordion-section-title', function(n) {
      ;('keydown' === n.type && 13 !== n.which) ||
        ...
        (function(n) {
          ...
          a.addClass('opening'),
            e.hasClass('open')
              ? (e.toggleClass('open'), s.toggle(!0).slideToggle(150))
              : (t.attr('aria-expanded', 'false'),
                ...
                i
                  ...
                  .show()
                  .slideUp(150),
                s.toggle(!1).slideToggle(150),
                e.toggleClass('open'))
          setTimeout(function() {
            a.removeClass('opening')
          }, 150),
            o && o.attr('aria-expanded', String('false' === o.attr('aria-expanded')))
        })(e(this)))
    })
  })
})(jQuery)
