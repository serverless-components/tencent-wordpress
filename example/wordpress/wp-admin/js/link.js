...
jQuery(document).ready(function($) {
  ...
  if (getUserSetting('cats')) $('#category-tabs a[href="#categories-pop"]').click()
   ...
   * @return {void}
   */
  $('#link-category-add-submit').click(function() {
    newCat.focus()
  })
  ...
  $('a[href="#categories-all"]').click(function() {
    deleteUserSetting('cats')
  })

  // Set a preference for the popular categories to cookies.
  $('a[href="#categories-pop"]').click(function() {
    setUserSetting('cats', 'pop')
  })

  if ('pop' == getUserSetting('cats')) $('a[href="#categories-pop"]').click()
