...
;(function($, wp) {
  window.inlineEditPost = {
    ...
    init: function() {
      ...
      $('#bulk-edit')
        .find('fieldset:first')
        .after($('#inline-edit fieldset.inline-edit-categories').clone())
        .siblings('fieldset:last')
        .prepend($('#inline-edit label.inline-edit-tags').clone())
      ...
      $('tbody th.check-column input[type="checkbox"]').each(function() {
        ...
        if ($(this).prop('checked')) {
          ...
          te +=
            ...
            wp.i18n.__('Remove From Bulk Edit') +
            '">X</a>' +
            theTitle +
            '</div>'
        }
        ...
        if (locked.hasOwnProperty(key)) {
          if (!row.hasClass('wp-locked')) {
            ...
            if (lock_data.avatar_src) {
              ...
              row
                .find('.column-title .locked-avatar')
                .empty()
                .append(avatar)
            }
