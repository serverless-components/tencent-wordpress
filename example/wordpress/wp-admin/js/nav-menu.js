      ...
      if (isPrimaryMenuItem) {
        ;(primaryItems = $('.menu-item-depth-0')),
          ...
          (title = menus.menuFocus
            ...
            .replace('%2$d', itemPosition)
            .replace('%3$d', totalMenuItems))
      } else {
    ...
    initSortables: function() {
      ...
      function updateMenuMaxDepth(depthChange) {
        ...
        if (depthChange === 0) {
          ...
          while (!$('.menu-item-depth-' + newDepth, api.menuList).length && newDepth > 0) newDepth--
        }
    ...
    attachTabsPanelListeners: function() {
      $('#menu-settings-column').bind('click', function(e) {
        ...
        if (target.hasClass('nav-tab-link')) {
          ...
          selectAreaMatch = target
            .closest('.tabs-panel-active')
            .parent()
            .attr('id')
          if (selectAreaMatch) {
            items = $('#' + selectAreaMatch + ' .tabs-panel-active .menu-item-title input')
