...
;(function(exports, $) {
    ...
    /** @lends wp.customize~Container.prototype */ {
      ...
      getContainer: function() {
        ...
        if (template && container.container) {
          return $.trim(template(_.extend({ id: container.id }, container.params)))
        }
  ...
  api.Section = Container.extend(
    /** @lends wp.customize.Section.prototype */ {
      ...
      attachEvents: function() {
        ...
        section.container
          .find('.accordion-section-title, .customize-section-back')
    ...
    /** @lends wp.customize.Control.prototype */ {
      ...
      renderNotifications: function() {
        ...
        if ('undefined' !== typeof console && console.warn) {
          console.warn(
            '[DEPRECATED] wp.customize.Control.prototype.renderNotifications() is deprecated in favor of instantating a wp.customize.Notifications and calling its render() method.'
          )
        }
  ...
  $(function() {
    ...
    api('show_on_front', 'page_on_front', 'page_for_posts', function(
      showOnFront,
      pageOnFront,
      pageForPosts
    ) {
