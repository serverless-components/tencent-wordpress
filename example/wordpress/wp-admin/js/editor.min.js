    ...
    ;(m.editor = m.editor || {}),
      (window.switchEditors = new (function() {
        ...
        function e() {
          !s &&
            window.tinymce &&
            ((s = window.tinymce),
            (d = s.$)(document).on('click', function(e) {
              var t = d(e.target)
              t.hasClass('wp-switch-editor') &&
                r(t.attr('data-wp-editor-id'), t.hasClass('switch-tmce') ? 'tmce' : 'html')
            }))
        }
        function u(e) {
          var t = d('.mce-toolbar-grp', e.getContainer())[0],
            n = t && t.clientHeight
        ...
        function r(e, t) {
          ...
          var n,
            ...
            c = o[0]
          if (
            ('toggle' === t && (t = i && !i.isHidden() ? 'html' : 'tmce'),
            'tmce' === t || 'tinymce' === t)
          ) {
            if (i && !i.isHidden()) return !1
            void 0 !== window.QTags && window.QTags.closeAllTags(e),
              (n = parseInt(c.style.height, 10) || 0)
            ;(i
              ? i.getParam('wp_keep_scroll_position')
              : window.tinyMCEPreInit.mceInit[e] &&
                window.tinyMCEPreInit.mceInit[e].wp_keep_scroll_position) &&
              (function(e) {
                ...
                var t = e[0],
                  n = (function(e, t) {
                    ...
                    o &&
                      !o.showAsPlainText &&
                      (n = o.urlAtStartOfContent ? o.endIndex : o.startIndex)
                    var c = g(e, r)
                    c && !c.showAsPlainText && (r = c.urlAtEndOfContent ? c.startIndex : c.endIndex)
                    return { cursorStart: n, cursorEnd: r }
                  })(t.value, { cursorStart: t.selectionStart, cursorEnd: t.selectionEnd }),
                  r = n.cursorStart,
                  i = n.cursorEnd,
                  a = r !== i ? 'range' : 'single',
                  o = null,
                ...
                t.value = [
                  t.value.slice(0, r),
                  c.clone().addClass('mce_SELRES_start')[0].outerHTML,
                  o,
                  t.value.slice(i)
                ].join('')
              })(o),
              i
                ? (i.show(),
                  !s.Env.iOS &&
                    ...
                    50 < (n = n - u(i) + 14) &&
                    n < 5e3 &&
                    i.theme.resizeTo(null, n),
                  i.getParam('wp_keep_scroll_position') && w(i))
                : s.init(window.tinyMCEPreInit.mceInit[e]),
              a.removeClass('html-active').addClass('tmce-active'),
            ...
            if (i) {
              s.Env.iOS ||
                ((n = (r = i.iframeElement) ? parseInt(r.style.height, 10) : 0) &&
                  50 < (n = n + u(i) - 14) &&
                  n < 5e3 &&
                  (c.style.height = n + 'px'))
              var p = null
              i.getParam('wp_keep_scroll_position') &&
                (p = (function(e) {
                  ...
                  var n = 'SELRES_' + Math.random(),
                    ...
                    p = o.startOffset,
                    s = o.cloneRange()
                  0 < e.$(c).parents('.mce-offscreen-selection').length
                    ? ((c = e.$('[data-mce-selected]')[0]),
                  ...
                  var l = new RegExp(
                    ...
                    g = new RegExp(
                      '(\\s*)<span[^>]*\\s*class="mce_SELRES_end"[^>]+>\\s*' + n + '[^<]*<\\/span>'
                    ),
                    u = d.match(l),
                    w = d.match(g)
                  if (!u) return null
                  ...
                  if (w) {
                    ...
                    var v = w.index
                    ;-1 !== w[0].indexOf('data-mce-object-selection') && (v -= w[1].length),
                      (h = v - m)
                  }
            ...
            a.removeClass('tmce-active').addClass('html-active'),
        ...
        function b(e, t) {
          return e('<span>')
            .css({ display: 'inline-block', width: 0, overflow: 'hidden', 'line-height': 0 })
            .html(t || '')
        }
        function w(e) {
          ...
          e.getParam('wp_keep_scroll_position') &&
            (function(e, t) {
              var n,
                r = e.$(t).offset().top,
                i = e.$(e.getContentAreaContainer()).offset().top,
                a = u(e),
                o = f('#wp-content-editor-tools'),
                c = 0,
                p = 0
              ...
              var s,
                ...
                g = d - (c + a)
              if (l < g) return
              s = e.settings.wp_autoresize_on
                ? ((n = f('html,body')), Math.max(l - g / 2, p - c))
                : ((n = f(e.contentDocument).find('html,body')), r)
        ...
        function E(e) {
          ...
          return e
            ? ((-1 === e.indexOf('<script') && -1 === e.indexOf('<style')) ||
              ...
              -1 !== e.indexOf('<hr') && (e = e.replace(/\s*<hr( [^>]*)?>\s*/g, '\n\n<hr$1>\n\n')),
              -1 !== e.indexOf('<object') &&
        ...
        function a(e) {
          ...
          return (
            ...
            -1 !== e.indexOf('<figcaption') &&
              (e = (e = e.replace(/\s*(<figcaption[^>]*>)/g, '$1')).replace(
                /<\/figcaption>\s*/g,
                '</figcaption>'
              )),
            -1 !== e.indexOf('[caption') &&
              ((n = !0),
              (e = e.replace(/\[caption[\s\S]+?\[\/caption\]/g, function(e) {
                return (e = (e = e.replace(/<br([^>]*)>/g, '<wp-temp-br$1>')).replace(
                  /<[^<>]+>/g,
                  function(e) {
                    return e.replace(/[\n\t ]+/, ' ')
                  }
            ...
            (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e +=
              ...
              new RegExp('<p>\\s*(</?(?:' + r + ')(?: [^>]*)?>)\\s*</p>', 'gi'),
              '$1'
            )).replace(/<p>(<li.+?)<\/p>/gi, '$1')).replace(
              /<p>\s*<blockquote([^>]*)>/gi,
              '<blockquote$1><p>'
            )).replace(/<\/blockquote>\s*<\/p>/gi, '</p></blockquote>')).replace(
              new RegExp('<p>\\s*(</?(?:' + r + ')(?: [^>]*)?>)', 'gi'),
              '$1'
            )).replace(new RegExp('(</?(?:' + r + ')(?: [^>]*)?>)\\s*</p>', 'gi'), '$1')).replace(
              /(<br[^>]*>)\s*\n/gi,
              '$1'
            )).replace(/\s*\n/g, '<br />\n')).replace(
              new RegExp('(</?(?:' + r + ')[^>]*>)\\s*<br />', 'gi'),
              '$1'
            )).replace(/<br \/>(\s*<\/?(?:p|li|div|dl|dd|dt|th|pre|td|ul|ol)>)/gi, '$1')).replace(
              /(?:<p>|<br ?\/?>)*\s*\[caption([^\[]+)\[\/caption\]\s*(?:<\/p>|<br ?\/?>)*/gi,
              '[caption$1[/caption]'
            )).replace(/(<(?:div|th|td|form|fieldset|dd)[^>]*>)(.*?)<\/p>/g, function(e, t, n) {
              return n.match(/<p( [^>]*)?>/) ? e : t + '<p>' + n + '</p>'
            })),
            t && (e = e.replace(/<wp-line-break>/g, '\n')),
            n && (e = e.replace(/<wp-temp-br([^>]*)>/g, '<br$1>')),
            e
          )
        }
        function t(e) {
          ...
          return (
            f && f('body').trigger('beforePreWpautop', [t]),
            (t.data = E(t.data)),
            f && f('body').trigger('afterPreWpautop', [t]),
            t.data
          )
        }
        function o(e) {
          var t = { o: n, data: e, unfiltered: e }
          return (
            f && f('body').trigger('beforeWpautop', [t]),
            (t.data = a(t.data)),
            f && f('body').trigger('afterWpautop', [t]),
            t.data
          )
        }
        return (
          f(document).on('tinymce-editor-init.keep-scroll-position', function(e, t) {
          ...
          (m.editor.autop = o),
          (m.editor.removep = t),
          (n = { go: r, wpautop: o, pre_wpautop: t, _wp_Autop: a, _wp_Nop: E })
        )
      })()),
      (m.editor.initialize = function(e, t) {
        ...
        if (f && e && m.editor.getDefaultSettings) {
          if (
            ((r = m.editor.getDefaultSettings()), (t = t || { tinymce: !0 }).tinymce && t.quicktags)
          ) {
            var i = f('#' + e),
              a = f('<div>').attr({
            ...
            if (t.mediaButtons) {
              ...
              window._wpMediaViewsL10n &&
                ...
                (s = window._wpMediaViewsL10n.addMedia)
              var d = f('<button type="button" class="button insert-media add_media">')
              d.append('<span class="wp-media-buttons-icon"></span>'),
                d.append(document.createTextNode(' ' + s)),
                d.data('editor', e),
                p.append(f('<div class="wp-media-buttons">').append(d))
            }
            a.append(
              p
                .append(
                  f('<div class="wp-editor-tabs">')
                    .append(
                      c
                        .clone()
                        .attr({ id: e + '-tmce', class: 'wp-switch-editor switch-tmce' })
                        .text(window.tinymce.translate('Visual'))
                    )
                    .append(
                      c
                        .attr({ id: e + '-html', class: 'wp-switch-editor switch-html' })
          ...
          window.tinymce &&
            t.tinymce &&
            ('object' != typeof t.tinymce && (t.tinymce = {}),
            ((n = f.extend({}, r.tinymce, t.tinymce)).selector = '#' + e),
            f(document).trigger('wp-before-tinymce-init', n),
            window.tinymce.init(n),
            window.wpActiveEditor || (window.wpActiveEditor = e)),
            window.quicktags &&
              t.quicktags &&
              ('object' != typeof t.quicktags && (t.quicktags = {}),
              ((n = f.extend({}, r.quicktags, t.quicktags)).id = e),
              f(document).trigger('wp-before-quicktags-init', n),
              window.quicktags(n),
      ...
      (m.editor.remove = function(e) {
        var t,
          n,
          r = f('#wp-' + e + '-wrap')
        window.tinymce && (t = window.tinymce.get(e)) && (t.isHidden() || t.save(), t.remove()),
          window.quicktags && (n = window.QTags.getInstance(e)) && n.remove(),
          r.length && (r.after(f('#' + e)), r.remove())
      }),
